__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function d(t) {
      ...
      await o("WAWebManageE2ESessionsJob").ensureE2ESessions([p], !1, d);
      var g = i.data.id,
        h = r("WANullthrows")(o("WAWebUserPrefsMeUser").getMaybeMeDeviceLid());
      o("WALogger")
        .LOG(
          s ||
        ...
        .tags("messaging");
      var y = await r("WAWebUserPrefsStatus").getStatusSkDistribList([p]),
        C = y.participantList,
        b = y.skDistribList;
      o("WALogger").LOG(
        u ||
      ...
      var v = await o("WAWebEncryptAndSendStatusMsg").genMessageBody(
          m,
          h,
          b,
          C,
        ...
        R = v[1],
        L = v[2],
        E = await o("WAWebReportingTokenUtils").genReportingTokenBody(
          i.data,
          a,
        ),
        k = o("WAWap").wap(
          "message",
          {
            ...
            edit: o("WAWebSendMsgCommonApi").editAttribute(a, i.data.subtype),
          },
          S,
          R,
          L,
