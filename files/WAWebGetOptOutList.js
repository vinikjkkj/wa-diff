__d(
  ...
  function (t, n, r, o, a, i, l) {
    async function e(e) {
      var t = await o("WAWebUserPrefsMultiDevice").getOptOutListHash(),
        n = { itemArgs: t != null ? { itemDhash: t } : void 0, iqCategory: e },
        r = await o("WASmaxBlocklistsGetOptOutListRPC").sendGetOptOutListRPC(n);
      switch (r.name) {
