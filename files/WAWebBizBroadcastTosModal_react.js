    ...
    function p(e) {
      ...
      (t[1] !== n
        ? ((_ = function () {
            ...
            o(
              "WAWebBusinessBroadcastUserJourneyLogger",
            ).BusinessBroadcastUserJourneyLogger.tosNuxViewed(n, e);
          }),
          (f = [n]),
          (t[1] = n),
          (t[2] = _),
            ...
            (o(
              ...
              o("WAWebBizBroadcastTos")
                ...
                .then(function () {
                  var e = o(
                    "WAWebBizBroadcastTos",
                  ).getBizBroadcastTosDebugInfo();
                  (o(
                    "WAWebBusinessBroadcastUserJourneyLogger",
                  ).BusinessBroadcastUserJourneyLogger.tosNuxAcceptSuccess(
                    n,
                    e,
                  ),
                    a());
                ...
                .catch(function (e) {
                  var t,
                    a =
                      (t = r("getErrorSafe")(e)) != null
                        ? t
                        : r("err")("unknown error"),
                    l = a.name + ": " + a.message,
                    s = o("WAWebBizBroadcastTos").getBizBroadcastTosDebugInfo();
                  (o(
                    "WAWebBusinessBroadcastUserJourneyLogger",
