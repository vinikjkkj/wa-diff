__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function s(t) {
      ...
      if (e()) {
        var s = new (o(
          ...
          esrSendResult: o("WAWebWamEnumEsrSendResultType").ESR_SEND_RESULT_TYPE
            .SUCCESS,
          isAGroup: !1,
    ...
    ((l.sendEphemeralSyncResponseSendWamEvent = s),
      (l.sendEphemeralSyncResponseSendErrorWamEvent = u),
      (l.sendEphemeralSyncResponseReceiveWamEvent = c));
  },
  98,
);
