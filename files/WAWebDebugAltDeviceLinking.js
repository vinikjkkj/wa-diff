__d(
  ...
  ["WABase64", "WAWebCryptoCurve25519"],
  function (t, n, r, o, a, i, l) {
    ...
    async function s() {
      var e = o("WABase64").decodeB64("MsKm2JQ="),
        ...
        a = await self.crypto.subtle.exportKey("raw", r);
    }
    ...
    async function u() {
      var e,
        t = {
          ...
          privKey: e.decodeB64("0Lsr1qHOQQwANO7PZA8bieCuP/RePLsd8Du4iyrFjEU="),
        },
        n = {
          pubKey: e.decodeB64("2MuFC9muN9evLf231QvfRPxgJ77rb9DFxrjPVSAU/Qw="),
          privKey: e.decodeB64("4OpA/0BlZ07ZPchtdzR1/UdDxUdlv9fCy/GQYkgZXUM="),
        },
        r = await o("WAWebCryptoCurve25519").sharedSecret(n.pubKey, t.privKey),
        a = await o("WAWebCryptoCurve25519").sharedSecret(t.pubKey, n.privKey);
    }
    u.doc = "test diffie hellman";
    var c = { checkDerived: s, testDH: u };
    l.default = c;
  },
  98,
);
