  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function m(t) {
      var n = t.destination,
        ...
        l = t.sessionId,
        s = t.uniqueIds,
        u = await c.getAccountLinkingData();
      if (u != null) {
        var d = u.accesstoken;
        try {
          var m = await o("WAWebRelayClient").commitMutation(
    ...
    async function p(e) {
      var t = e.crosspostingDestination,
        ...
        i = e.sessionId,
        l = e.statusMessageId,
        m = await c.getAccountLinkingData();
      if (m != null) {
        var p = m.accesstoken,
          _ = m.fbid,
          f = await o("WAWebAccountLinkingCryptoUtils").generateRSAKeys(),
          g = f.privateKey,
          h = f.publicKey,
          y = await o("WAWebAccountLinkingCryptoUtils").cryptoKeyToPem(h, !0),
          C = {
            version: 1,
            timestamp: Date.now(),
            access_token: p,
        ...
        if (_ != null)
          try {
            ...
            if (v.name === "EncryptedPayloadRequestResponseSuccess") {
              ...
              if ("waffle_xr" in I) {
                ...
                await o("WAWebCrosspostingHelper").processCrosspostingResponse(
                  T,
                  l,
                );
              }
              await o("WAWebCrosspostingHelper").logCrosspostingWamEvent({
          ...
          throw (
            o("WALogger")
              ...
              .tags("waffle", "crossposting", "iq")
              .sendLogs("waffle-crossposting-iq-null-fbid", { sampling: 0.01 }),
            r("err")("CrosspostingIQNullWaEntFbid")
          );
      }
    }
    ((l.makeEligibilityRequest = m), (l.makeCrosspostingIQ = p));
  },
  98,
);
