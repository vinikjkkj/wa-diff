  ...
  function (t, n, r, o, a, i, l) {
    function e(e) {
      ...
      return o("WAWebModelStorageUtils")
        .getStorage()
        .lock(["poll-votes"], async function (e) {
          var n = e[0],
            r = await n.anyOf(["parentMsgKey", "sender"], s(t)),
            a = new Map();
          for (var i of r) a.set(o("WAWebPollsGetVoteKey").getVoteKey(i), i);
          var l = [],
            u = [],
            c = [];
          for (var d of t) {
            ...
            p != null &&
              (p.ack != null && p.ack >= o("WAWebAck").ACK.SENT
                ? (h = Array.from(new Uint8Array(p.selectedOptionLocalIds)))
                : p.lastSuccessfulSelectedOptionLocalIds != null &&
                  (h = Array.from(
                    new Uint8Array(p.lastSuccessfulSelectedOptionLocalIds),
                  )));
            var y =
              h !== g.lastSuccessfulSelectedOptionLocalIds
          ...
          return (
            ...
            u.length > 0 && (await n.bulkCreateOrReplace(u)),
            l
          );
        });
    }
