      ...
      var Le = function (t) {
        ...
        xe = function (t) {
          ...
          if ((De(t, ["controller_set_video_element"]), t != null && e)) {
            var n = [
              ...
              ["ended", Be.onEnded],
              ["error", Be.onError],
              ["loadeddata", Be.onLoadedData],
              ["loadedmetadata", Be.onLoadedMetadata],
              ["pause", Be.onPause],
              ["play", Be.onPlay],
              ["playing", Be.onPlaying],
              ["progress", Be.onProgress],
              ["ratechange", Be.onRateChange],
              ["seeked", Be.onSeeked],
              ["seeking", Be.onSeeking],
              ["timeupdate", Be.onTimeUpdate],
              ["volumechange", Be.onVolumeChange],
              ["waiting", Be.onWaiting],
            ];
            for (var r of n) {
              var o = r[0],
                a = r[1];
        ...
        Pe = function (t) {
          ...
          if (
            ...
            if (
              (_ &&
                (t.loggingMetaData.instanceKey !== $e &&
                  (A(
                  ...
                  ($e = t.loggingMetaData.instanceKey)),
        ...
        Be = o(
          "VideoPlayerImplementationStateMachine",
        ).createReactVideoElementCallbacksForStateMachine(ve, De),
        We = pe(ve.getInitialState()),
        qe = _
          ? function (e, t) {
              return function () {
                A("[" + t + "] begin");
        ...
        Ue = {
          ...
          handleReactEffectCleanup: r("gkx")("24349")
            ? qe(we, "handleReactEffectCleanup")
            : qe(Fe, "handleReactEffectCleanup->handleReactUnmount"),
          handleReactEffectInit: r("gkx")("24349")
            ? qe(Me, "handleReactEffectInit")
            : qe(Ae, "handleReactEffectInit->handleReactMount"),
          handleReactPropsChanged: Pe,
          implementationController: Oe,
          initialExposedState: We,
          logFlusherToVPL: z,
          machine: ve,
          notifySubscribers: ne,
          videoElementCallbacks: Be,
          videoElementRefCallback: function (t) {
            (t == null && r("gkx")("17338")) ||
              De(t, ["videoElementRefCallback"]);
          },
        };
      return (
        _ && A("[created]", { engine: Ue, machine: ve, videoElementRef: oe }),
        {
          debugLog: A,
          engine: Ue,
