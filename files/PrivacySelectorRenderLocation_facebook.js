__d(
  ...
  function (t, n, r, o, a, i) {
    var e = n("$InternalEnum").Mirrored([
        ...
        "BIZWEB_HOME_CARDS",
        "BIZWEB_PAGE_PROFILE_MANAGEMENT",
        "BIZWEB_PAGE_PROFILE_MANAGEMENT_EDIT",
        "BIZWEB_SELF_VIEW",
        "BIZ_TAGGED_CONTENT_TAB",
        "BK_AVATAR_PRIVACY_PAGE",
        "BK_COMMUNITY_HELP_DRIVE_COMPOSER",
        "BK_CREATOR_BADGE_BOTTOM_SHEET",
        "BK_ECM",
        "BK_IGCCP_BACK_CATALOG",
        "BK_LIFE_EVENT_UPSELL_BOTTOMSHEET",
        "BK_MEMU_LIKENESS_SETTINGS",
        "BK_MSGR_PUBLIC_CHAT_SHARE_COMPOSER",
        "BK_PC_FRIEND_LIST_VISIBILITY_CONTROL",
        "BK_PERMALINK_BANNER_PRIVACY_CONTROL",
        "BK_PRIVACY_CENTER",
        "BK_PROFILE_ABOUT_CREATOR_BADGE",
        "BK_PROFILE_DIRECTORY",
        "BK_PROFILE_EDIT",
        "BPS_ADMIN_COMPOSER",
        "BPS_COMPOSER",
        "BPS_COMPOSER_PPE",
        "BPS_COMPOSER_STANDALONE_EDIT",
        "BPS_CREATOR_COMPOSER",
        "BPS_DIRECTED_PRIVACY",
        "BPS_FEED_UNIT_ICON_EDIT",
        "BPS_REELS_COMPOSER",
        "BPS_REELS_PPE",
        "BPS_REELS_STANDALONE_EDIT",
        "BPS_SHARE_SHEET",
        "BPS_STORIES",
        "BPS_STORIES_UEG",
        "BPS_STORY_STANDALONE_EDIT",
        "BPS_VIDEO_PRODUCTION_UNIFICATION",
        "BPS_WIDGETS_PUBLISHER",
        "BUNDLED_SETTINGS",
        ...
        "COMET_EVENTS_RSVP",
        "COMET_FULLSCREEN_COMPOSER",
        "COMET_FULLSCREEN_COMPOSER_PREVIEW",
        "COMET_FULLSCREEN_EDIT_COMPOSER",
        "COMET_GAMING_FEED",
        ...
        "COMET_PROFILE_ABOUT_DIRECTORY_PAGE",
        "COMET_PROFILE_ABOUT_PAGE",
        "COMET_PROFILE_ABOUT_PAGE_INLINE",
        "COMET_PROFILE_COLLECTIONS",
        "COMET_PROFILE_DIRECTORY_IA",
        "COMET_PROFILE_DIRECTORY_POST_CLICK_DIALOG",
        ...
        "COMET_RESOLVE_DEFAULT_FEED_AND_REELS_PRIVACY_CONFLICT",
        "COMET_ROOMS_TO_LIVE",
        "COMET_SETTING_APPS_AND_WEBSITES",
        "COMET_SETTING_TIMELINE",
        "COMET_SHARE_DIALOG",
        "COMET_STORIES_AUDIENCE_SETTING",
        "COMET_STORIES_CREATE",
        "COMET_STORIES_STANDALONE_EDIT",
        "COMET_STORY_CARD_HEADER_OWNER_INFO",
        "COMET_STORY_EDIT_COMPOSER",
        "COMET_STORY_MENU",
        "COMET_STREAM",
        "COMET_TWO_STEP_CREATOR_COMPOSER",
        ...
        "HELP_CENTER_SETTING",
        "HELP_CENTER_USF_SETTING",
        "IG_TO_FB_STORY_XPOST_PROFILE_PROMPT_UPSELL",
        ...
        "REGULATORY_DEFAULTS_FRAMEWORK",
        "RESOLVE_DEFAULT_FEED_AND_REELS_PRIVACY_CONFLICT",
        "RN_PROFILE_ABOUT",
        "SAVE_LIST",
        "SAY_THANKS",
        "SETTINGS",
        ...
        "UNIT_TEST",
        "UNKNOWN__FIX_ME",
        "USF_FAMILY_CENTER_SETTING",
        "USF_MESSENGER_FAMILY_CENTER_SETTING",
        "VIDEO_PLAYLIST",
        "VIDEO_UPLOAD",
        "WORK_PROFILE",
      ]),
