  ...
  function (t, n, r, o, a, i, l) {
    ...
    function x(e) {
      return r("WAWebSetReadReceiptJob")(e).then(function (e) {
        return (
          e.value !== "error" &&
            o("WAWebUserPrefsMultiDeviceDebug").setDebugReadReceipt(e.value),
          e
        );
      });
    }
    ...
    function w() {
      return (
        (w = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
              ...
              o("WALogger").WARN(
                m ||
                  (m = babelHelpers.taggedTemplateLiteralLoose([
                    "debug: setDeviceListEntry: no entry for ",
                    "",
                  ])),
                e,
              ),
                ...
                o("WALogger").WARN(
                  p ||
                    (p = babelHelpers.taggedTemplateLiteralLoose([
                      "debug: setDeviceListEntry: unsupported key: ",
                      "",
                    ])),
                  a,
                ),
          ...
          return o("WAWebSchemaDeviceList")
            .getDeviceListTable()
            .merge(e, t)
            .then(function () {
              return (
                o("WALogger").LOG(
                  _ ||
                    (_ = babelHelpers.taggedTemplateLiteralLoose([
                      "debug: setDeviceListEntry: update successful",
                    ])),
                ),
                !0
              );
    ...
    function X() {
      return (
        (X = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
          ...
          for (
            var a = o("WAWebWidFactory").createWid(e + "@c.us"), i = 0;
            i < t;
            i++
          ) {
            var l = "test-message-" + i,
            ...
            yield o("WAWebSendMsgJob").encryptAndSendMsg(
              {
      ...
      return (
        (ae = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
          (r("WAWebNetworkStatus").simulateNetworkStatus(!1),
            ...
            (o("WAWebSocketModel").Socket.stream = o(
              "WAWebSocketConstants",
    ...
    ce.doc = "update draft message job to update the text in the chat table";
    function de(e, t) {
    ...
    me.doc = "get chat row deserialized from DB";
    function _e(e) {
      o("WAWebUserPrefsMultiDeviceDebug").setDebugDecryptFail(e);
    }
    _e.doc = "Set the next N message decryptions to fail";
    function fe() {
      return o("WAWebUserPrefsMultiDeviceDebug").getDebugDecryptFail();
    }
    fe.doc = "Check how many more message decryptions are set to fail";
    function ge(e, t) {
    ...
    ge.doc = "Fails create-session for a given device";
    function he(e) {
      o("WAWebUserPrefsMultiDeviceDebug").setDebugDoNotSendRetryReceipt(e);
    }
    he.doc = "Set the next N retry receipts will not be sent";
    function ye() {
      return o(
        "WAWebUserPrefsMultiDeviceDebug",
      ).getDebugDoNotSendRetryReceipt();
    }
    ye.doc = "Check how many more retry receipts will be skipped";
    function Ce() {
    ...
    Ce.doc = "Dump all model data from IndexedDB";
    function ve() {
          ...
          var e = Array.from(
            ...
            t = e.map(
              (function () {
                var e = n("asyncToGeneratorRuntime").asyncToGenerator(
                  function* (e) {
                    var t = o("WAWebSignalStorageUtils").getStorage().table(e),
                      n = yield t.all();
                    return [e, n];
                  },
                );
    ...
    ve.doc = "Dump all signal data from IndexedDB";
    function Re(e) {
      return Le.apply(this, arguments);
    }
    function Le() {
    ...
    ((ke.doc = "Opens the Lists Intro Popup"), (ke.paramsToExecute = []));
    function Ie(e) {
    ...
    (($e.doc = "Send a raw wam event (used by UWP Hybrid app)"),
      ($e.paramsToExecute = []));
    function Ne(e, t) {
      o("WAWebTos").TosManager.setState(e, t, o("WATimeUtils").unixTime());
    }
    Ne.doc = "Set the state of a given TOS notice";
    function Me(e) {
        ...
        (Ae = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e) {
          var t = 0,
            ...
            r = yield o(
              ...
              { userId: n, deviceId: t, accessToken: e },
              "recovery",
            );
          return r ===
    ...
    we.doc = "Store canonical credentials directly (for E2E tests)";
    function Fe() {
      return o("WAWebCanonicalUtils").isCanonicalPresent();
    }
    Fe.doc = "Check if canonical token has been stored";
    function Oe(e) {
      return Be.apply(this, arguments);
    }
    function Be() {
    ...
    var Ve = babelHelpers.extends(
      ...
      r("WAWebDebugNewsletterAdminInsights"),
      r("WAWebDebugNewsletterSimilar"),
      r("WAWebDebugFlipper"),
      r("WAWebDebugComments"),
      r("WAWebDebugCommunity"),
      r("WAWebDebugNux"),
      r("WAWebDebugPolls"),
      r("WAWebDebugEvents"),
      r("WAWebDebugReactions"),
      r("WAWebDebugScheduledMessages"),
      r("WAWebDebugScreenLock"),
      r("WAWebDebugSmb"),
      r("WAWebDebugSocket"),
      r("WAWebDebugSyncd"),
      o("WAWebDebugRichTextInput").WAWebDebugRichTextInput,
      r("WAWebDebugUI"),
      r("WAWebDebugHybrid"),
      r("WAWebDebugEphemerality"),
      r("WAWebDebugMessagingInfra"),
      r("WAWebDebugBookingConfirmation"),
      r("WAWebDebugInAppSignupConfirmation"),
      r("WAWebDebugMultiStepForm"),
      r("WAWebDebugSignupAGM"),
      r("WAWebDebugPaymentReminders"),
      r("WAWebDebugPrivacyExperience"),
      r("WAWebDebugDB"),
      r("WAWebDebugBot"),
      r("WAWebDebugGDPR"),
      r("WAWebDebugLidMigration"),
      r("WAWebDebugContacts"),
      r("WAWebDebugChatAssignment"),
      r("WAWebDebugChatLock"),
      r("WAWebDebugCommunityNavigation"),
      r("WAWebDebugMex"),
      r("WAWebDebugToast.react"),
      r("WAWebDebugStickerPack"),
      r("WAWebDebugACS"),
      r("WAWebDebugNux"),
      r("WAWebDebugMisc"),
      r("WAWebDebugNct"),
      r("WAWebDebugTabs"),
      r("WAWebAccountLinkingDebug"),
      r("WAWebDebugGalaxyFlow"),
      r("WAWebDebugAds"),
      r("WAWebDebugStatus"),
      r("WAWebDebugTextStatus"),
      r("WAWebDebugSmax"),
      r("WAWebDebugUsername"),
      r("WAWebDebugUsync"),
      r("WAWebDebugCallingGroupCalling"),
      r("WAWebDebugCallingNavNux"),
      r("WAWebDebugCapping"),
      ...
      r("WAWebDebugOutContacts"),
      {
        ...
        getEstimatedFTSDbSize: o("WAWebEstimateFtsStorageApi")
          .getEstimatedFTSDbSize,
        getEstimatedIndexedDbUsage: o("WAWebEstimateIndexeddbUsageApi")
        ...
        getChatDeserializedFromDBById: me,
        updateDraftMessageChatDb: ce,
        updateDraftMessageChatUiAndDb: de,
        sendAllLogs: Re,
        decodeStanza: Z,
        voipWinRTBridge:
          n("cr:17219") == null ||
        ...
        setDebugDecryptFail: _e,
        getDebugDecryptFail: fe,
        setDebugEncryptFail: ge,
        setDebugDoNotSendRetryReceipt: he,
        getDebugDoNotSendRetryReceipt: ye,
        ...
        getReportingInfoRow: Ie,
        triggerReportingTokenCleanup: De,
        ...
        setTosState: Ne,
        overrideFacebookGraphQLEndpointForTest: Ee,
        getPrivacyDisallowedListTableContents: O,
        setSharerSkipPreference: Me,
        setCanonicalToken: we,
