  ...
  function (t, n, r, o, a, i, l) {
    ...
    ((h.name = "HistorySync"),
      (h.internalSpec = {
        ...
        pushnames: [7, e.FLAGS.REPEATED | e.TYPES.MESSAGE, R],
        globalSettings: [8, e.TYPES.MESSAGE, k],
        threadIdUserSecret: [9, e.TYPES.BYTES],
        threadDsTimeframeOffset: [10, e.TYPES.UINT32],
        recentStickers: [11, e.FLAGS.REPEATED | e.TYPES.MESSAGE, T],
        pastParticipants: [12, e.FLAGS.REPEATED | e.TYPES.MESSAGE, D],
        callLogRecords: [
          13,
          e.FLAGS.REPEATED | e.TYPES.MESSAGE,
        ...
        phoneNumberToLidMappings: [15, e.FLAGS.REPEATED | e.TYPES.MESSAGE, C],
        companionMetaNonce: [16, e.TYPES.STRING],
        shareableChatIdentifierEncryptionKey: [17, e.TYPES.BYTES],
        accounts: [18, e.FLAGS.REPEATED | e.TYPES.MESSAGE, v],
        nctSalt: [19, e.TYPES.BYTES],
        inlineContacts: [20, e.FLAGS.REPEATED | e.TYPES.MESSAGE, b],
        inlineContactsProvided: [21, e.TYPES.BOOL],
      }),
      (y.name = "Conversation"),
      (y.internalSpec = {
        id: [1, e.FLAGS.REQUIRED | e.TYPES.STRING],
        messages: [2, e.FLAGS.REPEATED | e.TYPES.MESSAGE, S],
        ...
        participant: [20, e.FLAGS.REPEATED | e.TYPES.MESSAGE, L],
        ...
        wallpaper: [26, e.TYPES.MESSAGE, E],
      ...
      (C.name = "PhoneNumberToLIDMapping"),
      (C.internalSpec = {
        pnJid: [1, e.TYPES.STRING],
        lidJid: [2, e.TYPES.STRING],
      }),
      (b.name = "InlineContact"),
      (b.internalSpec = {
        pnJid: [1, e.TYPES.STRING],
        lidJid: [2, e.TYPES.STRING],
      ...
      (E.name = "WallpaperSettings"),
      (E.internalSpec = {
        filename: [1, e.TYPES.STRING],
        opacity: [2, e.TYPES.UINT32],
        isGenAi: [3, e.TYPES.BOOL],
      }),
      (k.name = "GlobalSettings"),
      (k.internalSpec = {
        lightThemeWallpaper: [1, e.TYPES.MESSAGE, E],
        mediaVisibility: [2, e.TYPES.ENUM, _],
        darkThemeWallpaper: [3, e.TYPES.MESSAGE, E],
        autoDownloadWiFi: [4, e.TYPES.MESSAGE, I],
        autoDownloadCellular: [5, e.TYPES.MESSAGE, I],
        autoDownloadRoaming: [6, e.TYPES.MESSAGE, I],
        ...
        avatarUserSettings: [11, e.TYPES.MESSAGE, $],
        ...
        individualNotificationSettings: [17, e.TYPES.MESSAGE, P],
        groupNotificationSettings: [18, e.TYPES.MESSAGE, P],
        chatLockSettings: [
          19,
          e.TYPES.MESSAGE,
      ...
      (D.name = "PastParticipants"),
      (D.internalSpec = {
        groupJid: [1, e.TYPES.STRING],
        pastParticipants: [2, e.FLAGS.REPEATED | e.TYPES.MESSAGE, x],
      }),
      (x.name = "PastParticipant"),
      (x.internalSpec = {
      ...
      (l.PhoneNumberToLIDMappingSpec = C),
      (l.InlineContactSpec = b),
      (l.AccountSpec = v),
      (l.HistorySyncMsgSpec = S),
      (l.PushnameSpec = R),
      (l.GroupParticipantSpec = L),
      (l.WallpaperSettingsSpec = E),
      (l.GlobalSettingsSpec = k),
      (l.AutoDownloadSettingsSpec = I),
      (l.StickerMetadataSpec = T),
      (l.PastParticipantsSpec = D),
      (l.PastParticipantSpec = x),
      (l.AvatarUserSettingsSpec = $),
      (l.NotificationSettingsSpec = P));
  },
  98,
);
