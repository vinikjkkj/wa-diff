__d(
  ...
  function (t, n, r, o, a, i, l) {
            ...
            (o("WALogger").LOG(
              e ||
                (e = babelHelpers.taggedTemplateLiteralLoose([
                  "[SeamlessMigration] RequestIsSeamlessMigrationEnabledStateRequested ",
                  " and max retries ",
                  "",
                ])),
              n,
              ...
              o("WAWebCmd").Cmd.on("on_initial_chat_synced", function () {
                if (t.$3()) {
                  var e = o("WAWebUserPrefsMeUser").getMaybeMeDevicePn();
                  e != null && t.$1.requestUserPrefsMigration(e.toJid());
                }
              }));
              ...
              (o("WALogger").LOG(
                s ||
                  (s = babelHelpers.taggedTemplateLiteralLoose([
                    "[SeamlessMigration] RequestIsFilesCleanupEnabledStateRequested ",
                    "",
                  ])),
                i,
              ),
    ...
    l.WindowsHybridBridgeSeamlessMigration_v2604 = c;
  },
  98,
);
