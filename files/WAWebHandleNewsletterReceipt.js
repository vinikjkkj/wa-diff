__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function u(t) {
      ...
      if (n !== o("WAAckLevel").ACK.READ && n !== o("WAAckLevel").ACK.PLAYED)
        throw (
          o("WALogger").WARN(
            e ||
      ...
      var _ =
        ...
        o("WAWebWidFactory")
          .asUserWidOrThrow(c)
          .equals(o("WAWebUserPrefsMeUser").getMePnUserOrThrow_DO_NOT_USE());
      if (!_)
        throw (
          o("WALogger").WARN(
            s ||
      ...
      var h =
        ...
        y = o("WAWebMessageReceiptBatcher").receiptBatcher.acceptPeerReceipt({
          isOffline: h,
          ack: n,
          ts: m,
          remote: l,
