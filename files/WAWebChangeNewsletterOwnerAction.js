__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function p(t, n) {
      ...
      var l =
        (i = t.newsletterMetadata) == null ? void 0 : i.subscribers.get(n.id);
      if (l == null)
        throw (
          o("WALogger")
            .ERROR(
      ...
      try {
        ...
        (await o("WAWebNewsletterChangeOwnerJob").changeNewsletterOwner(_, p),
          await o(
            "WAWebNewsletterBridgeApi",
          ).NewsletterBridgeApi.updateMyNewsletterMembershipRole({
            newsletter: t,
            newRole: o("WAWebCommonNewsletterEnums").NewsletterMembershipType
              .Admin,
          }),
          await o(
            "WAWebNewsletterBridgeApi",
