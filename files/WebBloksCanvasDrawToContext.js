__d(
  ...
  function (t, n, r, o, a, i, l) {
    var e = "bk.types.CanvasFill",
      s = "bk.types.CanvasGroup",
      u = "bk.types.CanvasLayer",
      c = "bk.types.CanvasPath",
      d = "bk.types.CanvasPathAdd",
      m = "bk.types.CanvasPathArc",
      p = "bk.types.CanvasPathCircle",
      _ = "bk.types.CanvasPathClose",
      f = "bk.types.CanvasPathCubicTo",
      g = "bk.types.CanvasPathEllipse",
      h = "bk.types.CanvasPathLineTo",
      y = "bk.types.CanvasPathMoveTo",
      C = "bk.types.CanvasPathQuadTo",
      b = "bk.types.CanvasPathRect",
      v = "bk.types.CanvasShapeArc",
      S = "bk.types.CanvasShapeCircle",
      R = "bk.types.CanvasShapeEllipse",
      L = "bk.types.CanvasShapeLine",
      E = "bk.types.CanvasShapeRect",
      k = "bk.types.CanvasStroke",
      I = "bk.types.CanvasTransform",
      T = "bk.types.CanvasTransformInverseV2",
      D = "bk.types.CanvasTransformRotate",
      x = "bk.types.CanvasTransformScale",
      $ = "bk.types.CanvasTransformSkew",
      P = "bk.types.CanvasTransformSkewV2",
      N = "bk.types.CanvasTransformTranslate";
    function M(t, n, r) {
      switch (t.styleId) {
        case s:
