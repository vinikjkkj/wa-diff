__d(
  ...
  function (t, n, r, o, a, i, l) {
    var e, s, u, c, d, m;
    async function p(t, n, a, i, l, p, _) {
      var f = t.data.to,
        g = t.data.id.id;
      o("WALogger")
        .LOG(
      ...
      try {
        var C,
          b = f.isRegularUserPn()
            ...
            : (C = o("WAWebUserPrefsMeUser").getMaybeMeDeviceLid()) != null
              ? C
              : o("WAWebUserPrefsMeUser").getMeDevicePnOrThrow_DO_NOT_USE(),
          v = await o("WAWebDBDeviceListFanout").getFanOutList({
            wids: [f, b],
          }),
        ...
        var L = await o("WAWebSendMsgToDeviceList").sendMsgToDeviceList(
            t,
            n,
            S,
            {
