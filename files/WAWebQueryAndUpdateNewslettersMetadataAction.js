__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function L(t, n) {
      ...
      try {
        ...
        return (
          ...
          l == null || l.addPoint("fetchAdminCountsForOwnerNewsletter_end"),
          o("WALogger").LOG(
            s ||
    ...
    async function E(e, t) {
      ...
      try {
        ...
        var s = o("WAWebNewsletterModelUtils").mapNewsletterToChat(l),
          ...
          c =
            (n = l.newsletterPictureMetadataMixin) == null ? void 0 : n.picture,
          d = c
            ? [
                o("WAWebNewsletterModelUtils").mapPicturesToProfilePicThumb(
                  e,
            ...
            : [],
          f = await k(e, t == null ? void 0 : t.adminFields),
          g = f.adminCount,
          h = f.adminProfile,
    ...
    async function k(e, t) {
      ...
      var l = await o("WAWebNewsletterGetAdminInfoJob").getNewsletterAdminInfo(
        e,
      );
      return {
