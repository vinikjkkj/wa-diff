  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function _(e) {
      var t = e.CallCreatorDeviceJid,
        ...
        m = e.Type,
        p = e.VideoEnabled;
      if (o("WAWebVoipJsonParserPayloads").UpdateJoinableCallLogType == null)
        throw r("err")(
          "WAWebVoipActionWriteCallLogEventUpdateJoinable: Expected UpdateJoinableCallLogType to be defined",
        );
      var _, f;
      if (
        m === o("WAWebVoipJsonParserPayloads").UpdateJoinableCallLogType.Create
      ) {
        if (t == null)
          throw r("err")(
        ...
        if (g != null)
          ...
          var h,
            ...
            C = await o("WAWebCallLogUtils").getCallLogTargetDetails({
              ...
              (k = k.map(function (e) {
                ...
                return t
                  ? babelHelpers.extends({}, e, {
                      outcome:
                        t.State ===
                        o("WAWebVoipWaCallEnums").CallSummaryUserState.Connected
        ...
        ((_ = babelHelpers.extends({}, E.toJSON(), {
          ...
          isVideoCall: E.isVideoCall || (i == null ? void 0 : i.IsVideo) || p,
          callDuration:
      ...
      m === o("WAWebVoipJsonParserPayloads").UpdateJoinableCallLogType.Delete
    ...
    ((l.cleanupJoinableCallLog = m),
      (l.generateCallLogFromEventUpdateJoinable = p));
  },
  98,
);
