  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function d(e) {
      var t,
        ...
        r = await o("WADeprecatedSendIq").deprecatedSendIq(n, c);
    ...
    async function m(e) {
      if (!r("gkx")("26258")) {
        ...
        await o("WADeprecatedSendIq").deprecatedSendIq(a, n);
      }
    }
    async function p(e) {
      var t,
        n = new (r("WADeprecatedWapParser"))("tosNoticesSet", r("WAWebNoop")),
        a = (t = o("WAWap")).wap(
          "iq",
          {
            xmlns: "tos",
