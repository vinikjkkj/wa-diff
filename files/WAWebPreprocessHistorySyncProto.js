  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function h(t, n) {
      ...
      var i = new Map(),
        ...
        I = await o("WAWebUserPrefsAppStateSync").getAllCriticalDataSynced(),
      ...
      for (
        ...
        var J = o("WAWebHistorySyncLidChatGating").isForcedHistoryLidChat()
            ? $[q]
            : await o("WAWebApiChatCommon").getChatMaybeByHistory(H),
          Z =
        ...
        if (
          ...
          for (var te = 0; te < V.messages.length; te++) {
            ...
            var ie = V.messages[te],
              le = o("WALongInt").maybeNumberOrThrowIfTooLarge(ie.msgOrderId);
            if (!(G != null && G !== -1 && le != null && le >= G)) {
              ...
              if (
                ...
                var de = await o("WAWebSchemaMessage")
                  .getMessageTable()
                  .betweenCount(
                    ["internalId"],
              ...
              if (
                ...
                if (D >= pe.batchSize) {
                  ...
                  (O.length < 3 &&
                    O.push(
                      "processT=" + fe + "ms targetT=" + ge + "ms batch=" + D,
                    ),
                    o(
                      "WAWebHistorySyncDynamicThrottlingManager",
                    ...
                    pe.delayMs > 0 &&
                      (B++,
                      (W += pe.delayMs),
                      await o("WAAsyncSleep").asyncSleep(pe.delayMs)),
                    (D = 0),
                    (T = self.performance.now()));
                }
              } else
      ...
      return (
        ...
        B > 0 &&
          o("WALogger")
            ...
            .tags("history-sync"),
        o("WAWebHistorySyncNotificationCommonUtils").reportMissingMapping(i),
        {
