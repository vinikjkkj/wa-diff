    ...
    async function c(t) {
      try {
        return await o(
          ...
          o("WAWebNewsletterValidationUtils").toNewsletterJidOrThrow(t.toJid()),
        );
      } catch (l) {
        var n =
          l != null && typeof l == "object" && "status" in l ? l.status : null;
        if (n === 423)
          try {
            ...
            o("WALogger")
              ...
              .catching(a)
              .tags("newsletter")
              .sendLogs("newsletter-subscribe-to-live-updates-suspend-error");
            return;
          }
        else if (n === 451)
          try {
