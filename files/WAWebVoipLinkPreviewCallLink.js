__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    async function v(t, n) {
      ...
      I || (r("WAWebCallCollection").setPendingCallLink({ isVideo: k }), C());
      try {
        await o("WAWebEnsureVoipInited").ensureVoipInitialized();
      } catch (e) {
        (o("WALogger").LOG(
          c ||
      ...
      var T = o("WAWebFrontendContactGetters").getMyUsername(),
        D = await o("WAWebVoipStackInterface").getVoipStackInterface();
      if (D == null) {
        (o("WALogger").LOG(
          d ||
      ...
      var x = await D.previewCallLink(R, k, n, T, E === !0);
      (l === !0 && D.type === "web" && (await D.setCallMute(!0)),
        h === !0 &&
          D.type === "web" &&
          (x === 0
            ? await D.joinCallLink()
            : o("WALogger").LOG(
                _ ||
