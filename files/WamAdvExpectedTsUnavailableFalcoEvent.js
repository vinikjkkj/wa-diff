__d(
  "WamAdvExpectedTsUnavailableFalcoEvent",
  [
    "FalcoLoggerInternal",
    "Promise",
  ...
  function (t, n, r, o, a, i, l) {
    ...
    var e,
      s,
      u = r("getFalcoLogPolicy_DO_NOT_USE")("8186"),
      c = {
        app_build: (s = r("requireDeferred"))(
          "WAWebFalcoCanonicalAppBuild",
        ).__setRef("WamAdvExpectedTsUnavailableFalcoEvent"),
    ...
    var m = o("FalcoLoggerInternal").create(
        "wam_adv_expected_ts_unavailable",
        u,
        d,
      ),
      p = m;
