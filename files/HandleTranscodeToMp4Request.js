__d(
  ...
  ["VideoTranscodeUtils", "WAResultOrError"],
  function (t, n, r, o, a, i, l) {
    ...
    async function u(t) {
      ...
      var f = await _.getOptionalMetadata(u),
        g = f.metadataInfo,
        h = f.transcodeInput;
      ...
      var b = y ? o("WAResultOrError").makeError("invalid-media") : await m(u);
      if (b.success === !0)
        return (
      ...
      var E = await _.transcode(h);
      if (E.success === !0) {
        d.addPoint("transcode_end");
        var k = await _.getOptionalMetadata(E.value.resultBuffer),
          I = k.metadataInfo;
        (o("VideoTranscodeUtils").annotateVideoMetadata({
          metadata: I,
          eventFlow: d,
        ...
        var T = await m(E.value.resultBuffer);
        if (T.success === !0)
          return (
