__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    async function C(e, t) {
      try {
        var n = o("WAWebProtobufsE2E.pb").Message$PinInChatMessage$Type.cast(t);
        if (n == null) {
          o("WALogger").ERROR(
            c ||
        ...
        var r;
        if (typeof e == "string") {
          var a = await o("WAWebMsgCollection").MsgCollection.getMessagesById([
              e,
            ]),
            i = a.messages;
        ...
        o("WALogger").LOG(
          d ||
            (d = babelHelpers.taggedTemplateLiteralLoose(["sendPinMsg: ", ""])),
          String(r),
        );
      } catch (e) {
        o("WALogger").WARN(
    ...
    async function b() {
      var e = "Hey, this is the parent message",
        t = y(),
        n = r("WANullthrows")(
          await o("WAWebSendTextMsgChatAction").createTextMsgData(t, e),
        ),
        a = new (o("WAWebMsgModel").Msg)(n);
      g("Sending orphan pin message. Will pause for 10s after this.");
      var i = await o("WAWebSendPinMessageAction").sendPinInChatMsg(
        a,
      ...
      (await o("WAPromiseDelays").delayMs(1e4),
        ...
        await o("WAWebSendTextMsgChatAction").addAndSendTextMsg(t, n),
        o("WALogger").LOG(
          p ||
    ...
    ((v.doc = "Toggle pins debug mode"), (v.paramsToExecute = []));
    function S() {
      var e,
        t =
    ...
    ((S.doc = "Get pins debug mode"), (S.paramsToExecute = []));
    var R = {
      sendPinMsg: C,
      createOrUpdatePinInChatDebug: h,
      testOrphanPinMsg: b,
      togglePinsDebugMode: v,
      getPinsDebugMode: S,
    };
    l.default = R;
  },
