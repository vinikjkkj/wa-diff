  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function s(t, n, a) {
      ...
      var c = o("WAWebWidFactory").createWid(n),
        d;
      try {
        d = await o("WAWebCatalogCollection").CatalogCollection.find(c);
      } catch (e) {
        return null;
      }
      var m =
      ...
      if (m == null || m.reviewStatus !== "APPROVED" || m.isHidden) return null;
      ...
      if (p) {
        var f = [
          ...
          g = await o("WAWebMediaDataUtils").getResizedThumbData(p.mediaUrl, f);
        _ = g[0];
      }
      var h;
      if (
      ...
      a != null
        ? ((v = r("fbs")
            ._(/*BTDS*/ "{productName} from {catalogOwnerName} on WhatsApp.", [
