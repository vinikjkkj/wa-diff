__d(
  ...
  [
    ...
    "WAWebWindowsHybridBridge.v2572",
    "WAWebWindowsHybridBridge.v2573",
  ...
  function (t, n, r, o, a, i, l) {
    ...
    function y(e, t) {
      try {
        return e != null && e.startsWith("2572")
          ? new (o("WAWebWindowsHybridBridge.v2572").WindowsHybridBridge_v2572)(
              o("WAWebWindowsHybridFlowHelpers").unsafeCastCustomWebView(t),
            )
          : e != null && e.startsWith("2573")
            ? new (o(
                "WAWebWindowsHybridBridge.v2573",
              ).WindowsHybridBridge_v2573)(
                o("WAWebWindowsHybridFlowHelpers").unsafeCastCustomWebView(t),
              )
            : e != null && e.startsWith("2574")
              ? new (o(
                  "WAWebWindowsHybridBridge.v2574",
                ).WindowsHybridBridge_v2574)(
                  o("WAWebWindowsHybridFlowHelpers").unsafeCastCustomWebView(t),
                )
