  ...
  function (t, n, r, o, a, i, l) {
    ...
    function d(t) {
      try {
        ...
        return p != null && p.isValid
          ...
          : {
              status: s.INVALID,
              type: o("WAWebBizBroadcastsTypedError").PhoneError.INVALID,
            };
      } catch (n) {
        return (
          o("WALogger")
    ...
    function m(e) {
      if (e == null || typeof e != "string")
        return {
          status: s.INVALID,
          type: o("WAWebBizBroadcastsTypedError").NameError.INVALID,
        };
      var t = Array.from(e).slice(0, u).join("");
      return t.trim().length === 0
        ? {
            status: s.INVALID,
            type: o("WAWebBizBroadcastsTypedError").NameError.EMPTY,
          }
