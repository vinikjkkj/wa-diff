      ...
      if (
        ...
        try {
          var h = await o(
            ...
            downloadQpl: g,
            downloadOrigin: r("WAWebMediaGetDownloadOriginForMsg")(i.unsafe()),
          });
          if (h) {
...
`,
    ...
    async function h(e) {
      ...
      if (
        ...
        if (!(g && (g.thumbnailHeight == null || g.thumbnailWidth == null))) {
          o("WALogger").LOG(
            m ||
