__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function u(t, n, r) {
      var a = await o("WAWebSchemaGroupMetadata")
      ...
      if (a != null) {
        ...
        ((i.wamTypeOfGroup = o("WAWebGroupType").groupTypeToWamEnum(s)),
          ...
          (i.isOpenBotGroup =
            o(
              "WAWebBotGroupGatingUtils",
            ).isOpenGroupBotParticipantAddEnabled() && a.isOpenBotGroup === !0),
          (i.isTeeBotGroup =
            o(
              "WAWebBotGroupGatingUtils",
            ).isTEEGroupBotParticipantAddEnabled() && a.isTeeBotGroup === !0));
      }
      if (n != null) {
    ...
    async function c(e) {
      var t = await o("WAWebSchemaParticipant").getParticipantTable().get(e);
      return (
        t == null &&
          o("WALogger").WARN(
            s ||
    ...
    ((l.getGroupData = u),
      (l.getParticipantRecord = c),
      (l.isCagAddon = d),
      (l.formatWidTypeCountsForLog = m),
      (l.formatGroupTypeForLog = p));
  },
  98,
);
