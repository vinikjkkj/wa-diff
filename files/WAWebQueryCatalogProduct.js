  ...
  function (t, n, r, o, a, i, l, s) {
    var e,
      ...
      d = async function () {
        ...
        try {
          var C,
            b = await o("WAWebRelayClient").fetchQuery(
              e !== void 0
                ? e
      ...
      m = async function () {
        ...
        var r = t[0],
          ...
          _ = t[7],
          f = t[8],
          g = await o("WAWebBizCatalogManagementFetchProduct").fetchProduct({
            product: {
              jid: r.toJid(),
              product_id: a,
              width: String(i),
        ...
        if (g.type === "graphql-error") {
          ...
          if (g.type === "recovery-required")
            throw new (o("WAWebBackendErrors").AdAccountRecoveryRequiredError)(
              g.emailMask,
            );
