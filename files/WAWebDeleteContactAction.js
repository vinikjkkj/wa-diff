  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function h(t) {
      ...
      var i = t.phoneNumber || t.lid,
        ...
        m = o("WAWebContactSyncLogger").contactSyncLogger.createEventContext({
      ...
      try {
        await o("WAWebContactSyncApi").handleLidSync(p);
      } catch (e) {
        throw (
          o("WALogger")
            .ERROR(
      ...
      try {
        await o("WAWebHandleUsernameSync").handleUsernameSync(p);
      } catch (e) {
        throw (
          o("WALogger")
            .ERROR(
      ...
      if ((y.setNotMyContact(), t.lid)) {
        ...
        await o("WAWebSaveContactAction").runOrSendClientErrorLogs(
          ...
          function () {
            return o("WAWebContactEditSync").sendUsernameContactDelete(C, b);
          },
        );
      } else {
        var v = t.phoneNumber;
      ...
      (d > 0 &&
        ...
        g.length > 0 &&
          (await o("WAWebSaveContactAction").runOrSendClientErrorLogs(
            ...
            function () {
              return o("WAWebContactEditSync").sendContactDeleteBatch(g);
            },
          )));
    }
    function C(e) {
    ...
    ((l.deleteContactAction = h), (l.deleteContactBatchAction = y));
  },
  98,
);
