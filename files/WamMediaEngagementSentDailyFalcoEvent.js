__d(
  "WamMediaEngagementSentDailyFalcoEvent",
  [
    "FalcoLoggerInternal",
    "Promise",
  ...
  function (t, n, r, o, a, i, l) {
    ...
    var e,
      s,
      u = r("getFalcoLogPolicy_DO_NOT_USE")("8209"),
      c = {
        app_build: (s = r("requireDeferred"))(
          "WAWebFalcoCanonicalAppBuild",
        ).__setRef("WamMediaEngagementSentDailyFalcoEvent"),
    ...
    var m = o("FalcoLoggerInternal").create(
        "wam_media_engagement_sent_daily",
        u,
        d,
      ),
      p = m;
