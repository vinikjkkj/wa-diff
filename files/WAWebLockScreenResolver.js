  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    async function h() {
        ...
        (o("WALogger").LOG(
          ...
          o("WAWebModalManager").ModalManager.open(
            _.jsx(o("WAWebConfirmPopup.react").ConfirmPopup, {
              ...
              okText: s._(/*BTDS*/ "OK"),
              children: s._(/*BTDS*/ "End your call before locking the app."),
            }),
          ));
        return;
      }
      ...
      if (
        ...
        await o("WAWebMsgCollection").MsgCollection.encryptAndClearModels(),
        o(
          "WAWebUserPrefsInfoStore",
      ...
      (await o("WAWebCryptoEncKeyHelper").initEncSalt(), t.socketLoop.start());
    }
