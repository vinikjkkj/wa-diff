__d(
  "LexicalLink.prod",
  ["Lexical", "LexicalA11y", "LexicalExtension", "LexicalHtml", "LexicalUtils"],
  function $module_LexicalLink_prod(
    ...
    var _excluded = ["url"],
      _excluded2 = ["url"];
    var s = new Set(["http:", "https:", "mailto:", "sms:", "tel:"]);
    var _o5 = (function (_n$ElementNode) {
      function o(e, t, n) {
        var _this;
        if (e === void 0) {
          e = "";
        ...
        _this = _n$ElementNode.call(this, n) || this;
        var _t = t,
          _t$target = _t.target,
          ...
          _t$title = _t.title,
          s = _t$title === void 0 ? null : _t$title;
        ((_this.__url = e),
          (_this.__target = r),
          (_this.__rel = i),
          (_this.__title = s));
      ...
      babelHelpers.inheritsLoose(o, _n$ElementNode);
      ...
      _proto.$config = function $config() {
        return this.config("link", {
          ...
          importDOM: {
            a: function a() {
              return { conversion: c, priority: 1 };
            },
          },
        });
      };
      _proto.afterCloneFrom = function afterCloneFrom(e) {
        (_n$ElementNode.prototype.afterCloneFrom.call(this, e),
          (this.__url = e.__url),
          (this.__rel = e.__rel),
      ...
      _proto.createDOM = function createDOM(e) {
        var t = require("Lexical").$getDocument().createElement("a");
        return (
          this.updateLinkDOM(null, t, e),
          require("Lexical").addClassNamesToElement(t, e.theme.link),
          t
        );
      };
      _proto.updateLinkDOM = function updateLinkDOM(e, t, r) {
        if (require("Lexical").isHTMLAnchorElement(t)) {
          (e && e.__url === this.__url) ||
            (t.href = this.sanitizeUrl(this.__url));
          for (var _n of ["target", "rel", "title"]) {
            var _r = "__" + _n,
              _i = this[_r];
            (e && e[_r] === _i) || (_i ? (t[_n] = _i) : t.removeAttribute(_n));
          }
        }
      };
      ...
      _proto.updateFromJSON = function updateFromJSON(e) {
        return _n$ElementNode.prototype.updateFromJSON
          .call(this, e)
          .setURL(e.url)
          .setRel(e.rel || null)
      ...
      _proto.sanitizeUrl = function sanitizeUrl(e) {
        ...
        try {
          var _t2 = new URL(L(e));
          if (!s.has(_t2.protocol)) return "about:blank";
        } catch (e) {
          var _n2 = t
            .replace(/[\u0000-\u001F\u007F\s]/g, "")
            .match(/^([a-z][a-z0-9+.-]*):/i);
          if (null != _n2 && !s.has(_n2[1].toLowerCase() + ":"))
            return "about:blank";
        }
        return e;
      };
      _proto.exportJSON = function exportJSON() {
        return babelHelpers["extends"](
          {},
          _n$ElementNode.prototype.exportJSON.call(this),
          {
            rel: this.getRel(),
      ...
      _proto.extractWithChild = function extractWithChild(e, t, r) {
        if (!require("Lexical").$isRangeSelection(t)) return !1;
        var i = t.anchor.getNode(),
          s = t.focus.getNode();
        return (
          (this.is(i) || this.isParentOf(i)) &&
          (this.is(s) || this.isParentOf(s)) &&
          t.getTextContent().length > 0
        );
      };
      ...
      _proto.shouldMergeAdjacentLink = function shouldMergeAdjacentLink(e) {
        return (
          ...
          this.getTarget() === e.getTarget() &&
          this.getRel() === e.getRel() &&
          this.getTitle() === e.getTitle()
        );
      };
      return o;
    })(require("Lexical").ElementNode);
    function l(e) {
      var t = require("Lexical").$caretFromPoint(e, "next");
      return [t, t.getFlipped()];
    }
    function a(e, t) {
      for (var _r2 of t)
        if (_r2.origin.isAttached()) {
          var _t3 = require("Lexical").$normalizeCaret(_r2);
          return void require("Lexical").$setPointFromCaret(e, _t3);
        }
    }
    function u(e) {
      ...
      function s() {
        require("Lexical").$isRangeSelection(t) &&
          (a(t.anchor, r),
          a(t.focus, i),
          require("Lexical").$normalizeSelection__EXPERIMENTAL(t));
      }
      require("Lexical").$isRangeSelection(t) &&
        ((r = l(t.anchor)), (i = l(t.focus)));
      var o = !1;
      for (var _t4 of require("Lexical").$getChildCaret(e, "next")) {
        var _r3 = _t4.origin;
        if (require("Lexical").$isElementNode(_r3) && !_r3.isInline()) {
          var _i2 = _r3.getChildren();
          if (_i2.length > 0) {
            var _t5 = require("Lexical").$copyNode(e);
            (_t5.append.apply(_t5, _i2), _r3.append(_t5), (o = !0));
          }
          require("Lexical").$insertNodeToNearestRootAtCaret(
            _r3,
            require("Lexical").$rewindSiblingCaret(_t4),
            {
      ...
      function u(e, t, r) {
        var i = e[0],
          s = e[1],
          o = function o(e) {
            return require("Lexical").$isSiblingCaret(e) && e.origin.is(t);
          };
        if (!o(i) && !o(s)) return e;
      ...
      if (e.isAttached()) {
        var _t6 = e.getPreviousSibling();
        if (d(_t6) && _t6.shouldMergeAdjacentLink(e))
          return (
            r && (r = u(r, _t6, e)),
            i && (i = u(i, _t6, e)),
            _t6.append.apply(_t6, e.getChildren()),
            e.remove(),
            void s()
          );
        var _n3 = e.getNextSibling();
        d(_n3) &&
          e.shouldMergeAdjacentLink(_n3) &&
          (r && (r = u(r, e, _n3)),
          i && (i = u(i, e, _n3)),
          e.append.apply(e, _n3.getChildren()),
          _n3.remove(),
          (o = !0));
      }
      if (o) {
        if (!e.canBeEmpty() && e.isEmpty()) {
          var _t7 = e.getParent();
          (e.remove(), _t7 && _t7.isEmpty() && _t7.remove());
        }
        s();
      }
    }
    function c(e) {
      ...
      if (require("Lexical").isHTMLAnchorElement(e)) {
        var _n4 = e.textContent;
        ((null !== _n4 && "" !== _n4) || e.children.length > 0) &&
          (t = g(e.getAttribute("href") || "", {
    ...
    function g(e, t) {
      ...
      return require("Lexical").$applyNodeReplacement(new _o5(e, t));
    }
    function d(e) {
      return e instanceof _o5;
    }
    var _f = (function (_o) {
      function f(e, t, n) {
        var _this2;
    ...
    function h(e, t) {
      ...
      return require("Lexical").$applyNodeReplacement(new _f(e, t));
    }
    function p(e) {
      return e instanceof _f;
    }
    var m = require("Lexical").createCommand("TOGGLE_LINK_COMMAND");
    function x(e, t) {
      if ("element" === e.type) {
        var _r4 = e.getNode();
        ...
        return _r4.getChildren()[e.offset + t] || null;
      }
      return null;
    }
    function _(e, t) {
      ...
      if (e && "object" == typeof e) {
        ...
        ((r = _n5), (t = babelHelpers["extends"]({}, _i3, t)));
      } else r = e;
      var _t8 = t,
        i = _t8.target,
        s = _t8.title,
        o = void 0 === t.rel ? "noreferrer" : t.rel,
      ...
      if (require("Lexical").$isNodeSelection(l)) {
        ...
        return void _e2.forEach(function (e) {
          if (null === r) {
            var _t9 = require("Lexical").$findMatchingParent(e, function (e) {
              return !p(e) && d(e);
            });
            _t9 &&
              (_t9.insertBefore(e),
              0 === _t9.getChildren().length && _t9.remove());
          } else {
            var _t0 = require("Lexical").$findMatchingParent(e, function (e) {
              return !p(e) && d(e);
            });
            if (_t0)
              (_t0.setURL(r),
                void 0 !== i && _t0.setTarget(i),
                void 0 !== o && _t0.setRel(o),
                void 0 !== s && _t0.setTitle(s));
            else {
              var _t1 = g(r, { rel: o, target: i, title: s });
              (e.insertBefore(_t1), _t1.append(e));
            }
          }
        });
      }
      if (l.isCollapsed() && null === r)
        for (var _e3 of l.getNodes()) {
          var _t10 = require("Lexical").$findMatchingParent(_e3, function (e) {
            return !p(e) && d(e);
          });
          return void (
            null !== _t10 &&
            (_t10
              .getParentOrThrow()
              .splice(_t10.getIndexWithinParent(), 0, _t10.getChildren()),
            _t10.remove())
          );
        }
      var a = l.extract();
      if (null === r) {
        ...
        return void a.forEach(function (t) {
          var r = require("Lexical").$findMatchingParent(t, function (e) {
            return !p(e) && d(e);
          });
          if (null !== r) {
            var _t11 = r.getKey();
            if (_e4.has(_t11)) return;
            (!(function (e, t) {
              var r = new Set(
                  t
                    .filter(function (t) {
              ...
              if (u)
                ...
                for (var _t12 = o.length - 1; _t12 >= 0; _t12--)
                  e.insertAfter(o[_t12]);
              else {
                for (var _t13 = o.length - 1; _t13 >= 0; _t13--)
                  e.insertAfter(o[_t13]);
                var _t14 = i.slice(a + 1);
                if (_t14.length > 0) {
                  var _r5 = require("Lexical").$copyNode(e);
                  (o[o.length - 1].insertAfter(_r5),
                    _t14.forEach(function (e) {
                      return _r5.append(e);
                    }));
                }
              }
      ...
      if (1 === a.length) {
        var _e5 = a[0],
          _t15 = require("Lexical").$findMatchingParent(_e5, d);
        if (null !== _t15) return c(_t15);
      }
      !(function (e) {
        var t = require("Lexical").$getSelection();
        if (!require("Lexical").$isRangeSelection(t)) return e();
        var r = require("Lexical").$normalizeSelection__EXPERIMENTAL(t),
          i = r.isBackward(),
          s = x(r.anchor, i ? -1 : 0),
          o = x(r.focus, i ? 0 : -1),
          l = e();
        if (s || o) {
          ...
          if (require("Lexical").$isRangeSelection(_e6)) {
            ...
            require("Lexical").$setSelection(
              require("Lexical").$normalizeSelection__EXPERIMENTAL(_t16),
            );
          }
        }
      })(function () {
        var e = null;
        for (var _t17 of a) {
          if (!_t17.isAttached()) continue;
          var _l = require("Lexical").$findMatchingParent(_t17, d);
          if (_l) {
            c(_l);
            continue;
          }
          if (require("Lexical").$isElementNode(_t17)) {
            if (!_t17.isInline()) continue;
            if (d(_t17)) {
              if (
                !(
                  p(_t17) ||
                  (null !== e && e.getParentOrThrow().isParentOf(_t17))
                )
              ) {
                (c(_t17), (e = _t17));
                continue;
              }
              for (var _e9 of _t17.getChildren()) _t17.insertBefore(_e9);
              _t17.remove();
              continue;
            }
          }
          var _a = _t17.getPreviousSibling();
          d(_a) && _a.is(e)
            ? _a.append(_t17)
            : ((e = g(r, { rel: o, target: i, title: s })),
              _t17.insertAfter(e),
              e.append(_t17));
        }
      });
    ...
    var $ = {
        ...
        register: function register(n, r, i) {
          var _i$getOutput = i.getOutput(),
            s = _i$getOutput.created,
            o = _i$getOutput.createdMany,
            l = _i$getOutput.destroyed,
            a = _i$getOutput.destroyedMany,
            u = _i$getOutput.disabled,
            c = i.getDependency(require("LexicalA11y").AriaLiveRegionExtension)
              .output.announce;
            ...
            return u.value
              ...
              : n.registerMutationListener(
                  ...
                  function (e) {
                    ...
                    for (var _ref2 of e) {
                      var _r6 = _ref2[1];
                      "created" === _r6 ? t++ : "destroyed" === _r6 && n++;
                    }
                    t > 0 && 0 === n
                      ? c(
                          1 === t
                            ? s.peek()
                            : o.peek().replace("%s", String(t)),
                        )
                      : n > 0 &&
                        0 === t &&
                        c(
      ...
      N = [
        {
          ...
          match: require("LexicalHtml").sel.tag("a"),
          name: "@lexical/link/a",
        },
      ];
    function T(e, r) {
      return require("Lexical").mergeRegister(
        e.registerNodeTransform(_o5, u),
        e.registerCommand(
          m,
          function (e) {
            var t = r.validateUrl.peek(),
              n = r.attributes.peek();
            if (null === e) return (_(null), !0);
            if ("string" == typeof e)
              return !(void 0 !== t && !t(e)) && (_(e, n), !0);
            {
              var _r7 = e.url,
                _i4 = babelHelpers.objectWithoutPropertiesLoose(e, _excluded2);
              return (
                !(void 0 !== t && !t(_r7)) &&
                (_(_r7, babelHelpers["extends"]({}, n, _i4)), !0)
              );
            }
          },
        ...
        require("LexicalExtension").effect(function () {
          var t = r.validateUrl.value;
          if (!t) return;
          var s = r.attributes.value;
          return e.registerCommand(
            ...
            function (r) {
              ...
              if (
                ...
                o.isCollapsed() ||
                !require("LexicalUtils").objectKlassEquals(r, ClipboardEvent)
              )
                return !1;
              if (null === r.clipboardData) return !1;
              var l = r.clipboardData.getData("text");
              if (!t(l)) return !1;
              return (
    ...
    var b = {
        build: function build(e, n, r) {
          return require("LexicalExtension").namedSignals(n);
        },
        config: { attributes: void 0, validateUrl: void 0 },
        dependencies: [
          require("LexicalHtml").CoreImportExtension,
          [require("LexicalHtml").DOMImportExtension, { rules: N }],
        ],
        mergeConfig: function mergeConfig(e, t) {
          var r = require("Lexical").shallowMergeConfig(e, t);
          return (
            e.attributes &&
        ...
        register: function register(e, t, n) {
          return T(e, n.getOutput());
        },
      },
      S = { dependencies: [b], name: "@lexical/link/Import" };
    function C(e, t, r) {
      if (r === void 0) {
        r = {};
      }
      var i = function i(r) {
          ...
          if (
            (s.update(function () {
              ...
              if (null !== e) {
                ...
                if (!t.disabled.peek())
                  if (d(_r8))
                    ((a = p(_r8) && _r8.getIsUnlinked()),
                      (o = _r8.sanitizeUrl(_r8.getURL())),
                      (l = _r8.getTarget()));
                  else {
          ...
          (window.open(
            o,
            t.newTab.peek() || c || r.metaKey || r.ctrlKey || "_blank" === l
              ? "_blank"
              : "_self",
          ),
            r.preventDefault());
    ...
    function I(e, t) {
      ...
      return (
        ...
        null === r ||
          ...
          (require("Lexical").$isTextNode(r) && O(r.getTextContent(), t))
      );
    }
    function D(e, t) {
      ...
      return (
        ...
        null === r ||
          require("Lexical").$isLineBreakNode(r) ||
          (require("Lexical").$isTextNode(r) && y(r.getTextContent(), t))
      );
    }
    function w(e, t, n, r, i) {
      if (!(e > 0 ? P(r[e - 1], n) : I(i[0], n))) return !1;
      return t < r.length ? P(r[t], n) : D(i[i.length - 1], n);
    }
    function F(e, t, n) {
      var r = [],
        i = [],
    ...
    function W(e, t, r, i) {
      ...
      if (1 === e.length) {
        ...
        0 === t
          ? ((_l2$splitText = _l2.splitText(r)),
            ...
            (_l2 = _l2$splitText[1]),
            _l2$splitText)
          : ((_l2$splitText2 = _l2.splitText(t, r)),
            (_o2 = _l2$splitText2[1]),
            (_l2 = _l2$splitText2[2]),
            _l2$splitText2);
        var _a2 = require("Lexical").$createTextNode(i.text);
        return (
          _a2.setFormat(_o2.getFormat()),
          _a2.setDetail(_o2.getDetail()),
          _a2.setStyle(_o2.getStyle()),
          s.append(_a2),
          _o2.replace(s),
          _l2
        );
      ...
      if (e.length > 1) {
        ...
        0 === t
          ? (_o3 = _i5)
          : ((_i5$splitText = _i5.splitText(t)),
            (_o3 = _i5$splitText[1]),
            _i5$splitText);
        var _a3 = [];
        var _u2;
        for (var _t18 = 1; _t18 < e.length; _t18++) {
          var _n7 = e[_t18],
            _i6 = _n7.getTextContent().length,
            _s = _l3;
          if (_s < r)
            if (_l3 + _i6 <= r) _a3.push(_n7);
            else {
              var _n7$splitText = _n7.splitText(r - _s),
                _e10 = _n7$splitText[0],
                _t19 = _n7$splitText[1];
              (_a3.push(_e10), (_u2 = _t19));
            }
          _l3 += _i6;
        }
        var _c2 = require("Lexical").$getSelection(),
          _g = _c2
            ...
            : void 0,
          _d = require("Lexical").$createTextNode(_o3.getTextContent());
        return (
          _d.setFormat(_o3.getFormat()),
          _d.setDetail(_o3.getDetail()),
          _d.setStyle(_o3.getStyle()),
          s.append.apply(s, [_d].concat(_a3)),
          _g &&
            _g === _o3 &&
            (require("Lexical").$isRangeSelection(_c2)
              ? _d.select(_c2.anchor.offset, _c2.focus.offset)
              : require("Lexical").$isNodeSelection(_c2) &&
                _d.select(0, _d.getTextContent().length)),
          _o3.replace(s),
          _u2
        );
      }
    ...
    function z(e, t, r, i) {
      ...
      var l = e.getTextContent(),
        a = A(l, t);
      if (null === a || a.text !== l) return (K(e), void r(null, e.getURL()));
      if (!I(e, i) || !D(e, i)) return (K(e), void r(null, e.getURL()));
      var u = e.getURL();
      (u !== a.url && (e.setURL(a.url), r(a.url, u)),
        a.attributes &&
          (e.getRel() !== a.attributes.rel &&
            e.setRel(a.attributes.rel || null),
          e.getTarget() !== a.attributes.target &&
            e.setTarget(a.attributes.target || null),
          e.getTitle() !== a.attributes.title &&
            e.setTitle(a.attributes.title || null)));
    }
    function K(e) {
      var t = e.getChildren();
      for (var _n8 = t.length - 1; _n8 >= 0; _n8--) e.insertAfter(t[_n8]);
      return (
        e.remove(),
        t.map(function (e) {
          return e.getLatest();
    ...
    function J(e, t) {
      ...
      var _t21 = t,
        r = _t21.matchers,
        i = _t21.changeHandlers,
        s = _t21.excludeParents,
        _t21$separatorRegex = _t21.separatorRegex,
        o = _t21$separatorRegex === void 0 ? M : _t21$separatorRegex,
        l = function l(e, t) {
          for (var _n9 of i) _n9(e, t);
        };
      return require("Lexical").mergeRegister(
        e.registerNodeTransform(require("Lexical").TextNode, function (e) {
          ...
          if (p(t)) z(t, r, l, o);
            ...
            if (e.isSimpleText() && (y(e.getTextContent(), o) || !p(i))) {
              var _t22 = (function (e) {
                var t = [e];
                var r = e.getNextSibling();
                for (
                  ...
                  r.isSimpleText() &&
                  (t.push(r), !/[\s]/.test(r.getTextContent()));
                )
                  r = r.getNextSibling();
                return t;
              })(e);
              !(function (e, t, n, r) {
                for (var _t23 of e) {
                  var _e11 = _t23.getParent();
                  if (p(_e11) && !_e11.getIsUnlinked()) return;
                }
                var i = [].concat(e);
                var s = i
                  .map(function (e) {
                ...
                for (; (o = A(l, t)) && null !== o; ) {
                  var _e12 = o.index,
                    _t24 = _e12 + o.length;
                  if (w(a + _e12, a + _t24, r, s, i)) {
                    var _F = F(i, a + _e12, a + _t24),
                      _r0 = _F[0],
                      _s2 = _F[2],
                      _u3 = _F[3];
                    var _c3 = !1;
                    for (var _e13 of _s2) {
                      var _t25 = _e13.getParent();
                      if (p(_t25) && !_t25.getIsUnlinked()) {
                        _c3 = !0;
                        break;
                      }
                    }
                    if (_c3) {
                      ((a += _t24), (l = l.substring(_t24)));
                      continue;
                    }
                    var _g2 = W(_s2, a + _e12 - _r0, a + _t24 - _r0, o);
            ...
            !(function (e, t, n, r) {
              ...
              if (!p(i) || i.getIsUnlinked()) {
                if (
                  ...
                  if (!y(l, r)) return (K(s), void n(null, s.getURL()));
                  if (
                    ((a = l),
                    s.isEmailURI()
                      ? /^\.[a-zA-Z]{2,}/.test(a)
                    ...
                    null !== _o4 &&
                      _o4.text === _i8 &&
                      (s.append(e), z(s, t, n, r), n(null, s.getURL()));
                  }
                }
                var a;
                !p(o) ||
        ...
        e.registerCommand(
          ...
          function (e) {
            var t = require("Lexical").$getSelection();
            if (null !== e || !require("Lexical").$isRangeSelection(t))
              return !1;
            return (
              t.extract().forEach(function (e) {
                var t = e.getParent();
    ...
    var j = {
      ...
      mergeConfig: function mergeConfig(e, t) {
        var r = require("Lexical").shallowMergeConfig(e, t);
        for (var _n0 of ["matchers", "changeHandlers", "excludeParents"]) {
          var _i9 = t[_n0];
          Array.isArray(_i9) && (r[_n0] = [].concat(e[_n0], _i9));
        }
        return r;
      },
    ...
    ((exports.$createAutoLinkNode = h),
      (exports.$createLinkNode = g),
      (exports.$isAutoLinkNode = p),
      (exports.$isLinkNode = d),
      (exports.$toggleLink = _),
      (exports.AutoLinkAnnounceExtension = $),
      (exports.AutoLinkExtension = j),
      (exports.AutoLinkNode = _f),
      (exports.ClickableLinkExtension = R),
      (exports.LinkExtension = b),
      (exports.LinkImportExtension = S),
      (exports.LinkImportRules = N),
      (exports.LinkNode = _o5),
      (exports.TOGGLE_LINK_COMMAND = m),
      (exports.autoLinkEmailMatcher = E),
      ...
      (exports.createLinkMatcherWithRegExp = v),
      (exports.formatUrl = L),
      (exports.registerAutoLink = J),
      (exports.registerClickableLink = C),
      (exports.registerLink = T));
  },
  null,
);
