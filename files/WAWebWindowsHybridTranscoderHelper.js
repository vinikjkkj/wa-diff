__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function C(t, r, a, i, l) {
      ...
      var y =
        n("cr:17219") == null || (h = n("cr:17219").getWindowsBridge()) == null
          ? void 0
      ...
      try {
        ...
        var R = await y.requestSharedBufferForTranscoding(g++, t.size),
          L = R[0],
          E = R[1];
        ((C = L),
          o("WALogger").LOG(
        ...
        if (
          ...
          try {
            var D = await y.getVideoPreviewFrameFromSharedBuffer(C, g++),
              x = D[0],
              $ = D[1],
              P = D[2],
              N = D[3];
        ...
        var w = await y.performVideoTranscodingFromSharedBuffer(C, g++, M),
          A = w[0],
          F = w[1];
        ((b = A),
          o("WALogger").LOG(
