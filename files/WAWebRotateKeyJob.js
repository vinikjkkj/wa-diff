  ...
  function (t, n, r, o, a, i, l) {
    var e,
      ...
      p = o("WAWebDefinePersistedJob")
        ...
        .step("uploadKeys", async function () {
          var t = await o("WAWebSignalStoreApi")
            .waSignalStore.getRegistrationInfo()
            .then(function (e) {
              if (!e) throw r("err")("No registration info is available");
              return o("WAWebSignalStoreApi").waSignalStore.rotateSignedPreKey(
          ...
          var n = o("WAWap").wap(
            ...
            a = await o("WADeprecatedSendIq").deprecatedSendIq(n, m);
