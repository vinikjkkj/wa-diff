__d(
  "WamWaffleLinkedProfilesCacheFalcoEvent",
  [
    "FalcoLoggerInternal",
    "Promise",
  ...
  function (t, n, r, o, a, i, l) {
    ...
    var e,
      s,
      u = r("getFalcoLogPolicy_DO_NOT_USE")("7989"),
      c = {
        app_build: (s = r("requireDeferred"))(
          "WAWebFalcoCanonicalAppBuild",
        ).__setRef("WamWaffleLinkedProfilesCacheFalcoEvent"),
    ...
    var m = o("FalcoLoggerInternal").create(
        "wam_waffle_linked_profiles_cache",
        u,
        d,
      ),
      p = m;
