__d(
  ...
  function (t, n, r, o, a, i) {
    var e = [
      ...
      g = ["nombre", "nombre completo", "cliente", "nombre del cliente"],
      h = ["nome", "nome completo", "cliente", "nome do cliente"],
      y = ["nama", "nama lengkap", "pelanggan", "nama pelanggan"],
      C = ["\u0928\u093E\u092E", "\u092A\u0942\u0930\u093E \u0928\u093E\u092E"],
      b = [
        "\u0627\u0633\u0645",
        "\u0627\u0644\u0627\u0633\u0645",
      ...
      v = ["nom", "nom complet", "nom du client"],
      S = [
      ...
      R = ["isim", "ad soyad", "isim soyisim", "m\xFC\u015Fteri", "musteri"],
      L = [
        "firstname",
        "first name",
        "given name",
      ...
      k = x([].concat(e, l, s, u, c, d, m, p, _)),
      I = x([].concat(f, g, h, y, C, b, v, S, R)),
      T = x(L),
      D = x(E);
    function x(e) {
      var t = new Set();
      for (var n of e) t.add($(n));
      return t;
    }
    function $(e) {
    ...
    function M(e) {
      ...
      var t = e.trim();
      if (t.length === 0 || !N.test(t)) return !1;
    ...
    ((i.PHONE_HEADER_ALIASES = k),
      (i.FULL_NAME_HEADER_ALIASES = I),
      (i.FIRST_NAME_HEADER_ALIASES = T),
      (i.LAST_NAME_HEADER_ALIASES = D),
      (i.normalizeHeader = $),
      (i.matchHeaderToAliases = P),
