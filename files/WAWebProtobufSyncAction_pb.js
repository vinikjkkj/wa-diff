  ...
  function (t, n, r, o, a, i, l) {
    ...
    ((B.name = "RecentEmojiWeight"),
      ...
      (U.internalSpec = {
        ...
        starAction: [2, e.TYPES.MESSAGE, Et],
        contactAction: [3, e.TYPES.MESSAGE, Lt],
        muteAction: [4, e.TYPES.MESSAGE, Rt],
        pinAction: [5, e.TYPES.MESSAGE, St],
        pushNameSetting: [7, e.TYPES.MESSAGE, vt],
        quickReplyAction: [8, e.TYPES.MESSAGE, Ct],
        recentEmojiWeightsAction: [11, e.TYPES.MESSAGE, ft],
        labelEditAction: [14, e.TYPES.MESSAGE, gt],
        labelAssociationAction: [15, e.TYPES.MESSAGE, yt],
        localeSetting: [16, e.TYPES.MESSAGE, bt],
        archiveChatAction: [17, e.TYPES.MESSAGE, _t],
        deleteMessageForMeAction: [18, e.TYPES.MESSAGE, pt],
        keyExpiration: [19, e.TYPES.MESSAGE, it],
        markChatAsReadAction: [20, e.TYPES.MESSAGE, mt],
        clearChatAction: [21, e.TYPES.MESSAGE, dt],
        deleteChatAction: [22, e.TYPES.MESSAGE, ct],
        unarchiveChatsSetting: [23, e.TYPES.MESSAGE, ut],
        primaryFeature: [24, e.TYPES.MESSAGE, at],
        androidUnsupportedActions: [26, e.TYPES.MESSAGE, ot],
        agentAction: [27, e.TYPES.MESSAGE, rt],
        subscriptionAction: [28, e.TYPES.MESSAGE, nt],
        userStatusMuteAction: [29, e.TYPES.MESSAGE, tt],
        timeFormatAction: [30, e.TYPES.MESSAGE, et],
        nuxAction: [31, e.TYPES.MESSAGE, Ze],
        primaryVersionAction: [32, e.TYPES.MESSAGE, Je],
        stickerAction: [33, e.TYPES.MESSAGE, Xe],
        removeRecentStickerAction: [34, e.TYPES.MESSAGE, Ye],
        chatAssignment: [35, e.TYPES.MESSAGE, Qe],
        chatAssignmentOpenedStatus: [36, e.TYPES.MESSAGE, Ke],
        pnForLidChatAction: [37, e.TYPES.MESSAGE, je],
        marketingMessageAction: [38, e.TYPES.MESSAGE, Ge],
        marketingMessageBroadcastAction: [39, e.TYPES.MESSAGE, He],
        externalWebBetaAction: [40, e.TYPES.MESSAGE, Ve],
        privacySettingRelayAllCalls: [41, e.TYPES.MESSAGE, qe],
        callLogAction: [42, e.TYPES.MESSAGE, We],
        ugcBot: [43, e.TYPES.MESSAGE, Be],
        statusPrivacy: [44, e.TYPES.MESSAGE, Fe],
        botWelcomeRequestAction: [45, e.TYPES.MESSAGE, Me],
        deleteIndividualCallLog: [46, e.TYPES.MESSAGE, Ne],
        labelReorderingAction: [47, e.TYPES.MESSAGE, Pe],
        paymentInfoAction: [48, e.TYPES.MESSAGE, $e],
        customPaymentMethodsAction: [49, e.TYPES.MESSAGE, Te],
        lockChatAction: [50, e.TYPES.MESSAGE, Ie],
        chatLockSettings: [
          51,
          e.TYPES.MESSAGE,
          o("WAWebProtobufsChatLockSettings.pb").ChatLockSettingsSpec,
        ],
        wamoUserIdentifierAction: [52, e.TYPES.MESSAGE, Ee],
        privacySettingDisableLinkPreviewsAction: [53, e.TYPES.MESSAGE, Le],
        deviceCapabilities: [
          54,
          e.TYPES.MESSAGE,
          o("WAWebProtobufsDeviceCapabilities.pb").DeviceCapabilitiesSpec,
        ],
        noteEditAction: [55, e.TYPES.MESSAGE, Se],
        favoritesAction: [56, e.TYPES.MESSAGE, be],
        merchantPaymentPartnerAction: [57, e.TYPES.MESSAGE, Ce],
        waffleAccountLinkStateAction: [58, e.TYPES.MESSAGE, ye],
        usernameChatStartMode: [59, e.TYPES.MESSAGE, ze],
        notificationActivitySettingAction: [60, e.TYPES.MESSAGE, he],
        lidContactAction: [61, e.TYPES.MESSAGE, ge],
        ctwaPerCustomerDataSharingAction: [62, e.TYPES.MESSAGE, _e],
        paymentTosAction: [63, e.TYPES.MESSAGE, pe],
        privacySettingChannelsPersonalisedRecommendationAction: [
          64,
          e.TYPES.MESSAGE,
          Re,
        ],
        detectedOutcomesStatusAction: [66, e.TYPES.MESSAGE, Ue],
        maibaAiFeaturesControlAction: [68, e.TYPES.MESSAGE, se],
        businessBroadcastListAction: [69, e.TYPES.MESSAGE, de],
        musicUserIdAction: [70, e.TYPES.MESSAGE, Ae],
        statusPostOptInNotificationPreferencesAction: [71, e.TYPES.MESSAGE, ie],
        avatarUpdatedAction: [72, e.TYPES.MESSAGE, ae],
        privateProcessingSettingAction: [74, e.TYPES.MESSAGE, oe],
        newsletterSavedInterestsAction: [75, e.TYPES.MESSAGE, we],
        aiThreadRenameAction: [76, e.TYPES.MESSAGE, re],
        interactiveMessageAction: [77, e.TYPES.MESSAGE, te],
        settingsSyncAction: [78, e.TYPES.MESSAGE, J],
        outContactAction: [79, e.TYPES.MESSAGE, fe],
        nctSaltSyncAction: [80, e.TYPES.MESSAGE, ee],
        businessBroadcastCampaignAction: [81, e.TYPES.MESSAGE, ce],
        businessBroadcastInsightsAction: [82, e.TYPES.MESSAGE, Y],
        customerDataAction: [83, e.TYPES.MESSAGE, X],
        subscriptionsSyncV2Action: [84, e.TYPES.MESSAGE, j],
        threadPinAction: [85, e.TYPES.MESSAGE, ne],
        autoOrganizeBusinessChatSetting: [86, e.TYPES.MESSAGE, Z],
        bizAiSettingsNudgeAction: [87, e.TYPES.MESSAGE, le],
        coexV2VersionAction: [88, e.TYPES.MESSAGE, z],
        wasaRootSecretAction: [89, e.TYPES.MESSAGE, H],
        bubbleLockMessageAction: [90, e.TYPES.MESSAGE, ke],
        labelSublistAction: [91, e.TYPES.MESSAGE, ht],
        deviceCapabilitiesV2: [
          92,
          e.TYPES.MESSAGE,
          o("WAWebProtobufsDeviceCapabilities.pb").DeviceCapabilitiesSpec,
        ],
        ctwaMessageReceivedAction: [93, e.TYPES.MESSAGE, V],
      }),
      (V.name = "SyncActionValue$CtwaMessageReceivedAction"),
      (V.internalSpec = { isCtwaMessageReceived: [1, e.TYPES.BOOL] }),
      (H.name = "SyncActionValue$WASARootSecretAction"),
      (H.internalSpec = {
        secrets: [1, e.FLAGS.REPEATED | e.TYPES.MESSAGE, G],
      }),
      (G.name = "SyncActionValue$WASARootSecretAction$RootSecretEntry"),
      (G.internalSpec = {
        id: [1, e.TYPES.STRING],
      ...
      (z.name = "SyncActionValue$CoexV2VersionAction"),
      (z.internalSpec = { version: [1, e.TYPES.UINT64] }),
      (j.name = "SyncActionValue$SubscriptionsSyncV2Action"),
      (j.internalSpec = {
        subscriptions: [1, e.FLAGS.REPEATED | e.TYPES.MESSAGE, Q],
        paidFeature: [2, e.FLAGS.REPEATED | e.TYPES.MESSAGE, K],
      }),
      (K.name = "SyncActionValue$SubscriptionsSyncV2Action$PaidFeature"),
      (K.internalSpec = {
      ...
      (Q.name = "SyncActionValue$SubscriptionsSyncV2Action$SubscriptionInfo"),
      (Q.internalSpec = {
        id: [1, e.TYPES.STRING],
      ...
      (X.name = "SyncActionValue$CustomerDataAction"),
      (X.internalSpec = {
      ...
      (Y.name = "SyncActionValue$BusinessBroadcastInsightsAction"),
      (Y.internalSpec = {
      ...
      (J.name = "SyncActionValue$SettingsSyncAction"),
      (J.internalSpec = {
      ...
      (Z.name = "SyncActionValue$AutoOrganizeBusinessChatSetting"),
      (Z.internalSpec = { autoOrganize: [1, e.TYPES.BOOL] }),
      (ee.name = "SyncActionValue$NctSaltSyncAction"),
      (ee.internalSpec = { salt: [1, e.TYPES.BYTES] }),
      (te.name = "SyncActionValue$InteractiveMessageAction"),
      (te.internalSpec = {
        type: [1, e.FLAGS.REQUIRED | e.TYPES.ENUM, C],
        agmId: [2, e.TYPES.STRING],
      }),
      (ne.name = "SyncActionValue$ThreadPinAction"),
      (ne.internalSpec = { pinned: [1, e.TYPES.BOOL] }),
      (re.name = "SyncActionValue$AiThreadRenameAction"),
      (re.internalSpec = { newTitle: [1, e.TYPES.STRING] }),
      (oe.name = "SyncActionValue$PrivateProcessingSettingAction"),
      (oe.internalSpec = { privateProcessingStatus: [1, e.TYPES.ENUM, b] }),
      (ae.name = "SyncActionValue$AvatarUpdatedAction"),
      (ae.internalSpec = {
        eventType: [1, e.TYPES.ENUM, v],
        recentAvatarStickers: [2, e.FLAGS.REPEATED | e.TYPES.MESSAGE, Xe],
      }),
      (ie.name =
        "SyncActionValue$StatusPostOptInNotificationPreferencesAction"),
      (ie.internalSpec = { enabled: [1, e.TYPES.BOOL] }),
      (le.name = "SyncActionValue$BizAISettingsNudgeAction"),
      (le.internalSpec = {
        category: [1, e.TYPES.ENUM, S],
        version: [2, e.TYPES.INT64],
        updatedAtMs: [3, e.TYPES.INT64],
      }),
      (se.name = "SyncActionValue$MaibaAIFeaturesControlAction"),
      (se.internalSpec = {
        aiFeatureStatus: [1, e.TYPES.ENUM, L],
        aiReplyMode: [2, e.TYPES.ENUM, R],
      }),
      (ue.name = "SyncActionValue$BroadcastListParticipant"),
      (ue.internalSpec = {
        lidJid: [1, e.FLAGS.REQUIRED | e.TYPES.STRING],
        pnJid: [2, e.TYPES.STRING],
      }),
      (ce.name = "SyncActionValue$BusinessBroadcastCampaignAction"),
      (ce.internalSpec = {
      ...
      (de.name = "SyncActionValue$BusinessBroadcastListAction"),
      (de.internalSpec = {
        deleted: [1, e.TYPES.BOOL],
        participants: [2, e.FLAGS.REPEATED | e.TYPES.MESSAGE, ue],
      ...
      (me.name = "SyncActionValue$BusinessBroadcastAssociationAction"),
      (me.internalSpec = { deleted: [1, e.TYPES.BOOL] }),
      (pe.name = "SyncActionValue$PaymentTosAction"),
      (pe.internalSpec = {
        paymentNotice: [1, e.FLAGS.REQUIRED | e.TYPES.ENUM, k],
        accepted: [2, e.FLAGS.REQUIRED | e.TYPES.BOOL],
      }),
      (_e.name = "SyncActionValue$CtwaPerCustomerDataSharingAction"),
      (_e.internalSpec = {
        isCtwaPerCustomerDataSharingEnabled: [1, e.TYPES.BOOL],
      }),
      (fe.name = "SyncActionValue$OutContactAction"),
      (fe.internalSpec = {
        fullName: [1, e.TYPES.STRING],
        firstName: [2, e.TYPES.STRING],
      }),
      (ge.name = "SyncActionValue$LidContactAction"),
      (ge.internalSpec = {
        fullName: [1, e.TYPES.STRING],
        firstName: [2, e.TYPES.STRING],
        username: [3, e.TYPES.STRING],
      }),
      (he.name = "SyncActionValue$NotificationActivitySettingAction"),
      (he.internalSpec = { notificationActivitySetting: [1, e.TYPES.ENUM, I] }),
      (ye.name = "SyncActionValue$WaffleAccountLinkStateAction"),
      (ye.internalSpec = { linkState: [2, e.TYPES.ENUM, T] }),
      ...
      (be.name = "SyncActionValue$FavoritesAction"),
      (be.internalSpec = {
        favorites: [1, e.FLAGS.REPEATED | e.TYPES.MESSAGE, ve],
      }),
      (ve.name = "SyncActionValue$FavoritesAction$Favorite"),
      (ve.internalSpec = { id: [1, e.TYPES.STRING] }),
      (Se.name = "SyncActionValue$NoteEditAction"),
      (Se.internalSpec = {
      ...
      (Re.internalSpec = { isUserOptedOut: [1, e.TYPES.BOOL] }),
      (Le.name = "SyncActionValue$PrivacySettingDisableLinkPreviewsAction"),
      (Le.internalSpec = { isPreviewsDisabled: [1, e.TYPES.BOOL] }),
      (Ee.name = "SyncActionValue$WamoUserIdentifierAction"),
      (Ee.internalSpec = { identifier: [1, e.TYPES.STRING] }),
      (ke.name = "SyncActionValue$BubbleLockMessageAction"),
      (ke.internalSpec = { locked: [1, e.TYPES.BOOL] }),
      (Ie.name = "SyncActionValue$LockChatAction"),
      (Ie.internalSpec = { locked: [1, e.TYPES.BOOL] }),
      (Te.name = "SyncActionValue$CustomPaymentMethodsAction"),
      (Te.internalSpec = {
        customPaymentMethods: [1, e.FLAGS.REPEATED | e.TYPES.MESSAGE, De],
      }),
      (De.name = "SyncActionValue$CustomPaymentMethod"),
      (De.internalSpec = {
        credentialId: [1, e.FLAGS.REQUIRED | e.TYPES.STRING],
        country: [2, e.FLAGS.REQUIRED | e.TYPES.STRING],
        type: [3, e.FLAGS.REQUIRED | e.TYPES.STRING],
        metadata: [4, e.FLAGS.REPEATED | e.TYPES.MESSAGE, xe],
      }),
      (xe.name = "SyncActionValue$CustomPaymentMethodMetadata"),
      (xe.internalSpec = {
        key: [1, e.FLAGS.REQUIRED | e.TYPES.STRING],
        value: [2, e.FLAGS.REQUIRED | e.TYPES.STRING],
      }),
      ($e.name = "SyncActionValue$PaymentInfoAction"),
      ($e.internalSpec = { cpi: [1, e.TYPES.STRING] }),
      (Pe.name = "SyncActionValue$LabelReorderingAction"),
      (Pe.internalSpec = {
        sortedLabelIds: [1, e.FLAGS.REPEATED | e.TYPES.INT32],
      }),
      (Ne.name = "SyncActionValue$DeleteIndividualCallLogAction"),
      (Ne.internalSpec = {
        peerJid: [1, e.TYPES.STRING],
        isIncoming: [2, e.TYPES.BOOL],
      }),
      (Me.name = "SyncActionValue$BotWelcomeRequestAction"),
      (Me.internalSpec = { isSent: [1, e.TYPES.BOOL] }),
      (we.name = "SyncActionValue$NewsletterSavedInterestsAction"),
      (we.internalSpec = { newsletterSavedInterests: [1, e.TYPES.STRING] }),
      (Ae.name = "SyncActionValue$MusicUserIdAction"),
      (Ae.internalSpec = {
        musicUserId: [1, e.TYPES.STRING],
        music_user_id_map: [2, e.TYPES.MAP, [e.TYPES.STRING, e.TYPES.STRING]],
      }),
      (Fe.name = "SyncActionValue$StatusPrivacyAction"),
      (Fe.internalSpec = {
        mode: [1, e.TYPES.ENUM, $],
        userJid: [2, e.FLAGS.REPEATED | e.TYPES.STRING],
        shareToFb: [3, e.TYPES.BOOL],
        shareToIg: [4, e.TYPES.BOOL],
        customLists: [5, e.FLAGS.REPEATED | e.TYPES.MESSAGE, Oe],
        modes: [6, e.FLAGS.REPEATED | e.TYPES.ENUM, $],
      }),
      (Oe.name = "SyncActionValue$StatusPrivacyAction$CustomList"),
      (Oe.internalSpec = {
      ...
      (Be.name = "SyncActionValue$UGCBot"),
      (Be.internalSpec = { definition: [1, e.TYPES.BYTES] }),
      (We.name = "SyncActionValue$CallLogAction"),
      (We.internalSpec = { callLogRecord: [1, e.TYPES.MESSAGE, W] }),
      (qe.name = "SyncActionValue$PrivacySettingRelayAllCalls"),
      (qe.internalSpec = { isEnabled: [1, e.TYPES.BOOL] }),
      (Ue.name = "SyncActionValue$DetectedOutcomesStatusAction"),
      (Ue.internalSpec = { isEnabled: [1, e.TYPES.BOOL] }),
      (Ve.name = "SyncActionValue$ExternalWebBetaAction"),
      (Ve.internalSpec = { isOptIn: [1, e.TYPES.BOOL] }),
      (He.name = "SyncActionValue$MarketingMessageBroadcastAction"),
      (He.internalSpec = { repliedCount: [1, e.TYPES.INT32] }),
      (Ge.name = "SyncActionValue$MarketingMessageAction"),
      (Ge.internalSpec = {
        name: [1, e.TYPES.STRING],
      ...
      (ze.internalSpec = { chatStartMode: [1, e.TYPES.ENUM, N] }),
      (je.name = "SyncActionValue$PnForLidChatAction"),
      (je.internalSpec = { pnJid: [1, e.TYPES.STRING] }),
      (Ke.name = "SyncActionValue$ChatAssignmentOpenedStatusAction"),
      (Ke.internalSpec = { chatOpened: [1, e.TYPES.BOOL] }),
      (Qe.name = "SyncActionValue$ChatAssignmentAction"),
      (Qe.internalSpec = { deviceAgentId: [1, e.TYPES.STRING] }),
      (Xe.name = "SyncActionValue$StickerAction"),
      (Xe.internalSpec = {
      ...
      (Ye.name = "SyncActionValue$RemoveRecentStickerAction"),
      (Ye.internalSpec = { lastStickerSentTs: [1, e.TYPES.INT64] }),
      (Je.name = "SyncActionValue$PrimaryVersionAction"),
      (Je.internalSpec = { version: [1, e.TYPES.STRING] }),
      (Ze.name = "SyncActionValue$NuxAction"),
      (Ze.internalSpec = { acknowledged: [1, e.TYPES.BOOL] }),
      (et.name = "SyncActionValue$TimeFormatAction"),
      (et.internalSpec = { isTwentyFourHourFormatEnabled: [1, e.TYPES.BOOL] }),
      (tt.name = "SyncActionValue$UserStatusMuteAction"),
      (tt.internalSpec = { muted: [1, e.TYPES.BOOL] }),
      (nt.name = "SyncActionValue$SubscriptionAction"),
      (nt.internalSpec = {
        isDeactivated: [1, e.TYPES.BOOL],
        isAutoRenewing: [2, e.TYPES.BOOL],
        expirationDate: [3, e.TYPES.INT64],
      }),
      (rt.name = "SyncActionValue$AgentAction"),
      (rt.internalSpec = {
        name: [1, e.TYPES.STRING],
        deviceId: [2, e.TYPES.INT32],
        isDeleted: [3, e.TYPES.BOOL],
      }),
      (ot.name = "SyncActionValue$AndroidUnsupportedActions"),
      (ot.internalSpec = { allowed: [1, e.TYPES.BOOL] }),
      (at.name = "SyncActionValue$PrimaryFeature"),
      (at.internalSpec = { flags: [1, e.FLAGS.REPEATED | e.TYPES.STRING] }),
      (it.name = "SyncActionValue$KeyExpiration"),
      (it.internalSpec = { expiredKeyEpoch: [1, e.TYPES.INT32] }),
      (lt.name = "SyncActionValue$SyncActionMessage"),
      (lt.internalSpec = {
        key: [
          1,
          e.TYPES.MESSAGE,
      ...
      (st.name = "SyncActionValue$SyncActionMessageRange"),
      (st.internalSpec = {
        lastMessageTimestamp: [1, e.TYPES.INT64],
        lastSystemMessageTimestamp: [2, e.TYPES.INT64],
        messages: [3, e.FLAGS.REPEATED | e.TYPES.MESSAGE, lt],
      }),
      (ut.name = "SyncActionValue$UnarchiveChatsSetting"),
      (ut.internalSpec = { unarchiveChats: [1, e.TYPES.BOOL] }),
      (ct.name = "SyncActionValue$DeleteChatAction"),
      (ct.internalSpec = { messageRange: [1, e.TYPES.MESSAGE, st] }),
      (dt.name = "SyncActionValue$ClearChatAction"),
      (dt.internalSpec = { messageRange: [1, e.TYPES.MESSAGE, st] }),
      (mt.name = "SyncActionValue$MarkChatAsReadAction"),
      (mt.internalSpec = {
        read: [1, e.TYPES.BOOL],
        messageRange: [2, e.TYPES.MESSAGE, st],
      }),
      (pt.name = "SyncActionValue$DeleteMessageForMeAction"),
      (pt.internalSpec = {
        deleteMedia: [1, e.TYPES.BOOL],
        messageTimestamp: [2, e.TYPES.INT64],
      }),
      (_t.name = "SyncActionValue$ArchiveChatAction"),
      (_t.internalSpec = {
        archived: [1, e.TYPES.BOOL],
        messageRange: [2, e.TYPES.MESSAGE, st],
      }),
      (ft.name = "SyncActionValue$RecentEmojiWeightsAction"),
      (ft.internalSpec = {
        weights: [1, e.FLAGS.REPEATED | e.TYPES.MESSAGE, B],
      }),
      (gt.name = "SyncActionValue$LabelEditAction"),
      (gt.internalSpec = {
        name: [1, e.TYPES.STRING],
      ...
      (ht.name = "SyncActionValue$LabelSublistAction"),
      (ht.internalSpec = { subListId: [1, e.TYPES.INT32] }),
      (yt.name = "SyncActionValue$LabelAssociationAction"),
      (yt.internalSpec = {
        labeled: [1, e.TYPES.BOOL],
        modelMetaData: [2, e.TYPES.STRING],
      }),
      (Ct.name = "SyncActionValue$QuickReplyAction"),
      (Ct.internalSpec = {
      ...
      (bt.name = "SyncActionValue$LocaleSetting"),
      (bt.internalSpec = { locale: [1, e.TYPES.STRING] }),
      (vt.name = "SyncActionValue$PushNameSetting"),
      (vt.internalSpec = { name: [1, e.TYPES.STRING] }),
      (St.name = "SyncActionValue$PinAction"),
      (St.internalSpec = { pinned: [1, e.TYPES.BOOL] }),
      (Rt.name = "SyncActionValue$MuteAction"),
      (Rt.internalSpec = {
      ...
      (Lt.name = "SyncActionValue$ContactAction"),
      (Lt.internalSpec = {
        fullName: [1, e.TYPES.STRING],
        firstName: [2, e.TYPES.STRING],
      ...
      (Et.name = "SyncActionValue$StarAction"),
      (Et.internalSpec = { starred: [1, e.TYPES.BOOL] }),
      (kt.name = "SyncActionData"),
      (kt.internalSpec = {
      ...
      (l.SyncActionValue$CtwaMessageReceivedActionSpec = V),
      (l.SyncActionValue$WASARootSecretActionSpec = H),
      (l.SyncActionValue$WASARootSecretAction$RootSecretEntrySpec = G),
      (l.SyncActionValue$CoexV2VersionActionSpec = z),
      (l.SyncActionValue$SubscriptionsSyncV2ActionSpec = j),
      (l.SyncActionValue$SubscriptionsSyncV2Action$PaidFeatureSpec = K),
      (l.SyncActionValue$SubscriptionsSyncV2Action$SubscriptionInfoSpec = Q),
      (l.SyncActionValue$CustomerDataActionSpec = X),
      (l.SyncActionValue$BusinessBroadcastInsightsActionSpec = Y),
      (l.SyncActionValue$SettingsSyncActionSpec = J),
      (l.SyncActionValue$AutoOrganizeBusinessChatSettingSpec = Z),
      (l.SyncActionValue$NctSaltSyncActionSpec = ee),
      (l.SyncActionValue$InteractiveMessageActionSpec = te),
      (l.SyncActionValue$ThreadPinActionSpec = ne),
      (l.SyncActionValue$AiThreadRenameActionSpec = re),
      (l.SyncActionValue$PrivateProcessingSettingActionSpec = oe),
      (l.SyncActionValue$AvatarUpdatedActionSpec = ae),
      (l.SyncActionValue$StatusPostOptInNotificationPreferencesActionSpec = ie),
      (l.SyncActionValue$BizAISettingsNudgeActionSpec = le),
      (l.SyncActionValue$MaibaAIFeaturesControlActionSpec = se),
      (l.SyncActionValue$BroadcastListParticipantSpec = ue),
      (l.SyncActionValue$BusinessBroadcastCampaignActionSpec = ce),
      (l.SyncActionValue$BusinessBroadcastListActionSpec = de),
      (l.SyncActionValue$BusinessBroadcastAssociationActionSpec = me),
      (l.SyncActionValue$PaymentTosActionSpec = pe),
      (l.SyncActionValue$CtwaPerCustomerDataSharingActionSpec = _e),
      (l.SyncActionValue$OutContactActionSpec = fe),
      (l.SyncActionValue$LidContactActionSpec = ge),
      (l.SyncActionValue$NotificationActivitySettingActionSpec = he),
      (l.SyncActionValue$WaffleAccountLinkStateActionSpec = ye),
      (l.SyncActionValue$MerchantPaymentPartnerActionSpec = Ce),
      (l.SyncActionValue$FavoritesActionSpec = be),
      (l.SyncActionValue$FavoritesAction$FavoriteSpec = ve),
      (l.SyncActionValue$NoteEditActionSpec = Se),
      (l.SyncActionValue$PrivacySettingChannelsPersonalisedRecommendationActionSpec =
        Re),
      (l.SyncActionValue$PrivacySettingDisableLinkPreviewsActionSpec = Le),
      (l.SyncActionValue$WamoUserIdentifierActionSpec = Ee),
      (l.SyncActionValue$BubbleLockMessageActionSpec = ke),
      (l.SyncActionValue$LockChatActionSpec = Ie),
      (l.SyncActionValue$CustomPaymentMethodsActionSpec = Te),
      (l.SyncActionValue$CustomPaymentMethodSpec = De),
      (l.SyncActionValue$CustomPaymentMethodMetadataSpec = xe),
      (l.SyncActionValue$PaymentInfoActionSpec = $e),
      (l.SyncActionValue$LabelReorderingActionSpec = Pe),
      (l.SyncActionValue$DeleteIndividualCallLogActionSpec = Ne),
      (l.SyncActionValue$BotWelcomeRequestActionSpec = Me),
      (l.SyncActionValue$NewsletterSavedInterestsActionSpec = we),
      (l.SyncActionValue$MusicUserIdActionSpec = Ae),
      (l.SyncActionValue$StatusPrivacyActionSpec = Fe),
      (l.SyncActionValue$StatusPrivacyAction$CustomListSpec = Oe),
      (l.SyncActionValue$UGCBotSpec = Be),
      (l.SyncActionValue$CallLogActionSpec = We),
      (l.SyncActionValue$PrivacySettingRelayAllCallsSpec = qe),
      (l.SyncActionValue$DetectedOutcomesStatusActionSpec = Ue),
      (l.SyncActionValue$ExternalWebBetaActionSpec = Ve),
      (l.SyncActionValue$MarketingMessageBroadcastActionSpec = He),
      (l.SyncActionValue$MarketingMessageActionSpec = Ge),
      (l.SyncActionValue$UsernameChatStartModeActionSpec = ze),
      (l.SyncActionValue$PnForLidChatActionSpec = je),
      (l.SyncActionValue$ChatAssignmentOpenedStatusActionSpec = Ke),
      (l.SyncActionValue$ChatAssignmentActionSpec = Qe),
      (l.SyncActionValue$StickerActionSpec = Xe),
      (l.SyncActionValue$RemoveRecentStickerActionSpec = Ye),
      (l.SyncActionValue$PrimaryVersionActionSpec = Je),
      (l.SyncActionValue$NuxActionSpec = Ze),
      (l.SyncActionValue$TimeFormatActionSpec = et),
      (l.SyncActionValue$UserStatusMuteActionSpec = tt),
      (l.SyncActionValue$SubscriptionActionSpec = nt),
      (l.SyncActionValue$AgentActionSpec = rt),
      (l.SyncActionValue$AndroidUnsupportedActionsSpec = ot),
      (l.SyncActionValue$PrimaryFeatureSpec = at),
      (l.SyncActionValue$KeyExpirationSpec = it),
      (l.SyncActionValue$SyncActionMessageSpec = lt),
      (l.SyncActionValue$SyncActionMessageRangeSpec = st),
      (l.SyncActionValue$UnarchiveChatsSettingSpec = ut),
      (l.SyncActionValue$DeleteChatActionSpec = ct),
      (l.SyncActionValue$ClearChatActionSpec = dt),
      (l.SyncActionValue$MarkChatAsReadActionSpec = mt),
      (l.SyncActionValue$DeleteMessageForMeActionSpec = pt),
      (l.SyncActionValue$ArchiveChatActionSpec = _t),
      (l.SyncActionValue$RecentEmojiWeightsActionSpec = ft),
      (l.SyncActionValue$LabelEditActionSpec = gt),
      (l.SyncActionValue$LabelSublistActionSpec = ht),
      (l.SyncActionValue$LabelAssociationActionSpec = yt),
      (l.SyncActionValue$QuickReplyActionSpec = Ct),
      (l.SyncActionValue$LocaleSettingSpec = bt),
      (l.SyncActionValue$PushNameSettingSpec = vt),
      (l.SyncActionValue$PinActionSpec = St),
      (l.SyncActionValue$MuteActionSpec = Rt),
      (l.SyncActionValue$ContactActionSpec = Lt),
      (l.SyncActionValue$StarActionSpec = Et),
      (l.SyncActionDataSpec = kt),
      (l.PatchDebugDataSpec = It));
  },
  98,
);
