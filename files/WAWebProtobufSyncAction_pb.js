__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    ((F.name = "RecentEmojiWeight"),
      ...
      (ct.name = "SyncActionValue$ModelMetadata"),
      (ct.internalSpec = {
        modelName: [1, e.TYPES.STRING],
        isLatestModel: [2, e.TYPES.BOOL],
        isDetected: [3, e.TYPES.BOOL],
      }),
      (dt.name = "SyncActionValue$LabelAssociationAction"),
      (dt.internalSpec = {
        labeled: [1, e.TYPES.BOOL],
        modelMetaData: [2, e.FLAGS.REPEATED | e.TYPES.MESSAGE, ct],
      }),
      ...
      (l.SyncActionValue$ModelMetadataSpec = ct),
