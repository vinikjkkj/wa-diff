  ...
  function (t, n, r, o, a, i, l) {
    ...
    ((O.name = "RecentEmojiWeight"),
      ...
      (q.internalSpec = {
        ...
        starAction: [2, e.TYPES.MESSAGE, vt],
        contactAction: [3, e.TYPES.MESSAGE, bt],
        muteAction: [4, e.TYPES.MESSAGE, Ct],
        pinAction: [5, e.TYPES.MESSAGE, yt],
        pushNameSetting: [7, e.TYPES.MESSAGE, ht],
        quickReplyAction: [8, e.TYPES.MESSAGE, ft],
        recentEmojiWeightsAction: [11, e.TYPES.MESSAGE, mt],
        labelEditAction: [14, e.TYPES.MESSAGE, pt],
        labelAssociationAction: [15, e.TYPES.MESSAGE, _t],
        localeSetting: [16, e.TYPES.MESSAGE, gt],
        archiveChatAction: [17, e.TYPES.MESSAGE, dt],
        deleteMessageForMeAction: [18, e.TYPES.MESSAGE, ct],
        keyExpiration: [19, e.TYPES.MESSAGE, rt],
        markChatAsReadAction: [20, e.TYPES.MESSAGE, ut],
        clearChatAction: [21, e.TYPES.MESSAGE, st],
        deleteChatAction: [22, e.TYPES.MESSAGE, lt],
        unarchiveChatsSetting: [23, e.TYPES.MESSAGE, it],
        primaryFeature: [24, e.TYPES.MESSAGE, nt],
        androidUnsupportedActions: [26, e.TYPES.MESSAGE, tt],
        agentAction: [27, e.TYPES.MESSAGE, et],
        subscriptionAction: [28, e.TYPES.MESSAGE, Ze],
        userStatusMuteAction: [29, e.TYPES.MESSAGE, Je],
        timeFormatAction: [30, e.TYPES.MESSAGE, Ye],
        nuxAction: [31, e.TYPES.MESSAGE, Xe],
        primaryVersionAction: [32, e.TYPES.MESSAGE, Qe],
        stickerAction: [33, e.TYPES.MESSAGE, je],
        removeRecentStickerAction: [34, e.TYPES.MESSAGE, Ke],
        chatAssignment: [35, e.TYPES.MESSAGE, ze],
        chatAssignmentOpenedStatus: [36, e.TYPES.MESSAGE, Ge],
        pnForLidChatAction: [37, e.TYPES.MESSAGE, He],
        marketingMessageAction: [38, e.TYPES.MESSAGE, Ue],
        marketingMessageBroadcastAction: [39, e.TYPES.MESSAGE, qe],
        externalWebBetaAction: [40, e.TYPES.MESSAGE, We],
        privacySettingRelayAllCalls: [41, e.TYPES.MESSAGE, Oe],
        callLogAction: [42, e.TYPES.MESSAGE, Fe],
        ugcBot: [43, e.TYPES.MESSAGE, Ae],
        statusPrivacy: [44, e.TYPES.MESSAGE, Me],
        botWelcomeRequestAction: [45, e.TYPES.MESSAGE, $e],
        deleteIndividualCallLog: [46, e.TYPES.MESSAGE, xe],
        labelReorderingAction: [47, e.TYPES.MESSAGE, De],
        paymentInfoAction: [48, e.TYPES.MESSAGE, Te],
        customPaymentMethodsAction: [49, e.TYPES.MESSAGE, Ee],
        lockChatAction: [50, e.TYPES.MESSAGE, Le],
        chatLockSettings: [
          51,
          e.TYPES.MESSAGE,
        ...
        usernameChatStartMode: [59, e.TYPES.MESSAGE, Ve],
        ...
        newsletterSavedInterestsAction: [75, e.TYPES.MESSAGE, Pe],
      ...
      (Le.name = "SyncActionValue$LockChatAction"),
      (Le.internalSpec = { locked: [1, e.TYPES.BOOL] }),
      (Ee.name = "SyncActionValue$CustomPaymentMethodsAction"),
      (Ee.internalSpec = {
        customPaymentMethods: [1, e.FLAGS.REPEATED | e.TYPES.MESSAGE, ke],
      }),
      (ke.name = "SyncActionValue$CustomPaymentMethod"),
      (ke.internalSpec = {
        credentialId: [1, e.FLAGS.REQUIRED | e.TYPES.STRING],
        country: [2, e.FLAGS.REQUIRED | e.TYPES.STRING],
        type: [3, e.FLAGS.REQUIRED | e.TYPES.STRING],
        metadata: [4, e.FLAGS.REPEATED | e.TYPES.MESSAGE, Ie],
      }),
      (Ie.name = "SyncActionValue$CustomPaymentMethodMetadata"),
      (Ie.internalSpec = {
        key: [1, e.FLAGS.REQUIRED | e.TYPES.STRING],
        value: [2, e.FLAGS.REQUIRED | e.TYPES.STRING],
      }),
      (Te.name = "SyncActionValue$PaymentInfoAction"),
      (Te.internalSpec = { cpi: [1, e.TYPES.STRING] }),
      (De.name = "SyncActionValue$LabelReorderingAction"),
      (De.internalSpec = {
        sortedLabelIds: [1, e.FLAGS.REPEATED | e.TYPES.INT32],
      }),
      (xe.name = "SyncActionValue$DeleteIndividualCallLogAction"),
      (xe.internalSpec = {
        peerJid: [1, e.TYPES.STRING],
        isIncoming: [2, e.TYPES.BOOL],
      }),
      ($e.name = "SyncActionValue$BotWelcomeRequestAction"),
      ($e.internalSpec = { isSent: [1, e.TYPES.BOOL] }),
      (Pe.name = "SyncActionValue$NewsletterSavedInterestsAction"),
      (Pe.internalSpec = { newsletterSavedInterests: [1, e.TYPES.STRING] }),
      (Ne.name = "SyncActionValue$MusicUserIdAction"),
      (Ne.internalSpec = {
        musicUserId: [1, e.TYPES.STRING],
        music_user_id_map: [2, e.TYPES.MAP, [e.TYPES.STRING, e.TYPES.STRING]],
      }),
      (Me.name = "SyncActionValue$StatusPrivacyAction"),
      (Me.internalSpec = {
      ...
      (Ae.name = "SyncActionValue$UGCBot"),
      (Ae.internalSpec = { definition: [1, e.TYPES.BYTES] }),
      (Fe.name = "SyncActionValue$CallLogAction"),
      (Fe.internalSpec = { callLogRecord: [1, e.TYPES.MESSAGE, B] }),
      (Oe.name = "SyncActionValue$PrivacySettingRelayAllCalls"),
      (Oe.internalSpec = { isEnabled: [1, e.TYPES.BOOL] }),
      (Be.name = "SyncActionValue$DetectedOutcomesStatusAction"),
      (Be.internalSpec = { isEnabled: [1, e.TYPES.BOOL] }),
      (We.name = "SyncActionValue$ExternalWebBetaAction"),
      (We.internalSpec = { isOptIn: [1, e.TYPES.BOOL] }),
      (qe.name = "SyncActionValue$MarketingMessageBroadcastAction"),
      (qe.internalSpec = { repliedCount: [1, e.TYPES.INT32] }),
      (Ue.name = "SyncActionValue$MarketingMessageAction"),
      (Ue.internalSpec = {
        name: [1, e.TYPES.STRING],
      ...
      (Ve.name = "SyncActionValue$UsernameChatStartModeAction"),
      (Ve.internalSpec = { chatStartMode: [1, e.TYPES.ENUM, P] }),
      (He.name = "SyncActionValue$PnForLidChatAction"),
      (He.internalSpec = { pnJid: [1, e.TYPES.STRING] }),
      (Ge.name = "SyncActionValue$ChatAssignmentOpenedStatusAction"),
      (Ge.internalSpec = { chatOpened: [1, e.TYPES.BOOL] }),
      (ze.name = "SyncActionValue$ChatAssignmentAction"),
      (ze.internalSpec = { deviceAgentId: [1, e.TYPES.STRING] }),
      ...
      (Ke.name = "SyncActionValue$RemoveRecentStickerAction"),
      (Ke.internalSpec = { lastStickerSentTs: [1, e.TYPES.INT64] }),
      (Qe.name = "SyncActionValue$PrimaryVersionAction"),
      (Qe.internalSpec = { version: [1, e.TYPES.STRING] }),
      (Xe.name = "SyncActionValue$NuxAction"),
      (Xe.internalSpec = { acknowledged: [1, e.TYPES.BOOL] }),
      (Ye.name = "SyncActionValue$TimeFormatAction"),
      (Ye.internalSpec = { isTwentyFourHourFormatEnabled: [1, e.TYPES.BOOL] }),
      (Je.name = "SyncActionValue$UserStatusMuteAction"),
      (Je.internalSpec = { muted: [1, e.TYPES.BOOL] }),
      ...
      (et.name = "SyncActionValue$AgentAction"),
      (et.internalSpec = {
        name: [1, e.TYPES.STRING],
        deviceId: [2, e.TYPES.INT32],
        isDeleted: [3, e.TYPES.BOOL],
      }),
      (tt.name = "SyncActionValue$AndroidUnsupportedActions"),
      (tt.internalSpec = { allowed: [1, e.TYPES.BOOL] }),
      (nt.name = "SyncActionValue$PrimaryFeature"),
      (nt.internalSpec = { flags: [1, e.FLAGS.REPEATED | e.TYPES.STRING] }),
      (rt.name = "SyncActionValue$KeyExpiration"),
      (rt.internalSpec = { expiredKeyEpoch: [1, e.TYPES.INT32] }),
      (ot.name = "SyncActionValue$SyncActionMessage"),
      (ot.internalSpec = {
        key: [
          1,
          e.TYPES.MESSAGE,
      ...
      (at.name = "SyncActionValue$SyncActionMessageRange"),
      (at.internalSpec = {
        lastMessageTimestamp: [1, e.TYPES.INT64],
        lastSystemMessageTimestamp: [2, e.TYPES.INT64],
        messages: [3, e.FLAGS.REPEATED | e.TYPES.MESSAGE, ot],
      }),
      (it.name = "SyncActionValue$UnarchiveChatsSetting"),
      (it.internalSpec = { unarchiveChats: [1, e.TYPES.BOOL] }),
      (lt.name = "SyncActionValue$DeleteChatAction"),
      (lt.internalSpec = { messageRange: [1, e.TYPES.MESSAGE, at] }),
      (st.name = "SyncActionValue$ClearChatAction"),
      (st.internalSpec = { messageRange: [1, e.TYPES.MESSAGE, at] }),
      (ut.name = "SyncActionValue$MarkChatAsReadAction"),
      (ut.internalSpec = {
        read: [1, e.TYPES.BOOL],
        messageRange: [2, e.TYPES.MESSAGE, at],
      }),
      (ct.name = "SyncActionValue$DeleteMessageForMeAction"),
      (ct.internalSpec = {
        deleteMedia: [1, e.TYPES.BOOL],
        messageTimestamp: [2, e.TYPES.INT64],
      }),
      (dt.name = "SyncActionValue$ArchiveChatAction"),
      (dt.internalSpec = {
        archived: [1, e.TYPES.BOOL],
        messageRange: [2, e.TYPES.MESSAGE, at],
      }),
      (mt.name = "SyncActionValue$RecentEmojiWeightsAction"),
      (mt.internalSpec = {
        weights: [1, e.FLAGS.REPEATED | e.TYPES.MESSAGE, O],
      }),
      (pt.name = "SyncActionValue$LabelEditAction"),
      (pt.internalSpec = {
        name: [1, e.TYPES.STRING],
      ...
      (_t.name = "SyncActionValue$LabelAssociationAction"),
      (_t.internalSpec = {
        labeled: [1, e.TYPES.BOOL],
        modelMetaData: [2, e.TYPES.STRING],
      }),
      (ft.name = "SyncActionValue$QuickReplyAction"),
      (ft.internalSpec = {
      ...
      (gt.name = "SyncActionValue$LocaleSetting"),
      (gt.internalSpec = { locale: [1, e.TYPES.STRING] }),
      (ht.name = "SyncActionValue$PushNameSetting"),
      (ht.internalSpec = { name: [1, e.TYPES.STRING] }),
      (yt.name = "SyncActionValue$PinAction"),
      (yt.internalSpec = { pinned: [1, e.TYPES.BOOL] }),
      (Ct.name = "SyncActionValue$MuteAction"),
      (Ct.internalSpec = {
      ...
      (bt.name = "SyncActionValue$ContactAction"),
      (bt.internalSpec = {
        fullName: [1, e.TYPES.STRING],
        firstName: [2, e.TYPES.STRING],
      ...
      (vt.name = "SyncActionValue$StarAction"),
      (vt.internalSpec = { starred: [1, e.TYPES.BOOL] }),
      (St.name = "SyncActionData"),
      (St.internalSpec = {
      ...
      (l.SyncActionValue$LockChatActionSpec = Le),
      (l.SyncActionValue$CustomPaymentMethodsActionSpec = Ee),
      (l.SyncActionValue$CustomPaymentMethodSpec = ke),
      (l.SyncActionValue$CustomPaymentMethodMetadataSpec = Ie),
      (l.SyncActionValue$PaymentInfoActionSpec = Te),
      (l.SyncActionValue$LabelReorderingActionSpec = De),
      (l.SyncActionValue$DeleteIndividualCallLogActionSpec = xe),
      (l.SyncActionValue$BotWelcomeRequestActionSpec = $e),
      (l.SyncActionValue$NewsletterSavedInterestsActionSpec = Pe),
      (l.SyncActionValue$MusicUserIdActionSpec = Ne),
      (l.SyncActionValue$StatusPrivacyActionSpec = Me),
      (l.SyncActionValue$StatusPrivacyAction$CustomListSpec = we),
      (l.SyncActionValue$UGCBotSpec = Ae),
      (l.SyncActionValue$CallLogActionSpec = Fe),
      (l.SyncActionValue$PrivacySettingRelayAllCallsSpec = Oe),
      (l.SyncActionValue$DetectedOutcomesStatusActionSpec = Be),
      (l.SyncActionValue$ExternalWebBetaActionSpec = We),
      (l.SyncActionValue$MarketingMessageBroadcastActionSpec = qe),
      (l.SyncActionValue$MarketingMessageActionSpec = Ue),
      (l.SyncActionValue$UsernameChatStartModeActionSpec = Ve),
      (l.SyncActionValue$PnForLidChatActionSpec = He),
      (l.SyncActionValue$ChatAssignmentOpenedStatusActionSpec = Ge),
      (l.SyncActionValue$ChatAssignmentActionSpec = ze),
      (l.SyncActionValue$StickerActionSpec = je),
      (l.SyncActionValue$RemoveRecentStickerActionSpec = Ke),
      (l.SyncActionValue$PrimaryVersionActionSpec = Qe),
      (l.SyncActionValue$NuxActionSpec = Xe),
      (l.SyncActionValue$TimeFormatActionSpec = Ye),
      (l.SyncActionValue$UserStatusMuteActionSpec = Je),
      (l.SyncActionValue$SubscriptionActionSpec = Ze),
      (l.SyncActionValue$AgentActionSpec = et),
      (l.SyncActionValue$AndroidUnsupportedActionsSpec = tt),
      (l.SyncActionValue$PrimaryFeatureSpec = nt),
      (l.SyncActionValue$KeyExpirationSpec = rt),
      (l.SyncActionValue$SyncActionMessageSpec = ot),
      (l.SyncActionValue$SyncActionMessageRangeSpec = at),
      (l.SyncActionValue$UnarchiveChatsSettingSpec = it),
      (l.SyncActionValue$DeleteChatActionSpec = lt),
      (l.SyncActionValue$ClearChatActionSpec = st),
      (l.SyncActionValue$MarkChatAsReadActionSpec = ut),
      (l.SyncActionValue$DeleteMessageForMeActionSpec = ct),
      (l.SyncActionValue$ArchiveChatActionSpec = dt),
      (l.SyncActionValue$RecentEmojiWeightsActionSpec = mt),
      (l.SyncActionValue$LabelEditActionSpec = pt),
      (l.SyncActionValue$LabelAssociationActionSpec = _t),
      (l.SyncActionValue$QuickReplyActionSpec = ft),
      (l.SyncActionValue$LocaleSettingSpec = gt),
      (l.SyncActionValue$PushNameSettingSpec = ht),
      (l.SyncActionValue$PinActionSpec = yt),
      (l.SyncActionValue$MuteActionSpec = Ct),
      (l.SyncActionValue$ContactActionSpec = bt),
      (l.SyncActionValue$StarActionSpec = vt),
      (l.SyncActionDataSpec = St),
      (l.PatchDebugDataSpec = Rt));
  },
  98,
);
