  ...
  function (t, n, r, o, a, i, l) {
    ...
    ((O.name = "RecentEmojiWeight"),
      ...
      (q.internalSpec = {
        ...
        starAction: [2, e.TYPES.MESSAGE, yt],
        contactAction: [3, e.TYPES.MESSAGE, ht],
        muteAction: [4, e.TYPES.MESSAGE, gt],
        pinAction: [5, e.TYPES.MESSAGE, ft],
        pushNameSetting: [7, e.TYPES.MESSAGE, _t],
        quickReplyAction: [8, e.TYPES.MESSAGE, mt],
        recentEmojiWeightsAction: [11, e.TYPES.MESSAGE, ut],
        labelEditAction: [14, e.TYPES.MESSAGE, ct],
        labelAssociationAction: [15, e.TYPES.MESSAGE, dt],
        localeSetting: [16, e.TYPES.MESSAGE, pt],
        archiveChatAction: [17, e.TYPES.MESSAGE, st],
        deleteMessageForMeAction: [18, e.TYPES.MESSAGE, lt],
        keyExpiration: [19, e.TYPES.MESSAGE, et],
        markChatAsReadAction: [20, e.TYPES.MESSAGE, it],
        clearChatAction: [21, e.TYPES.MESSAGE, at],
        deleteChatAction: [22, e.TYPES.MESSAGE, ot],
        unarchiveChatsSetting: [23, e.TYPES.MESSAGE, rt],
        primaryFeature: [24, e.TYPES.MESSAGE, Ze],
        androidUnsupportedActions: [26, e.TYPES.MESSAGE, Je],
        agentAction: [27, e.TYPES.MESSAGE, Ye],
        subscriptionAction: [28, e.TYPES.MESSAGE, Xe],
        userStatusMuteAction: [29, e.TYPES.MESSAGE, Qe],
        timeFormatAction: [30, e.TYPES.MESSAGE, Ke],
        nuxAction: [31, e.TYPES.MESSAGE, je],
        primaryVersionAction: [32, e.TYPES.MESSAGE, ze],
        stickerAction: [33, e.TYPES.MESSAGE, He],
        removeRecentStickerAction: [34, e.TYPES.MESSAGE, Ge],
        chatAssignment: [35, e.TYPES.MESSAGE, Ve],
        chatAssignmentOpenedStatus: [36, e.TYPES.MESSAGE, Ue],
        pnForLidChatAction: [37, e.TYPES.MESSAGE, qe],
        marketingMessageAction: [38, e.TYPES.MESSAGE, Be],
        marketingMessageBroadcastAction: [39, e.TYPES.MESSAGE, Oe],
        externalWebBetaAction: [40, e.TYPES.MESSAGE, Fe],
        privacySettingRelayAllCalls: [41, e.TYPES.MESSAGE, we],
        callLogAction: [42, e.TYPES.MESSAGE, Me],
        ugcBot: [43, e.TYPES.MESSAGE, Ne],
        statusPrivacy: [44, e.TYPES.MESSAGE, $e],
        botWelcomeRequestAction: [45, e.TYPES.MESSAGE, Te],
        deleteIndividualCallLog: [46, e.TYPES.MESSAGE, Ie],
        labelReorderingAction: [47, e.TYPES.MESSAGE, ke],
        paymentInfoAction: [48, e.TYPES.MESSAGE, Ee],
        customPaymentMethodsAction: [49, e.TYPES.MESSAGE, Se],
        lockChatAction: [50, e.TYPES.MESSAGE, ve],
        chatLockSettings: [
          51,
          e.TYPES.MESSAGE,
          o("WAWebProtobufsChatLockSettings.pb").ChatLockSettingsSpec,
        ],
        wamoUserIdentifierAction: [52, e.TYPES.MESSAGE, be],
        privacySettingDisableLinkPreviewsAction: [53, e.TYPES.MESSAGE, Ce],
        deviceCapabilities: [
          54,
          e.TYPES.MESSAGE,
          o("WAWebProtobufsDeviceCapabilities.pb").DeviceCapabilitiesSpec,
        ],
        noteEditAction: [55, e.TYPES.MESSAGE, he],
        favoritesAction: [56, e.TYPES.MESSAGE, fe],
        merchantPaymentPartnerAction: [57, e.TYPES.MESSAGE, _e],
        waffleAccountLinkStateAction: [58, e.TYPES.MESSAGE, pe],
        usernameChatStartMode: [59, e.TYPES.MESSAGE, We],
        notificationActivitySettingAction: [60, e.TYPES.MESSAGE, me],
        lidContactAction: [61, e.TYPES.MESSAGE, de],
        ctwaPerCustomerDataSharingAction: [62, e.TYPES.MESSAGE, ue],
        paymentTosAction: [63, e.TYPES.MESSAGE, se],
        privacySettingChannelsPersonalisedRecommendationAction: [
          64,
          e.TYPES.MESSAGE,
          ye,
        ],
        detectedOutcomesStatusAction: [66, e.TYPES.MESSAGE, Ae],
        maibaAiFeaturesControlAction: [68, e.TYPES.MESSAGE, re],
        businessBroadcastListAction: [69, e.TYPES.MESSAGE, ie],
        musicUserIdAction: [70, e.TYPES.MESSAGE, xe],
        statusPostOptInNotificationPreferencesAction: [71, e.TYPES.MESSAGE, te],
        avatarUpdatedAction: [72, e.TYPES.MESSAGE, ee],
        privateProcessingSettingAction: [74, e.TYPES.MESSAGE, Z],
        newsletterSavedInterestsAction: [75, e.TYPES.MESSAGE, De],
        aiThreadRenameAction: [76, e.TYPES.MESSAGE, J],
        interactiveMessageAction: [77, e.TYPES.MESSAGE, X],
        settingsSyncAction: [78, e.TYPES.MESSAGE, j],
        outContactAction: [79, e.TYPES.MESSAGE, ce],
        nctSaltSyncAction: [80, e.TYPES.MESSAGE, Q],
        businessBroadcastCampaignAction: [81, e.TYPES.MESSAGE, ae],
        businessBroadcastInsightsAction: [82, e.TYPES.MESSAGE, z],
        customerDataAction: [83, e.TYPES.MESSAGE, G],
        subscriptionsSyncV2Action: [84, e.TYPES.MESSAGE, U],
        threadPinAction: [85, e.TYPES.MESSAGE, Y],
        autoOrganizeBusinessChatSetting: [86, e.TYPES.MESSAGE, K],
        bizAiSettingsNudgeAction: [87, e.TYPES.MESSAGE, ne],
      }),
      (U.name = "SyncActionValue$SubscriptionsSyncV2Action"),
      (U.internalSpec = {
        subscriptions: [1, e.FLAGS.REPEATED | e.TYPES.MESSAGE, H],
        paidFeature: [2, e.FLAGS.REPEATED | e.TYPES.MESSAGE, V],
      }),
      (V.name = "SyncActionValue$SubscriptionsSyncV2Action$PaidFeature"),
      (V.internalSpec = {
      ...
      (H.name = "SyncActionValue$SubscriptionsSyncV2Action$SubscriptionInfo"),
      (H.internalSpec = {
        id: [1, e.TYPES.STRING],
      ...
      (G.name = "SyncActionValue$CustomerDataAction"),
      (G.internalSpec = {
      ...
      (K.name = "SyncActionValue$AutoOrganizeBusinessChatSetting"),
      (K.internalSpec = { autoOrganize: [1, e.TYPES.BOOL] }),
      (Q.name = "SyncActionValue$NctSaltSyncAction"),
      (Q.internalSpec = { salt: [1, e.TYPES.BYTES] }),
      (X.name = "SyncActionValue$InteractiveMessageAction"),
      (X.internalSpec = {
        type: [1, e.FLAGS.REQUIRED | e.TYPES.ENUM, y],
        agmId: [2, e.TYPES.STRING],
      }),
      (Y.name = "SyncActionValue$ThreadPinAction"),
      (Y.internalSpec = { pinned: [1, e.TYPES.BOOL] }),
      (J.name = "SyncActionValue$AiThreadRenameAction"),
      (J.internalSpec = { newTitle: [1, e.TYPES.STRING] }),
      (Z.name = "SyncActionValue$PrivateProcessingSettingAction"),
      (Z.internalSpec = { privateProcessingStatus: [1, e.TYPES.ENUM, C] }),
      (ee.name = "SyncActionValue$AvatarUpdatedAction"),
      (ee.internalSpec = {
        eventType: [1, e.TYPES.ENUM, b],
        recentAvatarStickers: [2, e.FLAGS.REPEATED | e.TYPES.MESSAGE, He],
      }),
      (te.name =
        "SyncActionValue$StatusPostOptInNotificationPreferencesAction"),
      (te.internalSpec = { enabled: [1, e.TYPES.BOOL] }),
      (ne.name = "SyncActionValue$BizAISettingsNudgeAction"),
      (ne.internalSpec = {
        category: [1, e.TYPES.ENUM, v],
        version: [2, e.TYPES.INT64],
        updatedAtMs: [3, e.TYPES.INT64],
      }),
      (re.name = "SyncActionValue$MaibaAIFeaturesControlAction"),
      (re.internalSpec = {
        aiFeatureStatus: [1, e.TYPES.ENUM, R],
        aiReplyMode: [2, e.TYPES.ENUM, S],
      }),
      (oe.name = "SyncActionValue$BroadcastListParticipant"),
      (oe.internalSpec = {
        lidJid: [1, e.FLAGS.REQUIRED | e.TYPES.STRING],
        pnJid: [2, e.TYPES.STRING],
      }),
      (ae.name = "SyncActionValue$BusinessBroadcastCampaignAction"),
      (ae.internalSpec = {
      ...
      (ie.name = "SyncActionValue$BusinessBroadcastListAction"),
      (ie.internalSpec = {
        deleted: [1, e.TYPES.BOOL],
        participants: [2, e.FLAGS.REPEATED | e.TYPES.MESSAGE, oe],
        listName: [3, e.TYPES.STRING],
        labelIds: [4, e.FLAGS.REPEATED | e.TYPES.STRING],
        audienceExpression: [5, e.TYPES.STRING],
      }),
      (le.name = "SyncActionValue$BusinessBroadcastAssociationAction"),
      (le.internalSpec = { deleted: [1, e.TYPES.BOOL] }),
      (se.name = "SyncActionValue$PaymentTosAction"),
      (se.internalSpec = {
        paymentNotice: [1, e.FLAGS.REQUIRED | e.TYPES.ENUM, E],
        accepted: [2, e.FLAGS.REQUIRED | e.TYPES.BOOL],
      }),
      (ue.name = "SyncActionValue$CtwaPerCustomerDataSharingAction"),
      (ue.internalSpec = {
        isCtwaPerCustomerDataSharingEnabled: [1, e.TYPES.BOOL],
      }),
      (ce.name = "SyncActionValue$OutContactAction"),
      (ce.internalSpec = {
        fullName: [1, e.TYPES.STRING],
        firstName: [2, e.TYPES.STRING],
      }),
      (de.name = "SyncActionValue$LidContactAction"),
      (de.internalSpec = {
        fullName: [1, e.TYPES.STRING],
        firstName: [2, e.TYPES.STRING],
        username: [3, e.TYPES.STRING],
      }),
      (me.name = "SyncActionValue$NotificationActivitySettingAction"),
      (me.internalSpec = { notificationActivitySetting: [1, e.TYPES.ENUM, k] }),
      (pe.name = "SyncActionValue$WaffleAccountLinkStateAction"),
      (pe.internalSpec = { linkState: [2, e.TYPES.ENUM, I] }),
      (_e.name = "SyncActionValue$MerchantPaymentPartnerAction"),
      (_e.internalSpec = {
      ...
      (fe.name = "SyncActionValue$FavoritesAction"),
      (fe.internalSpec = {
        favorites: [1, e.FLAGS.REPEATED | e.TYPES.MESSAGE, ge],
      }),
      (ge.name = "SyncActionValue$FavoritesAction$Favorite"),
      (ge.internalSpec = { id: [1, e.TYPES.STRING] }),
      (he.name = "SyncActionValue$NoteEditAction"),
      (he.internalSpec = {
      ...
      (ye.internalSpec = { isUserOptedOut: [1, e.TYPES.BOOL] }),
      (Ce.name = "SyncActionValue$PrivacySettingDisableLinkPreviewsAction"),
      (Ce.internalSpec = { isPreviewsDisabled: [1, e.TYPES.BOOL] }),
      (be.name = "SyncActionValue$WamoUserIdentifierAction"),
      (be.internalSpec = { identifier: [1, e.TYPES.STRING] }),
      (ve.name = "SyncActionValue$LockChatAction"),
      (ve.internalSpec = { locked: [1, e.TYPES.BOOL] }),
      (Se.name = "SyncActionValue$CustomPaymentMethodsAction"),
      (Se.internalSpec = {
        customPaymentMethods: [1, e.FLAGS.REPEATED | e.TYPES.MESSAGE, Re],
      }),
      (Re.name = "SyncActionValue$CustomPaymentMethod"),
      (Re.internalSpec = {
        credentialId: [1, e.FLAGS.REQUIRED | e.TYPES.STRING],
        country: [2, e.FLAGS.REQUIRED | e.TYPES.STRING],
        type: [3, e.FLAGS.REQUIRED | e.TYPES.STRING],
        metadata: [4, e.FLAGS.REPEATED | e.TYPES.MESSAGE, Le],
      }),
      (Le.name = "SyncActionValue$CustomPaymentMethodMetadata"),
      (Le.internalSpec = {
        key: [1, e.FLAGS.REQUIRED | e.TYPES.STRING],
        value: [2, e.FLAGS.REQUIRED | e.TYPES.STRING],
      }),
      (Ee.name = "SyncActionValue$PaymentInfoAction"),
      (Ee.internalSpec = { cpi: [1, e.TYPES.STRING] }),
      (ke.name = "SyncActionValue$LabelReorderingAction"),
      (ke.internalSpec = {
        sortedLabelIds: [1, e.FLAGS.REPEATED | e.TYPES.INT32],
      }),
      (Ie.name = "SyncActionValue$DeleteIndividualCallLogAction"),
      (Ie.internalSpec = {
        peerJid: [1, e.TYPES.STRING],
        isIncoming: [2, e.TYPES.BOOL],
      }),
      (Te.name = "SyncActionValue$BotWelcomeRequestAction"),
      (Te.internalSpec = { isSent: [1, e.TYPES.BOOL] }),
      (De.name = "SyncActionValue$NewsletterSavedInterestsAction"),
      (De.internalSpec = { newsletterSavedInterests: [1, e.TYPES.STRING] }),
      (xe.name = "SyncActionValue$MusicUserIdAction"),
      (xe.internalSpec = {
        musicUserId: [1, e.TYPES.STRING],
        music_user_id_map: [2, e.TYPES.MAP, [e.TYPES.STRING, e.TYPES.STRING]],
      }),
      ($e.name = "SyncActionValue$StatusPrivacyAction"),
      ($e.internalSpec = {
        mode: [1, e.TYPES.ENUM, x],
        userJid: [2, e.FLAGS.REPEATED | e.TYPES.STRING],
        shareToFB: [3, e.TYPES.BOOL],
        shareToIG: [4, e.TYPES.BOOL],
        customLists: [5, e.FLAGS.REPEATED | e.TYPES.MESSAGE, Pe],
        modes: [6, e.FLAGS.REPEATED | e.TYPES.ENUM, x],
      }),
      (Pe.name = "SyncActionValue$StatusPrivacyAction$CustomList"),
      (Pe.internalSpec = {
      ...
      (Ne.name = "SyncActionValue$UGCBot"),
      (Ne.internalSpec = { definition: [1, e.TYPES.BYTES] }),
      (Me.name = "SyncActionValue$CallLogAction"),
      (Me.internalSpec = { callLogRecord: [1, e.TYPES.MESSAGE, B] }),
      (we.name = "SyncActionValue$PrivacySettingRelayAllCalls"),
      (we.internalSpec = { isEnabled: [1, e.TYPES.BOOL] }),
      (Ae.name = "SyncActionValue$DetectedOutcomesStatusAction"),
      (Ae.internalSpec = { isEnabled: [1, e.TYPES.BOOL] }),
      (Fe.name = "SyncActionValue$ExternalWebBetaAction"),
      (Fe.internalSpec = { isOptIn: [1, e.TYPES.BOOL] }),
      (Oe.name = "SyncActionValue$MarketingMessageBroadcastAction"),
      (Oe.internalSpec = { repliedCount: [1, e.TYPES.INT32] }),
      (Be.name = "SyncActionValue$MarketingMessageAction"),
      (Be.internalSpec = {
        name: [1, e.TYPES.STRING],
      ...
      (We.name = "SyncActionValue$UsernameChatStartModeAction"),
      (We.internalSpec = { chatStartMode: [1, e.TYPES.ENUM, P] }),
      (qe.name = "SyncActionValue$PnForLidChatAction"),
      (qe.internalSpec = { pnJid: [1, e.TYPES.STRING] }),
      (Ue.name = "SyncActionValue$ChatAssignmentOpenedStatusAction"),
      (Ue.internalSpec = { chatOpened: [1, e.TYPES.BOOL] }),
      (Ve.name = "SyncActionValue$ChatAssignmentAction"),
      (Ve.internalSpec = { deviceAgentID: [1, e.TYPES.STRING] }),
      (He.name = "SyncActionValue$StickerAction"),
      (He.internalSpec = {
      ...
      (Ge.name = "SyncActionValue$RemoveRecentStickerAction"),
      (Ge.internalSpec = { lastStickerSentTs: [1, e.TYPES.INT64] }),
      (ze.name = "SyncActionValue$PrimaryVersionAction"),
      (ze.internalSpec = { version: [1, e.TYPES.STRING] }),
      (je.name = "SyncActionValue$NuxAction"),
      (je.internalSpec = { acknowledged: [1, e.TYPES.BOOL] }),
      (Ke.name = "SyncActionValue$TimeFormatAction"),
      (Ke.internalSpec = { isTwentyFourHourFormatEnabled: [1, e.TYPES.BOOL] }),
      (Qe.name = "SyncActionValue$UserStatusMuteAction"),
      (Qe.internalSpec = { muted: [1, e.TYPES.BOOL] }),
      (Xe.name = "SyncActionValue$SubscriptionAction"),
      (Xe.internalSpec = {
        isDeactivated: [1, e.TYPES.BOOL],
        isAutoRenewing: [2, e.TYPES.BOOL],
        expirationDate: [3, e.TYPES.INT64],
      }),
      (Ye.name = "SyncActionValue$AgentAction"),
      (Ye.internalSpec = {
        name: [1, e.TYPES.STRING],
        deviceID: [2, e.TYPES.INT32],
        isDeleted: [3, e.TYPES.BOOL],
      }),
      (Je.name = "SyncActionValue$AndroidUnsupportedActions"),
      (Je.internalSpec = { allowed: [1, e.TYPES.BOOL] }),
      (Ze.name = "SyncActionValue$PrimaryFeature"),
      (Ze.internalSpec = { flags: [1, e.FLAGS.REPEATED | e.TYPES.STRING] }),
      (et.name = "SyncActionValue$KeyExpiration"),
      (et.internalSpec = { expiredKeyEpoch: [1, e.TYPES.INT32] }),
      (tt.name = "SyncActionValue$SyncActionMessage"),
      (tt.internalSpec = {
        key: [
          1,
          e.TYPES.MESSAGE,
      ...
      (nt.name = "SyncActionValue$SyncActionMessageRange"),
      (nt.internalSpec = {
        lastMessageTimestamp: [1, e.TYPES.INT64],
        lastSystemMessageTimestamp: [2, e.TYPES.INT64],
        messages: [3, e.FLAGS.REPEATED | e.TYPES.MESSAGE, tt],
      }),
      (rt.name = "SyncActionValue$UnarchiveChatsSetting"),
      (rt.internalSpec = { unarchiveChats: [1, e.TYPES.BOOL] }),
      (ot.name = "SyncActionValue$DeleteChatAction"),
      (ot.internalSpec = { messageRange: [1, e.TYPES.MESSAGE, nt] }),
      (at.name = "SyncActionValue$ClearChatAction"),
      (at.internalSpec = { messageRange: [1, e.TYPES.MESSAGE, nt] }),
      (it.name = "SyncActionValue$MarkChatAsReadAction"),
      (it.internalSpec = {
        read: [1, e.TYPES.BOOL],
        messageRange: [2, e.TYPES.MESSAGE, nt],
      }),
      (lt.name = "SyncActionValue$DeleteMessageForMeAction"),
      (lt.internalSpec = {
        deleteMedia: [1, e.TYPES.BOOL],
        messageTimestamp: [2, e.TYPES.INT64],
      }),
      (st.name = "SyncActionValue$ArchiveChatAction"),
      (st.internalSpec = {
        archived: [1, e.TYPES.BOOL],
        messageRange: [2, e.TYPES.MESSAGE, nt],
      }),
      (ut.name = "SyncActionValue$RecentEmojiWeightsAction"),
      (ut.internalSpec = {
      ...
      (dt.name = "SyncActionValue$LabelAssociationAction"),
      (dt.internalSpec = {
        labeled: [1, e.TYPES.BOOL],
        modelMetaData: [2, e.TYPES.STRING],
      }),
      (mt.name = "SyncActionValue$QuickReplyAction"),
      (mt.internalSpec = {
      ...
      (pt.name = "SyncActionValue$LocaleSetting"),
      (pt.internalSpec = { locale: [1, e.TYPES.STRING] }),
      (_t.name = "SyncActionValue$PushNameSetting"),
      (_t.internalSpec = { name: [1, e.TYPES.STRING] }),
      (ft.name = "SyncActionValue$PinAction"),
      (ft.internalSpec = { pinned: [1, e.TYPES.BOOL] }),
      (gt.name = "SyncActionValue$MuteAction"),
      (gt.internalSpec = {
      ...
      (ht.name = "SyncActionValue$ContactAction"),
      (ht.internalSpec = {
        fullName: [1, e.TYPES.STRING],
        firstName: [2, e.TYPES.STRING],
      ...
      (yt.name = "SyncActionValue$StarAction"),
      (yt.internalSpec = { starred: [1, e.TYPES.BOOL] }),
      (Ct.name = "SyncActionData"),
      (Ct.internalSpec = {
      ...
      (l.SyncActionValue$SubscriptionsSyncV2ActionSpec = U),
      (l.SyncActionValue$SubscriptionsSyncV2Action$PaidFeatureSpec = V),
      (l.SyncActionValue$SubscriptionsSyncV2Action$SubscriptionInfoSpec = H),
      (l.SyncActionValue$CustomerDataActionSpec = G),
      (l.SyncActionValue$BusinessBroadcastInsightsActionSpec = z),
      (l.SyncActionValue$SettingsSyncActionSpec = j),
      (l.SyncActionValue$AutoOrganizeBusinessChatSettingSpec = K),
      (l.SyncActionValue$NctSaltSyncActionSpec = Q),
      (l.SyncActionValue$InteractiveMessageActionSpec = X),
      (l.SyncActionValue$ThreadPinActionSpec = Y),
      (l.SyncActionValue$AiThreadRenameActionSpec = J),
      (l.SyncActionValue$PrivateProcessingSettingActionSpec = Z),
      (l.SyncActionValue$AvatarUpdatedActionSpec = ee),
      (l.SyncActionValue$StatusPostOptInNotificationPreferencesActionSpec = te),
      (l.SyncActionValue$BizAISettingsNudgeActionSpec = ne),
      (l.SyncActionValue$MaibaAIFeaturesControlActionSpec = re),
      (l.SyncActionValue$BroadcastListParticipantSpec = oe),
      (l.SyncActionValue$BusinessBroadcastCampaignActionSpec = ae),
      (l.SyncActionValue$BusinessBroadcastListActionSpec = ie),
      (l.SyncActionValue$BusinessBroadcastAssociationActionSpec = le),
      (l.SyncActionValue$PaymentTosActionSpec = se),
      (l.SyncActionValue$CtwaPerCustomerDataSharingActionSpec = ue),
      (l.SyncActionValue$OutContactActionSpec = ce),
      (l.SyncActionValue$LidContactActionSpec = de),
      (l.SyncActionValue$NotificationActivitySettingActionSpec = me),
      (l.SyncActionValue$WaffleAccountLinkStateActionSpec = pe),
      (l.SyncActionValue$MerchantPaymentPartnerActionSpec = _e),
      (l.SyncActionValue$FavoritesActionSpec = fe),
      (l.SyncActionValue$FavoritesAction$FavoriteSpec = ge),
      (l.SyncActionValue$NoteEditActionSpec = he),
      (l.SyncActionValue$PrivacySettingChannelsPersonalisedRecommendationActionSpec =
        ye),
      (l.SyncActionValue$PrivacySettingDisableLinkPreviewsActionSpec = Ce),
      (l.SyncActionValue$WamoUserIdentifierActionSpec = be),
      (l.SyncActionValue$LockChatActionSpec = ve),
      (l.SyncActionValue$CustomPaymentMethodsActionSpec = Se),
      (l.SyncActionValue$CustomPaymentMethodSpec = Re),
      (l.SyncActionValue$CustomPaymentMethodMetadataSpec = Le),
      (l.SyncActionValue$PaymentInfoActionSpec = Ee),
      (l.SyncActionValue$LabelReorderingActionSpec = ke),
      (l.SyncActionValue$DeleteIndividualCallLogActionSpec = Ie),
      (l.SyncActionValue$BotWelcomeRequestActionSpec = Te),
      (l.SyncActionValue$NewsletterSavedInterestsActionSpec = De),
      (l.SyncActionValue$MusicUserIdActionSpec = xe),
      (l.SyncActionValue$StatusPrivacyActionSpec = $e),
      (l.SyncActionValue$StatusPrivacyAction$CustomListSpec = Pe),
      (l.SyncActionValue$UGCBotSpec = Ne),
      (l.SyncActionValue$CallLogActionSpec = Me),
      (l.SyncActionValue$PrivacySettingRelayAllCallsSpec = we),
      (l.SyncActionValue$DetectedOutcomesStatusActionSpec = Ae),
      (l.SyncActionValue$ExternalWebBetaActionSpec = Fe),
      (l.SyncActionValue$MarketingMessageBroadcastActionSpec = Oe),
      (l.SyncActionValue$MarketingMessageActionSpec = Be),
      (l.SyncActionValue$UsernameChatStartModeActionSpec = We),
      (l.SyncActionValue$PnForLidChatActionSpec = qe),
      (l.SyncActionValue$ChatAssignmentOpenedStatusActionSpec = Ue),
      (l.SyncActionValue$ChatAssignmentActionSpec = Ve),
      (l.SyncActionValue$StickerActionSpec = He),
      (l.SyncActionValue$RemoveRecentStickerActionSpec = Ge),
      (l.SyncActionValue$PrimaryVersionActionSpec = ze),
      (l.SyncActionValue$NuxActionSpec = je),
      (l.SyncActionValue$TimeFormatActionSpec = Ke),
      (l.SyncActionValue$UserStatusMuteActionSpec = Qe),
      (l.SyncActionValue$SubscriptionActionSpec = Xe),
      (l.SyncActionValue$AgentActionSpec = Ye),
      (l.SyncActionValue$AndroidUnsupportedActionsSpec = Je),
      (l.SyncActionValue$PrimaryFeatureSpec = Ze),
      (l.SyncActionValue$KeyExpirationSpec = et),
      (l.SyncActionValue$SyncActionMessageSpec = tt),
      (l.SyncActionValue$SyncActionMessageRangeSpec = nt),
      (l.SyncActionValue$UnarchiveChatsSettingSpec = rt),
      (l.SyncActionValue$DeleteChatActionSpec = ot),
      (l.SyncActionValue$ClearChatActionSpec = at),
      (l.SyncActionValue$MarkChatAsReadActionSpec = it),
      (l.SyncActionValue$DeleteMessageForMeActionSpec = lt),
      (l.SyncActionValue$ArchiveChatActionSpec = st),
      (l.SyncActionValue$RecentEmojiWeightsActionSpec = ut),
      (l.SyncActionValue$LabelEditActionSpec = ct),
      (l.SyncActionValue$LabelAssociationActionSpec = dt),
      (l.SyncActionValue$QuickReplyActionSpec = mt),
      (l.SyncActionValue$LocaleSettingSpec = pt),
      (l.SyncActionValue$PushNameSettingSpec = _t),
      (l.SyncActionValue$PinActionSpec = ft),
      (l.SyncActionValue$MuteActionSpec = gt),
      (l.SyncActionValue$ContactActionSpec = ht),
      (l.SyncActionValue$StarActionSpec = yt),
      (l.SyncActionDataSpec = Ct),
      (l.PatchDebugDataSpec = bt));
  },
  98,
);
