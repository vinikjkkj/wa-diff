__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    async function $(e, t, n, r) {
      ...
      var a;
      try {
        a = await o("WAWebBizLabelEditingAction").labelAddAction(e, n);
      } catch (e) {
        o("WALogger")
          .ERROR(
            c ||
      ...
      if (t.length > 0) {
        ...
        try {
          o("WAWebLabelCollection").LabelCollection.addOrRemoveLabels([i], t, {
            listUpdateMode: o("WAWebLabelCollection").ListUpdateMode.CREATE,
          });
        } catch (e) {
          o("WALogger")
            .ERROR(
    ...
    async function P(e) {
      ...
      try {
        (l || s) &&
          (await o("WAWebBizLabelEditingAction").labelEditAction(
            n.id,
            a,
      ...
      try {
        if (y) {
          ...
          o("WAWebLabelCollection").LabelCollection.addOrRemoveLabels([b], d, {
            suppressSuccessToast: h || C,
          });
        }
        if (C) {
          var v = { id: String(n.id), type: "remove" };
          o("WAWebLabelCollection").LabelCollection.addOrRemoveLabels([v], m, {
    ...
    async function N(e, t, n) {
      ...
      try {
        var r,
          a = o("WAWebLabelCollection").LabelCollection.get(e);
        if (a == null)
          return (
            o("WALogger").WARN(
              y ||
        ...
        (await o("WAWebBizLabelEditingAction").labelDeleteAction(
          ...
          o("WAWebWamSmbListEventReporter").logSmbListEvent({
            ...
            predefinedId: (r = a.predefinedId) != null ? r : void 0,
          }),
    ...
    async function M(e) {
      ...
      try {
        var t = o("WAWebLabelCollection").LabelCollection.getNextOrderIndex();
        (await o("WAWebBizLabelEditingAction").labelEditAction(
          e.id,
          e.name,
          e.predefinedId,
    ...
    async function A(e) {
      if (
        ...
        var t = e.map(function (e) {
          ...
          return {
            id: String(e),
            orderIndex: (t = n == null ? void 0 : n.orderIndex) != null ? t : 0,
          };
        });
