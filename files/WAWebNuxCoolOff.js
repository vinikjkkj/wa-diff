      ...
      if (typeof e == "object" && e != null) {
        var t =
            typeof e.startDate == "string"
              ? r("WAWeb-moment")(e.startDate)
              : null,
          n = typeof e.duration == "number" ? e.duration : null;
        if (t != null && n != null) return { startDate: t, duration: n };
      }
    }
    var u = (function () {
      function t(t, n) {
      ...
      return (
        ...
        (n.$9 = function (t) {
          if (this.config.metricField) {
            var e = { bannerType: this.config.metricField, bannerOperation: t };
        ...
        (n.show = function () {
          ...
          t.isSame(i, "day") ||
            ...
            this.$9(o("WAWebWamEnumBannerOperations").BANNER_OPERATIONS.SHOWN),
            this.config.logImpression && this.config.logImpression());
        }),
        (n.click = function () {
          var e = this.nux.clicks + 1;
          (e === this.config.CLICKS_BEFORE_COOL_OFF && this.startCoolOffToday(),
            this.$7({ clicks: e }),
            this.$9(o("WAWebWamEnumBannerOperations").BANNER_OPERATIONS.CLICK));
        }),
        (n.dismiss = function () {
