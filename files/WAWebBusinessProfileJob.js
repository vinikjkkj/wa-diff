  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function c(e) {
      var t,
        n = (t = o("WAWap")).wap(
          ...
          {
            to: t.S_WHATSAPP_NET,
            smax_id: t.SMAX_ID(r("WAWapDeprecatedSmaxID").CommerceSettingsSet),
            xmlns: "fb:thrift_iq",
            id: t.generateId(),
            type: "set",
          },
        ...
        a = await o("WADeprecatedSendIq").deprecatedSendIq(n, s);
      if (a.success) return a.result;
      throw new (o("WAWebBackendErrors").ServerStatusCodeError)(a.errorCode);
    }
    async function d(e) {
      var t = o("WAWebUserPrefsMeUser").getMaybeMePnUser();
      if (t == null) throw r("err")("updateCartEnabledGraphQL: meUser is null");
      var n = await o(
        "WAWebBizCatalogManagementUpdateCommerceSettings",
      ...
      var n,
        ...
        f = (n = o("WAWap")).wap(
          ...
          n.wap(
            ...
            c !== void 0 ? o("WAWap").wap("latitude", null, String(c)) : null,
            d !== void 0 ? o("WAWap").wap("longitude", null, String(d)) : null,
            ...
            m !== void 0
              ? (function () {
                  var e =
                    m != null
                      ? o("WAWebBizGetPriceTiersQuery").getCachedPriceTierById(
                          m,
                        )
        ...
        g = await o("WADeprecatedSendIq").deprecatedSendIq(f, e);
      if (!g.success)
        throw new (o("WAWebBackendErrors").ServerStatusCodeError)(g.errorCode);
    }
    async function _(t, n, r) {
      var a,
        ...
        l = await o("WADeprecatedSendIq").deprecatedSendIq(i, e);
      if (!l.success)
        throw new (o("WAWebBackendErrors").ServerStatusCodeError)(l.errorCode);
    }
    async function f(t) {
      var n,
        r = (n = o("WAWap")).wap(
    ...
    ((l.updateCartEnabled = m),
      (l.editBusinessProfile = p),
      (l.sendCoverPhoto = _),
      (l.deleteCoverPhoto = f));
  },
  98,
);
