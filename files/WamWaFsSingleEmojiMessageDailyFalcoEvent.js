__d(
  "WamWaFsSingleEmojiMessageDailyFalcoEvent",
  [
    "FalcoLoggerInternal",
    "Promise",
  ...
  function (t, n, r, o, a, i, l) {
    ...
    var e,
      s,
      u = r("getFalcoLogPolicy_DO_NOT_USE")("8049"),
      c = {
        app_build: (s = r("requireDeferred"))(
          "WAWebFalcoCanonicalAppBuild",
        ).__setRef("WamWaFsSingleEmojiMessageDailyFalcoEvent"),
    ...
    var m = o("FalcoLoggerInternal").create(
        "wam_wa_fs_single_emoji_message_daily",
        u,
        d,
      ),
      p = m;
