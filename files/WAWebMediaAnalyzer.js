  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function $(t, n, a) {
      ...
      if ((a.addAnnotations({ bool: { use_wasm_worker: i } }), i))
        try {
          ...
          var l = await o("WABlobToArrayBuffer").blobToArrayBuffer(t),
            d = t.type,
            m = await o("WAWebMediaWorkerProxy").transcodeToMp4InWorker({
      ...
      var p = await M(t, n, a).catch(function (e) {
    ...
    async function N(e, t, n) {
      ...
      try {
        ...
        var l = o("WAWebMediaGatingUtils").shouldUseWasmMediaWorkerForFile(e);
        ...
        var u = { type: "prep", file: e, asGif: t },
          c = await o("WAWebSendMessageToMediaWorker").sendMessageToMediaWorker(
            u,
          ),
          d = c.error,
          m = c.file,
    ...
    async function M(e, t, n) {
      ...
      var r = { type: "prep", file: e, asGif: t },
        a = await o("WAWebSendMessageToMediaWorker").sendMessageToMediaWorker(
          r,
        ),
        i = a.error,
        l = a.file,
    ...
    async function w(e, t) {
      ...
      var n = await e.arrayBuffer(),
        r = await o("WAWebMediaWorkerProxy").mp4RepairMuxInWorker({
