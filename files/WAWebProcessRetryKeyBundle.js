  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function f(t) {
      var n = t.chat,
        ...
        h,
        y,
        C = await o("WAWebAddonRetryRequestUtils").getSentAddonMsgRecord(f);
      if (C != null)
        ...
        var b = await o("WAWebSchemaMessage").getMessageTable().get(String(f));
        if (!b) {
          var v = o("WAWebLidMigrationUtils").getAlternateMsgKey(f);
          if (
            (v &&
              (b = await o("WAWebSchemaMessage")
                .getMessageTable()
                .get(String(v))),
            !b)
          )
      ...
      var R = await o("WAWebApiMessageInfoStore").isRetryEligible(f, c, y, h),
        L =
          R ===
        ...
        E = L
          ...
          : null;
      (E &&
        (R = await o("WAWebApiMessageInfoStore").isRetryEligible(f, E, y, h)),
        g.type === o("WAWebSendMsgTypes").SendMessageRecordType.Message &&
          (await g.data.waitForPrep()),
        o("WALogger")
          .LOG(
            u ||
