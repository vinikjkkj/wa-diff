__d(
  ...
  function (t, n, r, o, a, i) {
    ...
    ((e.routeName = "AdsEventsManagerRoutingAppICERoute"),
      (e.configName = "AdsEventsManagerRouting"),
      (e.configPath = n("immutable").List(["app"])),
      (e.givenName = "app"),
      (e.path = "/events_manager2/list/app/{dataSourceID}"),
      (e.paramDefinitions = {
        dataSourceID: {
          type: "String",
          flowType: "FBID",
      ...
      (e.forceLoad = !1),
      (e.redirect = ["AdsEventsManagerRouting", ["app_overview"]]),
      (e.viewModuleName = "AdsEventsManagerAppInspectorContainer.react"),
      (a.exports = e));
  },
  null,
);
