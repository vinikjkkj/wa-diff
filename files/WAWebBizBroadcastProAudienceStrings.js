__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    function g() {
      return s._(
        /*BTDS*/ "By continuing you confirm you have marketing consent from all contacts added.",
      );
    }
    function h() {
    ...
    ((l.getAddSelectedAudiencesButtonLabel = e),
      (l.getChooseAnAudienceDialogTitle = u),
      (l.getAddRecipientsLabel = c),
      (l.getRemoveRecipientsLabel = d),
      (l.getRemoveRecipientsButtonLabel = m),
      (l.getEditAudienceFailureToastMessage = p),
      (l.getCreateAudienceFailureToastMessage = _),
      (l.getGoBackAriaLabel = f),
      (l.getMarketingConsentDisclaimer = g),
      (l.getChooseRecipientsToAddHeader = h),
      (l.getChooseRecipientsToRemoveHeader = y),
      (l.getSelectedCountSubtitle = C),
      (l.getSearchPlaceholder = b),
      (l.getContactListAriaLabel = v),
      (l.getSelectRecipientAriaLabel = S),
      (l.getLoadMorePaginationLabel = R),
      (l.getLoadingPaginationLabel = L));
  },
  226,
);
