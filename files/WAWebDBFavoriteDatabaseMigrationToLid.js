__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function E() {
      if (
        o("WAWebUserPrefsFavoritesLidMigration").isFavoritesMigrationComplete()
      ) {
        o("WALogger").LOG(
          e ||
      ...
      (await o("WAWebModelStorageUtils")
        .getStorage()
        .lock(["favorite", "chat"], async function (e) {
          var n = e[0],
            a = e[1],
            i = n,
            l = a;
          try {
            ...
            (L.forEach(function (e, t) {
              ...
              ($.push(e.id), P.push(babelHelpers.extends({}, e, { id: n })));
            }),
              o("WALogger").LOG(
                p ||
            ...
            if (N.length > 0) {
              ...
              o("WALogger")
                ...
                .sendLogs("migrateFavoritesDatabaseToLid-existing-favorites");
              var w = new Set(
                N.map(function (e) {
                  return e.id;
                }),
