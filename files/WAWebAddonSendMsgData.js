__d(
  ...
  function (t, n, r, o, a, i, l) {
      ...
      try {
        ...
        if (y(t))
          ...
          o("WALogger").LOG(
            ...
            t.id.id,
            h.id,
            (C = h.participant) == null ? void 0 : C.isLid(),
          );
          var b = await o("WAWebAddonProcessMsgsUtils").queryAddonParentMsgs(
              [t],
              a,
            ),
            v = b[0],
          ...
          if (
            ...
            R.convert.toDualEncryptedMsgData != null &&
              (i.encryptedMsgData = await R.convert.toDualEncryptedMsgData(
                i.decryptedMsgData,
                i.parent,
              ));
          }
          (a === o("WAWebAddonConstants").AddonProcessMode.Send ||
            a === o("WAWebAddonConstants").AddonProcessMode.SendRetry) &&
            (await o("WAWebAddonProcessMsgs").processOutgoingMsg(
              a,
              i.encryptedMsgData,
              v,
              n,
        ...
        await o("WAWebAddonRetryRequestUtils").storeSelfMessageTypeRow(
          i.decryptedMsgData,
        );
        var L =
        ...
        if (L) {
          var E = o("WAWebReferentialMsgKey").getReferentialMsgKey(i.parent);
          i.encryptedMsgData = o(
            "WAWebAddonProcessMsgsUtils",
          ).updateMsgParentKeyValue(i.encryptedMsgData, E);
        }
        var k = await o("WAWebSendMsgJob").encryptAndSendMsg(
            {
    ...
    ((l.isOptimisticAddonSendSupported = y), (l.sendAddonProcess = C));
  },
  98,
);
