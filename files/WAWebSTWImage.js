    ...
    async function m(t) {
      ...
      try {
        ...
        try {
          ...
          throw (
            o("WALogger")
              ...
              .tags("STW"),
            new (o("WAWebMiscErrors").GoogleLensApiError)(c.NON_200_RESPONSE)
          );
        }
        if (!d.ok)
          throw (
        ...
        var m = new TextDecoder(),
          p = await ((i = d.body) == null ? void 0 : i.getReader().read());
        if ((p == null ? void 0 : p.value) == null)
          throw (
            o("WALogger")
              ...
              .tags("STW"),
            new (o("WAWebMiscErrors").GoogleLensApiError)(c.NULL_RESPONSE_BODY)
          );
