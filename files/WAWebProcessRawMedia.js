  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function s(t, a) {
      ...
      try {
        ...
        c === "document" &&
          o("WAWebProcessRawMediaLogging").logSendDocumentEvent(a.filename, s);
        var m = o("WAWebMediaGatingUtils").getUploadLimit(c, a.fileOrigin, d);
        if (c === "video" && u && s >= e)
          throw new (r("WAWebMediaFileTooLargeError"))(c, e, s);
        if (!u && s > m) throw new (r("WAWebMediaFileTooLargeError"))(c, m, s);
        ...
        e: {
          if (c === "image") {
            var f;
            _ = await o("WAWebMediaDataUtils").processRawImage(
              t,
              {
                maxDimension:
          ...
          if (c === "sticker") {
            _ = await o("WAWebMediaDataUtils").processRawSticker(t);
            break e;
          }
          if (c === "video" || c === "audio") {
            if (
              ((_ = await o("WAWebMediaDataUtils").processRawAudioVideo(
                t,
                !!a.isPtt,
                a.precomputedFields,
                a.asGif,
          ...
          if (c === "document" || c === "sticker-pack") {
            _ = await o("WAWebMediaDataUtils").processRawDocument(
              t,
              a.filename,
              d,
              a.documentPageCount,
