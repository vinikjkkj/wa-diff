__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    var m = {
      ...
      addNewsletterMessageDeliveryUpdateForSelectedChat: async function () {
        var e,
        ...
        var a = await o("WAWebNewsletterDBUtils").getMessageByServerId(
          n,
          t.id.toString(),
        );
        if (a == null)
      ...
      terminateSelectedChannel: async function () {
        var e = o("WAWebDebugUtils").getSelectedChat();
        if (e == null)
