    ...
    async function c(t, n) {
      ...
      try {
        ...
        if (r("isStringNullOrEmpty")(a.greetingMessageBody))
          return (
            o("WAWebCtwaLogger").logAGMOperation({
              operationType:
                o("WAWebCtwaLogger").AGM_OPERATION_TYPE.null_greeting_message,
              fromBusiness: !l,
              agmPayload: i,
              businessWid: t.to,
              adId: a.sourceId,
        ...
        (i == null ? void 0 : i.ctaType) != null &&
          ...
          o("WAWebCtwaLogger").logAGMOperation({
            operationType:
              o("WAWebCtwaLogger").AGM_OPERATION_TYPE.agm_invalid_cta_payload,
            fromBusiness: !l,
            agmPayload: i,
            businessWid: t.to,
            adId: a.sourceId,
        ...
        var s = t.from,
          ...
          g = p,
          h = await d(n.chat),
          y = m(a == null ? void 0 : a.sourceId, h);
        if (y)
          return (
            o("WAWebCtwaLogger").logAGMOperation({
        ...
        return (
          ...
          r("isStringNullOrEmpty")(a.description) &&
            o("WAWebCtwaLogger").logAGMOperation({
              operationType:
                o("WAWebCtwaLogger").AGM_OPERATION_TYPE.bottomsheet_text_error,
              fromBusiness: !l,
              agmPayload: i,
              businessWid: g,
              adId: a.sourceId,
