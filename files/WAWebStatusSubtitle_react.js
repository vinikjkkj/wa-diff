    ...
    function L(t) {
      ...
      if (A) {
        var F,
          O,
          B =
            (F = w == null ? void 0 : w.listName) != null
              ? F
              : s._(/*BTDS*/ "Close friends"),
          W = (O = w == null ? void 0 : w.listEmoji) != null ? O : "\u2B50";
        (P.push({
          type: "closeFriends",
          content: s._(/*BTDS*/ "{List Name}", [s._param("List Name", B)]),
          onClick: function () {
            (u == null || u(),
              ...
              $.source ===
                ...
                d.jsxs(o("WAWebFlex.react").FlexRow, {
                  children: [
                    ...
                    d.jsx(R, { durationInSeconds: q, playing: m }),
                  ],
                }),
            ],
          }),
      ...
      var H = U.length > 0 ? U[V] : null;
      return d.jsxs(o("WAWebFlex.react").FlexRow, {
        align: "center",
        justify: "start",
        className: (e || (e = r("stylex")))([A && g.subtitleRow, f]),
        children: [
          d.jsx(o("WAWebFlex.react").FlexItem, {
            align: "center",
            grow: 0,
            ...
            d.jsx("span", {
              ...
              children: d.jsx(r("WAWebStatusSubtitleAttribution.react"), {
                ...
                onClick:
                  H.onClick != null
                    ? function (e) {
                        (v(H.type, E, k), H.onClick == null || H.onClick(e));
                      }
                    : null,
                icon: H.icon,
                enableChevronIcon: x && H.type !== "music",
                children: H.content,
              }),
            }),
        ],
