__d(
  ...
  function (t, n, r, o, a, i) {
    ...
    ((e.routeName = "AdsEventsManagerRoutingOfflineDataSetICERoute"),
      (e.configName = "AdsEventsManagerRouting"),
      (e.configPath = n("immutable").List(["offline_data_set"])),
      (e.givenName = "offline_data_set"),
      (e.path = "/events_manager2/list/offline_data_set/{dataSourceID}"),
      (e.paramDefinitions = {
        dataSourceID: {
          type: "String",
          flowType: "FBID",
      ...
      (e.forceLoad = !1),
      (e.redirect = ["AdsEventsManagerRouting", ["offline_data_set_overview"]]),
      (e.viewModuleName =
        "AdsEventsManagerOfflineDataSetInspectorContainer.react"),
      (a.exports = e));
  },
  null,
);
