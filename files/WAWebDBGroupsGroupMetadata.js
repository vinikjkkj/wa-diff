  ...
  function (t, n, r, o, a, i, l) {
    async function e(e) {
      ...
      await o("WAWebModelStorageUtils")
        .getStorage()
        .lock(["group-metadata"], async function (e) {
          var r = e[0],
            a = await r.bulkGet(
              t.map(function (e) {
          ...
          return (
            (n = t.map(function (e, t) {
              var n,
                ...
                h,
                y = a[t],
                C = { subject: e.subject, subjectTime: e.subjectTime || 0 },
                b = { announce: e.announce, a_v_id: e.a_v_id || 0 },
                v = {
                  desc: e.desc,
                  descId: e.descId,
                  descOwner: (n = e.descOwner) == null ? void 0 : n.toString(),
              ...
              if (y) {
                ...
                (S > C.subjectTime &&
                  ...
                  R > b.a_v_id && (b = { announce: y.announce, a_v_id: R }),
                  L > v.descTime &&
                    (v = {
                      desc: y.desc,
                      descId: y.descId,
              ...
              var k = babelHelpers.extends(
                {
                  id: e.id.toString(),
                  creation: e.creation,
                  owner: (r = e.owner) == null ? void 0 : r.toString(),
                  restrict: e.restrict,
                  ...
                  suspendAppealUpdateTime:
                    (u = e.suspendAppealUpdateTime) != null ? u : null,
                  terminated: (c = e.terminated) != null ? c : !1,
                  parentGroup:
                    (d = e.parentGroup) == null ? void 0 : d.toString(),
                  ...
                  lastActivityTimestamp:
                    (m = y == null ? void 0 : y.lastActivityTimestamp) != null
                      ? m
                      : 0,
                  lastSeenActivityTimestamp:
                    (p = y == null ? void 0 : y.lastSeenActivityTimestamp) !=
                    null
                      ? p
                      : 0,
                  isLidAddressingMode: e.isLidAddressingMode,
                  reportToAdminMode: (_ = e.reportToAdminMode) != null ? _ : !1,
                  ...
                  isOpenBotGroup:
                    (f = e == null ? void 0 : e.isOpenBotGroup) != null
                      ? f
                      : y == null
                        ? void 0
                        : y.isOpenBotGroup,
              ...
              return (
                ...
                e.groupAdder != null
                  ? babelHelpers.extends({}, k, {
                      groupAdder:
                        (h = e.groupAdder) == null ? void 0 : h.toString(),
                    })
                  : k
              );
            })),
            r.bulkCreateOrMerge(n)
          );
        });
    }
    async function s(e) {
      var t,
        ...
        p,
        _ = e.groupWid,
        f = await o("WAWebSchemaGroupMetadata")
      ...
      return f
        ? {
            id: _,
            owner:
              f.owner == null ? null : o("WAWebWidFactory").createWid(f.owner),
            creation: f.creation,
    ...
    function c(e, t, n) {
      return (
        n === void 0 && (n = !1),
        n
          ? u(babelHelpers.extends({ id: e.toString() }, t))
    ...
    ((l.updateGroupMetadataTable = e),
      (l.getGroupMetadataUNSAFE = s),
      (l.persistGroupMetadata = c),
      (l.getGroupMetadata = d),
      (l.bulkGetGroupMetadata = m));
  },
  98,
);
