__d(
  ...
  function $module_LexicalHashtag_prod(
    ...
    "use strict";
    var _n2 = (function (_t$TextNode) {
      function n() {
        return _t$TextNode.apply(this, arguments) || this;
      }
      babelHelpers.inheritsLoose(n, _t$TextNode);
      var _proto = n.prototype;
      _proto.$config = function $config() {
        return this.config("hashtag", { extends: require("Lexical").TextNode });
      };
      _proto.createDOM = function createDOM(e) {
        var _n = _t$TextNode.prototype.createDOM.call(this, e);
        return (
          require("Lexical").addClassNamesToElement(_n, e.theme.hashtag),
          _n
        );
      };
    ...
    function a(e) {
      ...
      return require("Lexical").$applyNodeReplacement(new _n2(e));
    }
    var r = new RegExp(
      (function () {
        var _ref = (function () {
    ...
    var s = {
      getHashtagMatch: function getHashtagMatch(e) {
        var t = r.exec(e);
        if (null === t) return null;
        var n = t[3].length + 1,
          a = t.index + t[1].length;
        return { end: a + n, start: a };
      },
    };
    function o(r, o) {
      if (o === void 0) {
      ...
      return require("Lexical").mergeRegister.apply(
        require("Lexical"),
        require("LexicalText").registerLexicalTextEntity(
          r,
          o.getHashtagMatch,
          _n2,
          function (e) {
            return a(e.getTextContent());
          },
        ),
      );
    }
    ...
    ((exports.$createHashtagNode = a),
      (exports.$isHashtagNode = function (e) {
        return e instanceof _n2;
      }),
      (exports.HashtagExtension = c),
      (exports.HashtagNode = _n2),
      (exports.registerLexicalHashtag = o));
  },
  null,
);
