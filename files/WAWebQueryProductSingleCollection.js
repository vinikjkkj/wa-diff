      ...
      c = async function (r) {
        ...
        try {
          var t,
            ...
            i = r.catalogWid,
            l = r.collectionId,
            u = r.directConnectionEncryptedInfo,
            c = r.height,
            d = r.limit,
            m = r.variantInfoFields,
            p = r.variantThumbnailHeight,
            _ = r.variantThumbnailWidth,
            f = r.width,
            g = await o("WAWebRelayClient").fetchQuery(
              e !== void 0
                ? e
