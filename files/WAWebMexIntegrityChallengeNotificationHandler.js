__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function c(t, n) {
      if (
        !o("WAWebIntegrityChallengeGatingUtils").isIntegrityCheckpointEnabled()
      ) {
        o("WALogger")
          .LOG(
            e ||
      ...
      try {
        ...
        var a = n.xwa2_notify_integrity_challenge,
          ...
          m;
        e: {
          if (d === o("WAWebIntegrityChallengeUtils").ChallengeTypes.PASSKEY) {
            var p = c == null ? void 0 : c.challenge_base64;
            if (p == null) throw r("err")("Missing passkey challenge_base64");
            m = { challenge_type: "PASSKEY", passkey_challenge_base64: p };
            break e;
          }
          if (d === o("WAWebIntegrityChallengeUtils").ChallengeTypes.CAPTCHA) {
