__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function g(t, n, a, i, l) {
      var f,
        g = t.data.id,
        y = o("WAWebWidFactory").createWid(g.remote.toString()),
        C = y.toString();
      if (a.length === 0) {
        o("WALogger").LOG(
          e ||
      ...
      var v = await o("WAWebDBDeviceListFanout").getFanOutList({
          wids: [].concat(a, [i]),
        ...
        R = await o("WAWebBroadcastSenderKeyManager").getBroadcastSkDistribList(
          S,
          a,
          C,
          i,
      ...
      (o("WALogger").LOG(
        ...
        (E === !0 || (I.length === 0 && T.length === 0)) &&
          (await o("WAWebSignal").Session.deleteGroupSenderKeyInfo(y, i)),
      ...
      if (P.length > 0)
        try {
          var N,
            M,
            w = await o("WAWebManageE2ESessionsJob").ensureE2ESessions(
              P,
              !1,
              o("WAWebSessionScope").SessionScope.DEFAULT,
            ),
            A = (N = w == null ? void 0 : w.missedPrekeyCount) != null ? N : 0,
            F =
              (M = w == null ? void 0 : w.depletedPrekeyCount) != null ? M : 0;
          (o("WALogger").LOG(
            c ||
            ...
            o(
              ...
              messageType: o("WAWebWamEnumMessageType").MESSAGE_TYPE.BROADCAST,
      ...
      var O = await o("WAWebPhashUtils").phashV2(a),
        B = o("WAWebUserPrefsMeUser").getMeDeviceLidOrThrow(),
        W = await o("WAWebPhashUtils").phashV2([].concat(S, [B])),
        q = new Map();
      ...
      (await o("WAWebSendMsgCommonApi").updateIdentityRange(t, S),
        await o("WAWebSignalProtocolStore")
          .getSignalProtocolStore()
          .flushBufferToDiskIfNotMemOnlyMode());
      var Y = await o("WAWebBroadcastMessageRPC").sendBroadcastMessageRPC({
          messageId: g.id,
          recipientJid: y,
          phash: W,
          messageType: Q,
      ...
      if (((f = J.success) == null ? void 0 : f.error) != null)
        throw (
          ...
          new (o("WAWebHandleMsgError").MessageSentAckError)(J.success.error)
        );
      (await o("WAWebBroadcastSenderKeyManager").markBroadcastHasSenderKey(
        V,
        C,
      ),
        o("WALogger").LOG(
    ...
    async function h(e, t, n, a, i, l, s, u) {
      u === void 0 && (u = new Map());
      ...
      var d = await o("WAWebSignal").Cipher.encryptSenderKeyMsgSignalProto(
        e,
        t,
        c,
      );
      if (!(d != null && d.ciphertext) || !(d != null && d.senderKeyBytes))
        throw r("err")(
      ...
      var m = d.ciphertext,
        ...
        g = null;
      n.length > 0 &&
        (g = await o("WAWebGetGroupKeyDistributionMsg").getKeyDistributionMsg(
          null,
          e,
          n,
          p,
        ...
        (g &&
          ...
          g.forEach(function (e) {
            var t = e.ciphertext,
              n = e.participant,
              r = e.type;
            r === o("WAWebBackendJobs.flow").CiphertextType.Pkmsg && (y = !0);
            var a =
                n.device == null || n.device === o("WAJids").DEFAULT_DEVICE_ID,
              i = a
                ? u.get(o("WAWebWidFactory").asUserWidOrThrow(n).toString())
                : null;
            h.push(
              o("WAWap").wap(
                "to",
      ...
      var S = o("WAWap").wap(
        ...
        R = null;
      if (y) {
        var L = await o("WAWebAdvSignatureApi").getADVEncodedIdentity();
