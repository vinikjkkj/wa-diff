__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    function f(e) {
      var t,
        n,
        a = o("react-compiler-runtime").c(86),
        i = e.chat,
      ...
      a[69] !== te || a[70] !== re || a[71] !== Pe
        ...
        : (Ne = a[72]);
      var Me;
      a[73] !== De || a[74] !== e.modeSelectorElement || a[75] !== Ne
        ? ((Me = u.jsxs(o("WAWebFlex.react").FlexRow, {
            align: "start",
            className: $e,
            children: [e.modeSelectorElement, De, Ne],
          })),
          (a[73] = De),
          (a[74] = e.modeSelectorElement),
          (a[75] = Ne),
          (a[76] = Me))
        : (Me = a[76]);
      var we;
      a[77] !== h || a[78] !== y || a[79] !== b
        ? ((we =
            y === !0
              ? u.jsx("div", {
      ...
      var Ae;
      return (
        a[81] !== Me || a[82] !== we || a[83] !== oe || a[84] !== se
