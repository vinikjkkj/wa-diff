__d(
  "WASmaxInGroupsPromoteDemoteAdminClientErrors",
  [
    "WAResultOrError",
  ...
  function (t, n, r, o, a, i, l) {
    function e(e) {
      ...
      var n = o(
        "WASmaxInGroupsIQErrorBlockedIntegrityEnforcementMixin",
      ).parseIQErrorBlockedIntegrityEnforcementMixin(e);
      if (n.success)
        return o("WAResultOrError").makeResult({
      ...
      return u.success
        ...
        : o("WASmaxParseUtils").errorMixinDisjunction(
            ...
            [
              ...
              "IQErrorBlockedIntegrityEnforcement",
              "IQErrorBadRequest",
              "IQErrorItemNotFound",
    ...
    l.parsePromoteDemoteAdminClientErrors = e;
  },
  98,
);
