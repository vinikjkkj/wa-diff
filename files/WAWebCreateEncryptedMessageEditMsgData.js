__d(
  ...
  function (t, n, r, o, a, i, l) {
    async function e(e, t) {
      ...
      var p = (n = e.editMsgType) != null ? n : o("WAWebMsgType").MSG_TYPE.CHAT,
      ...
      switch (p) {
        case o("WAWebMsgType").MSG_TYPE.CHAT: {
          var h,
            y = (h = e.body) != null ? h : "",
            C =
              e.matchedText != null || e.description != null || e.title != null;
          if (C) {
            var b, v, S;
            g = {
      ...
      var R = await o("WAWebAddonEncryption").encryptAddOn(g, {
          messageSecret: d,
          iv: u,
          stanzaId: t.id.id,
