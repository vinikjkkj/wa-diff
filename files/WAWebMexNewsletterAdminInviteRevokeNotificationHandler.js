    ...
    async function m(t, n) {
      ...
      if (p == null || m == null) {
        o("WALogger")
          ...
          .tags("mex", "newsletter")
          .sendLogs("newsletter-mex-admin-invite-revoke-null-actor-or-user");
        return;
      }
      ...
      if (
        (y === d.ACTOR
          ? (C = await o("WAWebLidMigrationDbUtils").getChatWidFromUserLid(g))
          : (C = await o("WAWebLidMigrationDbUtils").getChatWidFromUserLid(h)),
        C == null)
      ) {
        o("WALogger")
          .ERROR(
      ...
      (b.forEach(function (e) {
        ...
        await o("WAWebDBProcessMessage").updateExistingMessages(b, C),
