__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function m(e) {
      ...
      try {
        ...
        o("WALogger")
          ...
          .tags("messaging");
        var b = o("WAWebBackendJobsCommon").getMetricEditTypeFromMsg(n, a.data),
          v = await o("WAWebEncryptMsgProtobuf").encryptMsgProtobuf(
            i,
            p,
            f,
            a.data,
        ...
        if (R === o("WAWebBackendJobs.flow").CiphertextType.Pkmsg) {
          var E = await o("WAWebAdvSignatureApi").getADVEncodedIdentity();
          L = o("WAWap").wap("device-identity", null, E);
        }
        var k = o("WAWebBackendJobsCommon").mediaTypeFromProtobuf(n),
          I = await o("WAWebReportingTokenUtils").genReportingTokenBody(
            a.data,
            n,
          );
        ...
        var T = o("WAWap").wap(
          "message",
          {
            ...
            edit: o("WAWebSendMsgCommonApi").editAttribute(n, a.data.subtype),
          },
          C,
          o("WAWap").wap(
            "enc",
    ...
    l.createBroadcastDeviceMsgStanza = m;
  },
  98,
);
