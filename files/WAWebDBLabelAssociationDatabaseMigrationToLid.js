    ...
    async function b() {
      ...
      if (
        ...
        o("WALogger")
          ...
          .sendLogs("migrateLabelAssociationsDatabaseToLid-1-1-not-migrated");
        return;
      }
      var t = !1;
      (await o("WAWebModelStorageUtils")
        .getStorage()
        .lock(["label-association", "chat"], async function (e) {
          var n = e[0],
            a = e[1],
            i = n,
            l = a;
          try {
            ...
            (C.forEach(function (e, t) {
              ...
              (k.push(
                ...
                I.push(babelHelpers.extends({}, e, { associationId: n })));
            }),
              o("WALogger").LOG(
                p ||
              ...
              await i.bulkRemove(k),
              await i.bulkCreate(I));
            var T = await i.count();
            if (
              (o("WALogger").LOG(
                g ||
            ...
            throw (
              o("WALogger")
                ...
                .sendLogs("migrateLabelAssociationsDatabaseToLid-error"),
              r("getErrorSafe")(e)
            );
          }
        }),
