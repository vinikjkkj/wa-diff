  ...
  function (t, n, r, o, a, i, l) {
    ...
    var e,
      ...
      d = (function () {
        ...
        var t = e.prototype;
        return (
          (t.getPublicParameters = async function (t, n) {
            ...
            if (e == null)
              throw r("err")("WAWebACSServerProvider: config response is null");
            var a = e.xwa_wa_acs_config;
            return {
              configId: a.id,
          ...
          (t.getCredentials = async function (t) {
            var e,
              n,
              a = t.blindedTokens,
              i = t.config,
              ...
              s = t.requestProof;
            if (l == null)
              throw r("err")("WAWebACSServerProvider: missing project name");
            var u = a.map(function (e) {
                return { issue_data: o("WABase64").encodeB64UrlSafe(e) };
              }),
              d = await o("WAWebRelayClient").commitMutation(
                c,
                {
                  input: {
                    project_name: l,
            ...
            var _ = (e = m.creds) == null ? void 0 : e.evaluation;
            if (!Array.isArray(_))
              throw r("err")(
            ...
            if (C == null) return { signedBlindedTokens: f, dleqProofs: null };
            if (!Array.isArray(C))
              throw r("err")(
