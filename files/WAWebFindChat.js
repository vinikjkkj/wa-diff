  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function f(e, t, n) {
      ...
      if (!r("WAWebWid").isUser(a))
        return g(a, t, n).then(function (e) {
          var t = e.chat;
          return t;
        });
      var s = await _(a, l);
    ...
    async function g(t, n, a) {
      ...
      if (i.isRegularUser()) {
        if (
          ...
          (f == null &&
            ...
            await o("WAWebSyncContactJob").syncContactListJob([i], !0, "query"),
            (f = o("WAWebLidMigrationUtils").toUserLidOrThrow(i))),
            (l = await o(
              "WAWebMessageProcessUtils",
            ).selectChatForOneOnOneMessage({ lid: f })));
        } else if (i.isLid()) {
          var g = await _(l.chatId, a == null ? void 0 : a.getExistingChat);
          if (g == null) {
            o("WALogger").LOG(
              u ||
      ...
      var I = await o("WAWebCheckChatExistsOrCreate").checkChatExistsOrCreate({
          destinationChat: l,
          msgMeta: null,
          chatOriginType: n,
          initialProps: E,
    ...
    ((l.findExistingChat = f), (l.findOrCreateLatestChat = g));
  },
  98,
);
