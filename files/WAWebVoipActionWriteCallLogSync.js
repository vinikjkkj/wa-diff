  ...
  function (t, n, r, o, a, i, l) {
        ...
        o("WAWebCmd").Cmd.on(
          ...
          async function () {
            (o("WALogger").LOG(
              ...
              await o("WAPromiseEach").promiseEach(f, function (e, n) {
    ...
    async function C(e) {
      ...
      if (
        ...
        try {
          v = await o("WAWebCallLogUtils").getCallLogTargetDetails({
            callCreatorWid: S,
            callId: c,
        ...
        try {
          var x,
            ...
            P = {
              ...
              viewMode:
                l || a || h
                  ? o("WAWebViewMode.flow").ViewModeType.HISTORY_SYNCED_CALL_LOG
                  : D,
              callOutcome: o(
                "WAWebCallLogUtils",
          ...
          (a
            ...
            o("WALogger")
              .ERROR(
                _ || (_ = babelHelpers.taggedTemplateLiteralLoose(["", ""])),
                s.message,
              )
