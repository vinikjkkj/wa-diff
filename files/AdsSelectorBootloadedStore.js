  ...
  function (t, n, r, o, a, i, l) {
    ...
    var e,
      s = (function (t) {
        ...
        var o = n.prototype;
        return (
          (o.onLoadedSelector = function (t, n) {
            return this.__onLoadedModule(function (e) {
              return e(n);
            }, t);
          }),
          (o.loadSelectorPostDispatch = function (t) {
            this.__loadModulePostDispatch(t);
          }),
          (o.__reduce = function (n) {
            var t = this.__getModule().getValueEnforcing();
            ((e || (e = r("AdsDataAtom"))).waitFor(
              t.getStores().map(function (e) {
                return e.getDispatchToken();
              }),
            ),
              t.getStores().some(function (e) {
                return e.hasChanged();
              }) && this.__emitChange());
          }),
          (n.create = function (t) {
