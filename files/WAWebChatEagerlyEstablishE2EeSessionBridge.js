  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function m(t) {
      ...
      if (o("WAWebChatGetters").getIsGroup(t)) {
        ...
        var p = await o("WAWebSendMsgDatabaseJob").getFanOutListJob(
            [].concat(l.list, [m]),
            void 0,
            !0,
          ),
          _ = await r("WAWebUserPrefsStatus").getStatusSkDistribList(p),
          f = _.skDistribList;
        ((n = f),
          o("WALogger").LOG(
            s ||
        ...
        var g = o(
          ...
          C = t.id.isLid() ? h : y;
        n = await o("WAWebSendMsgDatabaseJob").getFanOutListJob([g, C]);
      }
      try {
        var b =
            t.id.isStatus() &&
          ...
          v = await o("WAWebManageE2ESessionsJob").ensureE2ESessions(n, !1, b);
