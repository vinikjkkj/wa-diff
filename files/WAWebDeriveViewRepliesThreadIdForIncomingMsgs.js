  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function u(t) {
      if (t.length !== 0) {
        ...
        for (var a of t)
          if (
            o("WAWebThreadMsgUtils").getMsgViewAllRepliesThread(a) == null &&
        ...
        if (
          ...
          var l = await o("WAWebDBMsgUtils").getMsgsByMsgKey(Array.from(r)),
            u = new Map(
              l.map(function (e) {
          ...
          if (m.size !== 0) {
            ...
            for (
              var f = Array.from(m.keys()),
                ...
                b = async function () {
                  var e,
                    ...
                    r = m.get(n),
                    a = h[v];
                  if (r == null || a == null || a.internalId == null) return 1;
                  var i = o("WAWebDBMessageUtils").getInChatMsgId(a.internalId),
                    l = o("WAWebDBMessageUtils").craftInternalThreadId(i, r),
              ...
              await b();
            (y.length > 0 && (await g.bulkCreateOrMerge(y)),
              C.length > 0 &&
                (await o(
                  "WAWebDBThreadMetadataBulkHelper",
