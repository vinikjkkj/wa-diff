__d(
  ...
  function (t, n, r, o, a, i, l, s) {
    ...
    async function m(e, t, n) {
      ...
      if (
        ...
        var a = await o(
          ...
          i =
            e.target instanceof HTMLAnchorElement && e.target ? e.target : null,
          l = o("WAWebMmSignalSharingModelUtils").getBodyLinkForMmSignalSharing(
            {
              chat: t,
              msg: n.unsafe(),
    ...
    ((l.getMmSignalSharingLearnMoreHCAURL = c),
      ...
      (l.openMmSignalSharingDisclosureModal = p));
  },
  226,
);
