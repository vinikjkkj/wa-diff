__d(
  ...
  function (t, n, r, o, a, i, l) {
          ...
          (a.initialize = (function () {
            var e = n("asyncToGeneratorRuntime").asyncToGenerator(function* () {
              var e = this.device,
                ...
                l = e.createShaderModule({ code: h(this.useYPacking) });
                    ...
                    function* () {
                      ...
                      try {
                        ...
                        var h = 16,
                          y = Math.ceil(i / h),
                          C = Math.ceil(l / h);
                        (_.dispatchWorkgroups(y, C), _.end());
                        var b = 4,
                          v = t.useYPacking
                            ? t.yPackedWidth * l * b
                            : i * l * b,
                          S = t.useUVPacking
                            ? t.uvPackedWidth * (l / 2) * b
                            : (i / 2) * (l / 2) * 2 * b,
                          R = v + S;
                        if (
                          (m.copyBufferToBuffer(c, 0, d, 0, R),
                        ...
                        try {
                          if (t.useYPacking && t.useUVPacking) {
                            var L = d.getMappedRange();
                            (t.nv12Data.set(new Uint8Array(L)), d.unmap());
                          } else {
                            for (
                              var E = new Uint32Array(d.getMappedRange()),
                                k = v / b,
                                I = 0;
                              I < t.yData.length;
                              I++
                              ...
                              t.yData[I] = E[I] & 255;
                            for (var T = 0; T < t.uvData.length; T++)
                              t.uvData[T] = E[k + T] & 255;
                            d.unmap();
                            var D = i * l;
                            (t.nv12Data.set(t.yData, 0),
                              t.nv12Data.set(t.uvData, D));
                          }
                        } catch (e) {
          ...
          (r.createConverter = (function () {
            var e = n("asyncToGeneratorRuntime").asyncToGenerator(
              function* (e, t) {
                ...
                return n != null ? n : yield y.create(e, t);
              },
            );
            function t(t, n) {
              return e.apply(this, arguments);
    ...
    ((l.WebGPUVideoConverter = y), (l.WAWebVoipVideoCaptureWebGPU = C));
  },
  98,
);
