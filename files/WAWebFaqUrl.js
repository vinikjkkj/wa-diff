__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    ((l.FAQ_BASE_URL = e),
      ...
      (l.getDefenseModeFaqUrl = W),
      (l.getCatalogCartOnOffFaqUrl = q),
      (l.getCommunityHomeNuxUrl = U),
      (l.getExitCommunityUrl = V),
      (l.getCommunityCreatorPrivacyUrl = H),
      (l.getCommunityMemberPrivacyUrl = G),
      (l.getCommunityBecomingOwnerUrl = z),
      (l.getLinkDeviceFaqUrl = j),
      (l.getDBErrorFaqUrl = K),
      (l.getHowToExitAndDeleteGroupsFaq = Q),
      (l.getGroupMemberUpdatesUsernameFaqUrl = X),
      (l.getUsernameFaqUrl = Y),
      (l.getUsernameKeyFaqUrl = J),
      ...
      (l.getNewsletterAiContentFaqUrl = se),
      (l.getNewsletterGeosuspendFaqUrl = ue),
      (l.getNewsletterMetricsEstimatedFaqUrl = ce),
      (l.getNewsletterMetricsUnavailableFaqUrl = de),
      (l.getMemberAddedGroupsUrl = me),
      (l.getReportToAdminFaqUrl = pe),
      (l.getOrderEphemeralExemptionUrl = _e),
      (l.getSafetyToolsFaqUrl = fe),
      (l.getSearchTheWebFaqUrl = ge),
      (l.getScreenLockLearnMoreUrl = he),
      (l.getMessageHistoryOnLinkedDevicesFAQUrl = ye),
      (l.getRequestAccountInfoFAQUrl = Ce),
      (l.getIndiaEcommerceComplianceFaqUrl = be),
      (l.getBotPrivacyPolicyUrl = ve),
      (l.getMetaGenAiGuideUrl = Se),
      (l.getBotTermsUrl = Re),
      (l.getWhatsappPrivacyPolicyBrazilUrl = Le),
      (l.getWhatsappBrazilBizBotRightsUrl = Ee),
      (l.getWhatsappBrazilBizBotObjectUrl = ke),
      (l.getWhatsappBusinessAppPrivacyPolicyUrl = Ie),
      (l.getBotLearnMoreUrl = Te),
      (l.getBizBot1pLearnMoreUrl = De),
      (l.getBizAiOnboardingHandoffFaqUrl = xe),
      (l.getBizBotTosLearnMoreUrl = $e),
      ...
      (l.getCallLinksFaqUrl = Ue),
      (l.getDisableLinkPreviewsFaqUrl = Ve),
      (l.getChatLockSecretCodeFaqUrl = He),
      (l.getAccountTakeOverFaqUrl = Ge),
      (l.getNativeContactLearnMoreFaqUrl = ze),
      (l.getAntiBrigadingFaqUrl = je),
      (l.getProtectIpInCallsFaqUrl = Ke),
      (l.getEventsAboutSafetyFaqUrl = Qe),
      (l.getEventsLearnMoreFaqUrl = Xe),
      (l.getEventsFindAndRespondFaqUrl = Ye),
      (l.getEventSuspensionFaqUrl = Je),
      (l.getCommunityGroupsVisibilityFaqUrl = Ze),
      (l.getBizQuickRepliesFaqUrl = et),
      (l.marketingMessageFeedbackLearnMoreURL = tt),
      (l.marketingMessageUserControlsStopLearnMoreURL = nt),
      (l.marketingMessageUserControlsResumeLearnMoreURL = rt),
      (l.sharingCustomerRelatedActivityLearnMoreURL = ot),
      (l.getNewsletterReportLearnMoreUrl = at),
      (l.getSeeExamplesOfScamsUrl = it),
      (l.getHowToReport = lt),
      (l.getEnterPnFaqUrl = st),
      (l.getWhatsappUsePhoneFallbackUrl = ut),
      (l.getWhatsappBusinessCommercePolicyUrl = ct),
      (l.getRestrictedAccountLearnMoreUrl = dt),
      (l.getWhatsAppBusinessPolicyUrl = mt),
      (l.getWhatsAppBusinessHomeUrl = pt),
      (l.getMessagingBestPracticeUrl = _t),
      (l.getSMBLinkedCatalogUrl = ft),
      (l.getGuestFAQUrl = gt),
      (l.getGuestUsernameReservationFAQUrl = ht),
      (l.getSMBIndividualNewChatMessageCappingHCAUrl = yt),
      (l.getConsumerIndividualNewChatMessageCappingHCAUrl = Ct),
      (l.getNewsletterQuestionResponsePrivacyBannerFAQUrl = bt),
      (l.getNewsletterAdminProfilesFAQUrl = vt),
