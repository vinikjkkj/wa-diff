      ...
      s = (e = o("WAWebWamCodegenUtils")).defineEvents(
        {
          LidMigrationDaily: [
            5842,
            {
              ...
              numberOfCagGroups: [15, e.TYPES.INTEGER],
              numberOfCagLidGroups: [16, e.TYPES.INTEGER],
              ...
              numberOfLidOnlyGroups: [17, e.TYPES.INTEGER],
              numberOfMixedPnLidGroups: [18, e.TYPES.INTEGER],
