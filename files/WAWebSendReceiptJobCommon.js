                    ...
                    I = function () {
                      ...
                      var c = l == null ? void 0 : l.key.id,
                        f =
                          c != null
                            ? o("WAWap").wap("bot", {
                                client_thread_id: o("WAWap").CUSTOM_STRING(c),
                              })
                            : null,
                        C = o("WAWap").wap(
                          "receipt",
                          {
                            ...
                            type: g === d.DELIVERY ? o("WAWap").DROP_ATTR : g,
                            class:
                              r != null
                      ...
                      if (h) {
                            ...
                            function* () {
                              ...
                              if (g === d.READ || g === d.READ_SELF) {
                                ...
                                return o(
                                  ...
                                  C,
                                  o("WAWebCommsAckParser").toCoreAckTemplate(t),
                                );
                            },
                          );
                          return function () {
                        ...
                        k.push(o("WADeprecatedSendIq").deprecatedCastStanza(C));
                    };
                  _.length > 0;
                )
                  I();
                return (c || (c = n("Promise"))).all(k);
              }
            }),
          );
        })),
