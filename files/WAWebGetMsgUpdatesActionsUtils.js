      ...
      (await Promise.all(
        n.map(async function (n) {
          ...
          if (
            ...
            var ee = ["t", "id", "from", "to"],
              te = c.t ? r("lodash").omit(n, ee) : n,
              ne = c.applyUpdate(te).then(function () {
                return c;
              });
            if ((E.push(ne), r("WAWebWid").isBroadcast(c.id.remote))) {
              var re = o("WAWebMsgModelUtils").getBroadcastFanoutKeys(c);
              re &&
            ...
            var ae =
              (oe = o("WAWebChatCollection").ChatCollection.get(n.id.remote)) !=
              null
                ? oe
            ...
            if (
              ...
              j.push(
                "msgId=" +
                  n.id.toString() +
                  " chatId=" +
                  ((ie = ae == null ? void 0 : ae.id.toString()) != null
                    ? ie
                    : "unknown"),
              );
            }
