    ...
    async function h(t) {
      ...
      try {
        ...
        if (
          ...
          return;
        var i = await ((n = window.navigator.serviceWorker) == null
          ? void 0
          : n.ready);
        if (!("periodicSync" in (i != null ? i : []))) return;
        var l = i == null ? void 0 : i.periodicSync;
        if (!l) return;
        var h = await (l.getTags == null ? void 0 : l.getTags());
        if (!h) return;
        var y = await ((a = window.navigator.permissions) == null ||
        a.query == null
          ? void 0
        ...
        if (!t && C)
          if (
            ...
            var b = await (l.getTags == null ? void 0 : l.getTags());
          ...
          (o("WALogger").LOG(
            ...
            await (l.unregister == null ? void 0 : l.unregister(g)));
          var v = await (l.getTags == null ? void 0 : l.getTags());
