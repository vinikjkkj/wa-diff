__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function m(t) {
      ...
      o("WALogger").LOG(
        e ||
          (e = babelHelpers.taggedTemplateLiteralLoose(["mmsUpload: start"])),
      );
      try {
        var b =
            ...
            h === o("WAWebMmsMediaTypes").MEDIA_TYPES.NATIVE_AD_VIDEO
              ...
              : h === o("WAWebMmsMediaTypes").MEDIA_TYPES.BIZ_COVER_PHOTO
                ? c
                : u,
          v = await o("WAWebHttpExtendedFetch")
            .extendedFetch(y, {
              method: "post",
              body: i,
              signal: g,
            ...
            .then(function (e) {
              if (!e.ok)
                switch (e.status) {
                  case 401:
                    throw new (o("WAWebMmsClientErrors").MMSUnauthorizedError)(
                      "mmsUpload",
                      { url: y },
                    );
                  case 413:
                    throw new (o("WAWebMmsClientErrors").MediaTooLargeError)(
                      "mmsUpload",
                      { url: y },
                    );
                  case 415:
