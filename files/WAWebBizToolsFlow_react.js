    ...
    function k(e) {
      ...
      switch (I) {
        ...
        case o("WAWebBizToolsFlowSteps").BizToolsSteps.Labels:
          ...
          break;
        case o("WAWebBizToolsFlowSteps").BizToolsSteps.BusinessAI:
          A = m.jsx(r("WAWebBizAIDrawer.react"), {
            onBack: D,
            isInitialStep: !1,
          });
          break;
              ...
              children: [
                ...
                o("WAWebBizAiAgentStatusUtils").hasOnboardedAiAgent()
                  ? m.jsx(o("WAWebDrawerButton.react").DrawerButtonSimple, {
                      ...
                      theme: "biz-tools",
                      divider: !1,
                      icon: m.jsx(r("WDSIconWdsIcAi.react"), {
                        iconXstyle: y.icon,
                      }),
                      active: !1,
                      secondaryChildren: s._(
                        /*BTDS*/ "Fast replies to customers 24\/7",
                      ),
                      onClick: function () {
                        return f(
                          o("WAWebBizToolsFlowSteps").BizToolsSteps.BusinessAI,
                        );
                      },
                      children: s._(/*BTDS*/ "Business AI"),
                    })
                  : null,
                p
                  ? m.jsx(o("WAWebDrawerButton.react").DrawerButtonSimple, {
