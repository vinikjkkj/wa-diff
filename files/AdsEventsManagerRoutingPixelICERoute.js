__d(
  ...
  function (t, n, r, o, a, i) {
    ...
    ((e.routeName = "AdsEventsManagerRoutingPixelICERoute"),
      (e.configName = "AdsEventsManagerRouting"),
      (e.configPath = n("immutable").List(["pixel"])),
      (e.givenName = "pixel"),
      (e.path = "/events_manager2/list/pixel/{dataSourceID}"),
      (e.paramDefinitions = {
        dataSourceID: {
          type: "String",
          flowType: "FBID",
      ...
      (e.forceLoad = !1),
      (e.redirect = ["AdsEventsManagerRouting", ["pixel_overview"]]),
      (e.viewModuleName = "AdsEventsManagerPixelInspectorContainer.react"),
      (a.exports = e));
  },
  null,
);
