    ...
    async function u(
      ...
      if (
        ((M = babelHelpers.extends({}, M, {
          ...
          macFatalSenderCurrentLthashToLocalCalculatedCurrentLthashMismatch: h,
        ...
        var F = await o("WAWebUserPrefsMultiDevice").getRecentMailboxAgeDays(),
          O = await o(
            "WAWebUserPrefsAppStateSync",
        ...
        M = babelHelpers.extends({}, M, {
          ...
          daysSinceLastPeriodicSync:
            O == null
              ? void 0
              : Math.trunc((o("WATimeUtils").unixTime() - O) / 60 / 60 / 24),
          hoursSinceFirstFiniteFailure:
            B == null
              ? void 0
              : Math.trunc((o("WATimeUtils").unixTimeMs() - B) / 1e3 / 60 / 60),
        });
        var W = await o("WAWebSchemaSyncActions")
            .getSyncActionsTable()
            .get('["primary_version","current"]'),
          q = await o("WAWebSchemaSyncActions")
            .getSyncActionsTable()
