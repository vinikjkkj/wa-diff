__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function L(e, t) {
      ...
      var b,
        v = o("WAWebProtobufsE2E.pb").Message$ExtendedTextMessage$PreviewType
          .NONE,
        S = null,
      ...
      if (L.resultType === o("WAWebApi").APICmd.CATALOG)
        ...
        var D = await o("WAWebLinkPreviewGroupUtils").getGroupInviteLinkPreview(
          e.url,
          L.data.code,
        );
        D && (b = D);
      ...
      if ((R == null ? void 0 : R.linksPreview) != null && S == null) {
        var x = await R.linksPreview.getPreviewAsync(e.url);
        if (x != null) {
          var $,
            P = ($ = x.thumbnail) != null ? $ : "",
            N = { thumbnail: P };
          if (
            ((b = o("WAWebLinkPreviewUtils").genLinkPreview({
              ...
              linkDetails: {
                ...
                richPreviewType: E(x.previewType, L),
                doNotPlayInline: !1,
                isLoading: !1,
              },
            })),
      ...
      var w = await r("WAWebMsgKey").newId(),
        A = o(
          "WAWebNonMessageDataRequestHandlerGenLinkPreview",
      ...
      try {
        ...
        var W = await o("WAPromiseTimeout").promiseTimeout(
          A.promise,
        ...
        (o("WALogger").LOG(
          ...
          (W == null || (O = W.linkPreviewResponse) == null ? void 0 : O.url) !=
            null &&
        ...
        if (q) {
          if (
            ...
            return (
              k(W == null ? void 0 : W.mediaUploadResult, F),
              o("WAWebGenMinimalLinkPreviewChatAction").genMinimalLinkPreview(
                e,
                v,
                !1,
                { psp: S, previewMetadata: q.previewMetadata },
              )
            );
        } else {
          T(
        ...
        var V =
            L.resultType === o("WAWebApi").APICmd.GROUP_INVITE
              ? o("WAWebLinkPreviewGroupUtils").GROUP_INVITE_DEFAULT_DESCRIPTION
              : q.description,
          H = await I({
        ...
        return (
          (b = o("WAWebLinkPreviewUtils").genLinkPreview({
            ...
            linkDetails: {
              title: q.title,
              description: V,
              richPreviewType: E(q.previewType, L),
              doNotPlayInline: !1,
              isLoading: !1,
            },
            linkThumbnail: H,
            paymentLinkDetails: { psp: S, previewMetadata: q.previewMetadata },
          })),
          C.set(e.url, b),
          b
        );
        ...
        try {
          ...
          d != null && m != null && f != null && p != null && _ != null
            ? (o("WALogger").LOG(
              ...
              (i = await o("WAWebLinkPreviewUtils").getThumbnailDetails({
