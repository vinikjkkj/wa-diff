  ...
  function (t, n, r, o, a, i, l) {
    async function e(e, t) {
      ...
      var _ = {
            ...
            protocolMessage: {
              ...
              editedMessage: {
                eventMessage: {
                  ...
                  description: (i = e.eventDescription) != null ? i : void 0,
        ...
        f = await o("WAWebAddonEncryption").encryptAddOn(_, {
          messageSecret: m,
          iv: c,
          stanzaId: t.id.id,
      ...
      return babelHelpers.extends(
        ...
        ),
        {
          ...
          t: Math.floor(r("WANullthrows")(e.latestEditSenderTimestampMs) / 1e3),
