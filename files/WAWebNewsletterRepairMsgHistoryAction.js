          ...
          if (
            ...
            if (!(u == null || u.serverId == null)) {
              ...
              try {
                var d;
                if (
                  (r("WARaceSignal")([c.signal, e.unmountSignal], function () {
                ...
                a.repairMsgHistoryPromise = o("WAWebNewsletterMsgHistoryUtils")
                  .fillMsgHistoryGaps({
                    jid: o(
                      "WAWebNewsletterValidationUtils",
                ...
                var _ =
                  (d = await n.msgs.repairMsgHistoryPromise) != null ? d : [];
