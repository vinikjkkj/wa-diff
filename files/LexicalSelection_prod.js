  ...
  function $module_LexicalSelection_prod(
    ...
    function h(n, o, r, i, s) {
      ...
      var l = o[0],
        c = new Map(),
        d = [],
        f = require("Lexical").$isElementNode(l) ? l : l.getParentOrThrow();
    ...
    ((exports.$cloneWithProperties = require("Lexical").$cloneWithProperties),
      ...
      (exports.$forEachSelectedTextNode = a),
      ...
      (exports.$getSelectionStyleValueForProperty = function (t, n, o) {
        ...
        if (require("Lexical").$isRangeSelection(t)) {
          ...
          var _o6 = t.anchor,
            ...
            _d2 = _i3 ? _o6.getNode() : _r4.getNode(),
            _f2 = _i3 ? _r4.offset : _o6.offset,
      ...
      (exports.$setBlocksType = function (t, n, o) {
        ...
        if (r) {
          ...
          ((i =
            ...
            })(_o7, s, require("Lexical").flipDirection(_d3))),
        ...
        if (
          ...
          if (_f3 || _a2) {
            var _e$$getCharacterOffse =
              ...
              _s5 = _c4.is(_d4),
              _f4 = n.is(_l2 ? _d4 : _c4),
              _a3 = n.is(_l2 ? _c4 : _d4);
            var _g,
              _u = 0;
            _s5
      ...
      (exports.createDOMRange = function (t, n, i, s, l) {
        ...
        if (
          ...
          require("Lexical").$isTextNode(s) && (g = o(g)),
          void 0 === n || void 0 === s || null === a || null === g)
        )
          return null;
        ("BR" === a.nodeName && ((_r1 = r(a)), (a = _r1[0]), (u = _r1[1]), _r1),
          "BR" === g.nodeName &&
            ((_r10 = r(g)), (g = _r10[0]), (p = _r10[1]), _r10));
        var $ = a.firstChild;
        a === g &&
          null != $ &&
          "BR" === $.nodeName &&
