    ...
    function s() {
      (function (e) {
        ...
        function S(e, t, n, r, o, a, i) {
          ...
          for (c = 0; c < 8; c++) l[c] = a[c];
          for (; o >= 64; ) {
            for (C(s, l, i, v), c = 0; c < 64; c++) e[t + c] = n[r + c] ^ s[c];
            for (u = 1, c = 8; c < 16; c++)
              ((u = (u + (l[c] & 255)) | 0), (l[c] = u & 255), (u >>>= 8));
            ((o -= 64), (t += 64), (r += 64));
          }
          if (o > 0)
            for (C(s, l, i, v), c = 0; c < o; c++) e[t + c] = n[r + c] ^ s[c];
          return 0;
        }
        function R(e, t, n, r, o) {
          ...
          for (; n >= 64; ) {
            for (C(i, a, o, v), s = 0; s < 64; s++) e[t + s] = i[s];
            for (l = 1, s = 8; s < 16; s++)
              ((l = (l + (a[s] & 255)) | 0), (a[s] = l & 255), (l >>>= 8));
            ((n -= 64), (t += 64));
          }
          if (n > 0) for (C(i, a, o, v), s = 0; s < n; s++) e[t + s] = i[s];
          return 0;
        }
        ...
        var k = function (t) {
          ...
          ((e = (t[0] & 255) | ((t[1] & 255) << 8)),
            (this.r[0] = e & 8191),
            (n = (t[2] & 255) | ((t[3] & 255) << 8)),
            (this.r[1] = ((e >>> 13) | (n << 3)) & 8191),
            (r = (t[4] & 255) | ((t[5] & 255) << 8)),
            (this.r[2] = ((n >>> 10) | (r << 6)) & 7939),
            (o = (t[6] & 255) | ((t[7] & 255) << 8)),
            (this.r[3] = ((r >>> 7) | (o << 9)) & 8191),
            (a = (t[8] & 255) | ((t[9] & 255) << 8)),
            (this.r[4] = ((o >>> 4) | (a << 12)) & 255),
            (this.r[5] = (a >>> 1) & 8190),
            (i = (t[10] & 255) | ((t[11] & 255) << 8)),
            (this.r[6] = ((a >>> 14) | (i << 2)) & 8191),
            (l = (t[12] & 255) | ((t[13] & 255) << 8)),
            (this.r[7] = ((i >>> 11) | (l << 5)) & 8065),
            (s = (t[14] & 255) | ((t[15] & 255) << 8)),
            (this.r[8] = ((l >>> 8) | (s << 8)) & 8191),
            (this.r[9] = (s >>> 5) & 127),
            (this.pad[0] = (t[16] & 255) | ((t[17] & 255) << 8)),
            (this.pad[1] = (t[18] & 255) | ((t[19] & 255) << 8)),
            (this.pad[2] = (t[20] & 255) | ((t[21] & 255) << 8)),
            (this.pad[3] = (t[22] & 255) | ((t[23] & 255) << 8)),
            (this.pad[4] = (t[24] & 255) | ((t[25] & 255) << 8)),
            (this.pad[5] = (t[26] & 255) | ((t[27] & 255) << 8)),
            (this.pad[6] = (t[28] & 255) | ((t[29] & 255) << 8)),
            (this.pad[7] = (t[30] & 255) | ((t[31] & 255) << 8)));
        };
        ((k.prototype.blocks = function (e, t, n) {
          for (
            var r = this.fin ? 0 : 2048,
              o,
              a,
              i,
              l,
            ...
            ((o = (e[t + 0] & 255) | ((e[t + 1] & 255) << 8)),
              (R += o & 8191),
              (a = (e[t + 2] & 255) | ((e[t + 3] & 255) << 8)),
              (L += ((o >>> 13) | (a << 3)) & 8191),
              (i = (e[t + 4] & 255) | ((e[t + 5] & 255) << 8)),
              (E += ((a >>> 10) | (i << 6)) & 8191),
              (l = (e[t + 6] & 255) | ((e[t + 7] & 255) << 8)),
              (k += ((i >>> 7) | (l << 9)) & 8191),
              (s = (e[t + 8] & 255) | ((e[t + 9] & 255) << 8)),
              (I += ((l >>> 4) | (s << 12)) & 8191),
              (T += (s >>> 1) & 8191),
              (u = (e[t + 10] & 255) | ((e[t + 11] & 255) << 8)),
              (D += ((s >>> 14) | (u << 2)) & 8191),
              (c = (e[t + 12] & 255) | ((e[t + 13] & 255) << 8)),
              (x += ((u >>> 11) | (c << 5)) & 8191),
              (d = (e[t + 14] & 255) | ((e[t + 15] & 255) << 8)),
              ($ += ((c >>> 8) | (d << 8)) & 8191),
              (P += (d >>> 5) | r),
              (m = 0),
              (p = m),
          ...
          (k.prototype.finish = function (e, t) {
            ...
            for (
              ...
              ((n[i] = this.h[i] + r), (r = n[i] >>> 13), (n[i] &= 8191));
            for (n[9] -= 8192, o = (r ^ 1) - 1, i = 0; i < 10; i++) n[i] &= o;
            for (o = ~o, i = 0; i < 10; i++) this.h[i] = (this.h[i] & o) | n[i];
            for (
          ...
          (k.prototype.update = function (e, t, n) {
            var r, o;
            if (this.leftover) {
              for (o = 16 - this.leftover, o > n && (o = n), r = 0; r < o; r++)
                this.buffer[this.leftover + r] = e[t + r];
              if (
                ((n -= o), (t += o), (this.leftover += o), this.leftover < 16)
              )
                return;
            ...
            if (
              (n >= 16 &&
                ((o = n - (n % 16)), this.blocks(e, t, o), (t += o), (n -= o)),
              n)
            ) {
        ...
        function T(e, t, n, r, o, a) {
          ...
          return (I(i, 0, n, r, o, a), f(e, t, i, 0));
        }
        function D(e, t, n, r, o) {
          var a;
          if (n < 32) return -1;
          for (
            E(e, 0, t, 0, n, r, o), I(e, 16, e, 32, n - 32, e), a = 0;
            a < 16;
            a++
          )
            e[a] = 0;
        ...
        function x(e, t, n, r, o) {
          var a,
            i = new Uint8Array(32);
          if (n < 32 || (L(i, 0, 32, r, o), T(t, 16, t, 32, n - 32, i) !== 0))
            return -1;
          for (E(e, 0, t, 0, n, r, o), a = 0; a < 32; a++) e[a] = 0;
          return 0;
        }
        function $(e, t) {
          var n;
        ...
        function M(e, n) {
          ...
          for (P(l), P(l), P(l), o = 0; o < 2; o++) {
            for (i[0] = l[0] - 65517, r = 1; r < 15; r++)
              ((i[r] = l[r] - 65535 - ((i[r - 1] >> 16) & 1)),
                (i[r - 1] &= 65535));
          ...
          for (r = 0; r < 16; r++)
            ((e[2 * r] = l[r] & 255), (e[2 * r + 1] = l[r] >> 8));
        }
        function w(e, t) {
          var n = new Uint8Array(32),
            r = new Uint8Array(32);
          return (M(n, e), M(r, t), g(n, 0, r, 0));
        }
        function A(e) {
        ...
        function V(e, n) {
          var r = t(),
            o;
          for (o = 0; o < 16; o++) r[o] = n[o];
          for (o = 250; o >= 0; o--) (q(r, r), o !== 1 && W(r, r, n));
          for (o = 0; o < 16; o++) e[o] = r[o];
        }
        function H(e, n, r) {
          ...
          for (
            o[31] = (n[31] & 127) | 64, o[0] &= 248, F(a, r), s = 0;
            s < 16;
            s++
          )
            ((c[s] = a[s]), (m[s] = u[s] = d[s] = 0));
          for (u[0] = m[0] = 1, s = 254; s >= 0; --s)
            ((i = (o[s >>> 3] >>> (s & 7)) & 1),
              N(u, c, i),
              N(d, m, i),
              O(p, u, d),
        ...
        function j(e, t, n) {
          var o = new Uint8Array(32);
          return (H(o, n, t), b(e, r, o, v));
        }
        var K = D,
          Q = x;
        function X(e, t, n, r, o, a) {
          var i = new Uint8Array(32);
          return (j(i, o, a), K(e, t, n, r, i));
        }
        function Y(e, t, n, r, o, a) {
          var i = new Uint8Array(32);
          return (j(i, o, a), Q(e, t, n, r, i));
        }
        var J = [
        ...
        function ae(e, n) {
          var r = [t(), t(), t(), t()];
          ($(r[0], c), $(r[1], d), $(r[2], i), W(r[3], c, d), oe(e, r, n));
        }
        function ie(e, r, o) {
        ...
        function ce(e, n, r, o) {
          var a = new Uint8Array(64),
            ...
            d = [t(), t(), t(), t()];
          (ee(a, o, 32), (a[0] &= 248), (a[31] &= 127), (a[31] |= 64));
          var m = r + 64;
          for (s = 0; s < r; s++) e[64 + s] = n[s];
          for (s = 0; s < 32; s++) e[32 + s] = a[32 + s];
          for (
            ee(l, e.subarray(32), r + 32), ue(l), ae(d, l), re(e, d), s = 32;
            s < 64;
            s++
          )
            e[s] = o[s];
          for (ee(i, e, r + 64), ue(i), s = 0; s < 64; s++) c[s] = 0;
          for (s = 0; s < 32; s++) c[s] = l[s];
          for (s = 0; s < 32; s++)
            for (u = 0; u < 32; u++) c[s + u] += i[s] * a[u];
          return (se(e.subarray(32), c), m);
        }
        function de(e, n) {
          var r = t(),
            o = t(),
        ...
        e.lowlevel = {
          ...
          crypto_scalarmult_BYTES: he,
          crypto_scalarmult_SCALARBYTES: ye,
          crypto_box_PUBLICKEYBYTES: Ce,
          crypto_box_SECRETKEYBYTES: be,
          crypto_box_BEFORENMBYTES: ve,
          crypto_box_NONCEBYTES: Se,
          crypto_box_ZEROBYTES: Re,
          crypto_box_BOXZEROBYTES: Le,
          crypto_sign_BYTES: Ee,
          crypto_sign_PUBLICKEYBYTES: ke,
          crypto_sign_SECRETKEYBYTES: Ie,
          crypto_sign_SEEDBYTES: Te,
          crypto_hash_BYTES: De,
        };
        function xe(e, t) {
        ...
        ((e.randomBytes = function (e) {
          ...
          (e.secretbox = function (e, t, n) {
            ...
            for (
              ...
              r[a + fe] = e[a];
            return (D(o, r, r.length, t, n), o.subarray(ge));
          }),
          (e.secretbox.open = function (e, t, n) {
            (Pe(e, t, n), xe(n, t));
            for (
              var r = new Uint8Array(ge + e.length),
                o = new Uint8Array(r.length),
                a = 0;
              a < e.length;
              a++
              ...
              r[a + ge] = e[a];
            return r.length < 32 || x(o, r, r.length, t, n) !== 0
              ? null
              : o.subarray(fe);
          }),
          ...
          (e.scalarMult = function (e, t) {
            if ((Pe(e, t), e.length !== ye)) throw new Error("bad n size");
            if (t.length !== he) throw new Error("bad p size");
            var n = new Uint8Array(he);
            return (H(n, e, t), n);
          }),
          (e.scalarMult.base = function (e) {
            if ((Pe(e), e.length !== ye)) throw new Error("bad n size");
            var t = new Uint8Array(he);
            return (G(t, e), t);
          }),
          (e.scalarMult.scalarLength = ye),
          (e.scalarMult.groupElementLength = he),
          ...
          (e.box.publicKeyLength = Ce),
          (e.box.secretKeyLength = be),
          (e.box.sharedKeyLength = ve),
          (e.box.nonceLength = Se),
          (e.box.overheadLength = e.secretbox.overheadLength),
          (e.sign = function (e, t) {
            if ((Pe(e, t), t.length !== Ie))
              throw new Error("bad secret key size");
            var n = new Uint8Array(Ee + e.length);
            return (ce(n, e, e.length, t), n);
          }),
          (e.sign.open = function (e, t) {
            if ((Pe(e, t), t.length !== ke))
              throw new Error("bad public key size");
            var n = new Uint8Array(e.length),
              r = me(n, e, e.length, t);
            if (r < 0) return null;
            for (var o = new Uint8Array(r), a = 0; a < o.length; a++)
              o[a] = n[a];
            return o;
          }),
          (e.sign.detached = function (t, n) {
            for (
              var r = e.sign(t, n), o = new Uint8Array(Ee), a = 0;
              a < o.length;
              a++
            )
              o[a] = r[a];
          ...
          (e.sign.detached.verify = function (e, t, n) {
            if ((Pe(e, t, n), t.length !== Ee))
              throw new Error("bad signature size");
            if (n.length !== ke) throw new Error("bad public key size");
            var r = new Uint8Array(Ee + e.length),
              o = new Uint8Array(Ee + e.length),
              a;
            for (a = 0; a < Ee; a++) r[a] = t[a];
            for (a = 0; a < e.length; a++) r[a + Ee] = e[a];
            return me(o, r, r.length, n) >= 0;
          }),
          ...
          (e.sign.keyPair.fromSecretKey = function (e) {
            if ((Pe(e), e.length !== Ie))
              throw new Error("bad secret key size");
            for (var t = new Uint8Array(ke), n = 0; n < t.length; n++)
              t[n] = e[32 + n];
            return { publicKey: t, secretKey: new Uint8Array(e) };
          }),
          (e.sign.keyPair.fromSeed = function (e) {
            if ((Pe(e), e.length !== Te)) throw new Error("bad seed size");
            for (
              var t = new Uint8Array(ke), n = new Uint8Array(Ie), r = 0;
              r < 32;
              r++
            )
              n[r] = e[r];
            return (ie(t, n, !0), { publicKey: t, secretKey: n });
          }),
          (e.sign.publicKeyLength = ke),
          (e.sign.secretKeyLength = Ie),
          (e.sign.seedLength = Te),
          (e.sign.signatureLength = Ee),
          (e.hash = function (e) {
            Pe(e);
            var t = new Uint8Array(De);
            return (ee(t, e, e.length), t);
          }),
          (e.hash.hashLength = De),
          (e.verify = function (e, t) {
            return (
              Pe(e, t),
              e.length === 0 || t.length === 0 || e.length !== t.length
                ? !1
                : _(e, 0, t, 0, e.length) === 0
            );
          }),
