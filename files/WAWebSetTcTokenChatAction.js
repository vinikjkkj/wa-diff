    ...
    async function s(t, n, r, a) {
      if (a != null && t.isRegularUser()) {
        var i = n != null ? n : o("WAWebLidMigrationUtils").toLid(t),
          l = i
            ? await o("WAWebChatCollection").ChatCollection.getChatByAccountLid(
                i,
              )
            : null;
        if (
          (l == null &&
            (l = await o("WAWebChatGetExistingBridge").getExisting(t)),
          l == null)
        ) {
          await o("WAWebApiOrphanTcToken").createOrUpdateOrphanTcToken(
            i != null ? i : t,
        ...
        if (
          !(
            (l.tcToken != null &&
              o("WAArrayBufferUtils").arrayBuffersEqualUNSAFE(l.tcToken, a)) ||
            (l.tcTokenTimestamp != null && l.tcTokenTimestamp > r)
          )
        ) {
          var s = !1;
          l.tcToken == null &&
            o("WAWebProfilePicThumbCollection").ProfilePicThumbCollection.get(
              l.id,
            ) == null &&
            (s = !0);
