  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function f() {
      ...
      (n("cr:6448") == null || n("cr:6448").incr("web.app.bootstrap"),
        ...
        await o("WAWebHandlePreviousLogout").handlePreviousLogoutFailures(),
      ...
      (p == null || p(),
        r("WAWebEnvironment").isWindows &&
          o("WAWebUserPrefsBase").userPreferencesStoreBase.set(
            o("WAWebUserPrefsKeys").UserPrefs.WindowsIsAdaptiveLayoutEnabled,
            o("WAWebAdaptiveLayoutGatingUtils").getIsAdaptiveLayoutEnabled(),
          ),
        ...
        await o("WAWebSafari14Fix").loadUserIdbForBrokenSafariVersion());
      try {
