  ...
  function (t, n, r, o, a, i, l) {
    async function e(e, t, n, a, i, l, s, u, c) {
      var d = l.map(function (e) {
        ...
        m = await o("WAWebCreateSendMsgRecord").createMsgRecord(e, t, n);
      if (m == null)
        throw r("err")(
          "resendUserGroupMsgJob failed to deserialize msg from db",
        );
      var p = await o("WAWebGroupMsgSendUtils").getParticipantRecord(a),
        _ = await o("WAWebGroupMsgSendUtils").getGroupData(a.toString(), p, m),
        f =
          m.type === o("WAWebSendMsgTypes").SendMessageRecordType.Message
            ...
            : o("WAWebSendMsgMetricReporter").createAddonMetricReporter(m.data);
