__d(
  "CometInternalTokenizerFetchProvider",
  [
    "CometInternalTokenizerFetchContext",
    "CometInternalTypeaheadEmptyFetchProvider",
    "react",
    "react-compiler-runtime",
    "useBaseTokenizerDataSourceFetch",
    ...
    function m(e) {
      ...
      t[4] !== a || t[5] !== i || t[6] !== p
        ? ((_ = {
          ...
          (t[7] = _))
        : (_ = t[7]);
      var f = r("useBaseTokenizerDataSourceFetch")(_),
        g = f[0],
        h = f[1],
        y = f[2],
        C = g.isLoading,
      ...
      return (
        t[17] !== R || t[18] !== S
          ? ((L = s.jsx(r("CometInternalTokenizerFetchContext").Provider, {
              value: S,
              children: R,
            })),
            (t[17] = R),
