__d(
  ...
  ["WALogger", "WAWebFileSaver", "WAWebFilenameManager", "cr:17219"],
  function (t, n, r, o, a, i, l) {
    ...
    async function O(t, r) {
      ...
      (o("WALogger").LOG(
        ...
        r == null || r(t));
      var y = await i.tryOpenCachedMediaFile(g, h);
      if (!y) {
        o("WALogger").ERROR(
          m ||
    ...
    async function B(e) {
      ...
      var i = a.mediaFileHash,
        ...
        s = await r.isCachedMediaFileExist(i, l);
      return (
        o("WALogger").LOG(
          _ ||
    ...
    async function W(e) {
      ...
      var d = await r.isCachedMediaFileExist(u, c);
      o("WALogger").LOG(
        C ||
          (C = babelHelpers.taggedTemplateLiteralLoose([
      ...
      (d ||
        ...
        await o("WAWebFileSaver").FileSaver.downloadAsync(
          ...
          async function (e, t, n) {
            ((m = e), await r.prepareForMediaFileSaving(e, t, n));
          },
        ),
        o("WALogger").LOG(
          v ||
        ...
        m != null &&
          ...
          await r.waitTillMediaDownloadCompletes(m != null ? m : "", c, u),
          o("WALogger").LOG(
            R ||
      ...
      var p = await r.isCachedMediaFileExist(u, c);
      if (!p) {
        (o("WALogger").ERROR(
          E ||
            (E = babelHelpers.taggedTemplateLiteralLoose([
    ...
    async function U(e) {
      ...
      var r =
        n("cr:17219") == null || (t = n("cr:17219").getWindowsBridge()) == null
          ? void 0
          : t.mediaFiles;
      if (r == null) {
        o("WALogger").ERROR(
      ...
      var i = await r.selectFolderForBulkMediaSaving();
      if (i == null || i === "") {
        o("WALogger").LOG(
          D ||
            (D = babelHelpers.taggedTemplateLiteralLoose([
      ...
      await o("WAWebFileSaver").FileSaver.downloadAsync(
        e,
        async function (e, t, n) {
          await r.prepareForZipArchiveSavingAndUnarchiveToFolder(e, i, t, n);
        },
      );
    }
    function V() {
    ...
    async function H(e) {
      ...
      var c = await r.tryCopyCachedMediaFile(s);
      if (!c) {
        o("WALogger").ERROR(
          w ||
    ...
    ((l.getMediaFileInfo = F),
      (l.openMediaFile = O),
      (l.isMediaFileSaved = B),
      (l.saveMediaFile = W),
      (l.supportsBulkMediaSaving = q),
      (l.selectFolderAndSaveFiles = U),
      (l.supportsMediaFileCopy = V),
      (l.copyMediaFile = H));
  },
  98,
);
