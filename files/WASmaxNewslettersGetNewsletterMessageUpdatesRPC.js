    ...
    function s() {
      return (
        (s = n("asyncToGeneratorRuntime").asyncToGenerator(function* (e, t) {
          var n = o(
              "WASmaxOutNewslettersGetNewsletterMessageUpdatesRequest",
            ).makeGetNewsletterMessageUpdatesRequest(e),
            r = yield o("WAComms").sendSmaxStanza(n, t),
            a = o(
              "WASmaxInNewslettersGetNewsletterMessageUpdatesResponseSuccess",
            ).parseGetNewsletterMessageUpdatesResponseSuccess(r, n);
          if (a.success)
            return {
          ...
          var i = o(
            "WASmaxInNewslettersGetNewsletterMessageUpdatesResponseClientError",
          ).parseGetNewsletterMessageUpdatesResponseClientError(r, n);
          if (i.success)
            return {
          ...
          var l = o(
            "WASmaxInNewslettersGetNewsletterMessageUpdatesResponseServerError",
          ).parseGetNewsletterMessageUpdatesResponseServerError(r, n);
          if (l.success)
            return {
