  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function u(t, n, r) {
      ...
      var i = a.map(function (e) {
        ...
        return (
          ...
          d({ added: n, oldRecord: e, removed: r, rotateKey: a, wid: t }),
    ...
    async function c(e) {
      if (e.length !== 0) {
        var t;
        try {
          t = await o("WAWebSchemaParticipant")
            .getParticipantTable()
            .anyOf(
              ["participants"],
              e.map(function (e) {
              ...
              e.participants.forEach(function (a) {
                ...
                if (i) {
                  ...
                  (s.forEach(function (e) {
                    ...
                    ((t = t || ((n = r.get(a)) != null ? n : !1)), r.delete(a));
                  }),
                    t &&
    ...
    ((l.updateGroupParticipantsInTransaction = u),
      (l.bulkUpdateGroupParticipantsInTransaction = c));
  },
  98,
);
