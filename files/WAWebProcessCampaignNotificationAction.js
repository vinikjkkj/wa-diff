__d(
  ...
  function (t, n, r, o, a, i, l) {
    ...
    async function $(e) {
      ...
      var i = await o("WAWebSchemaPendingBusinessBroadcastMessage")
    ...
    async function w(e, t, n, r, a, i) {
      ...
      p != null && (await p.triggerImageUpdate());
      ...
      var f = await o(
        ...
        g = f.freshMedia,
        h = f.mediaMsgData,
        y = o("WAWebBroadcastMsgDataUtils").createBroadcastProductMsgData(h, m);
    ...
    async function A(e, t, n, r, a, i) {
      var l = o("WAWebWidFactory").createWid(e);
      await o("WAWebCatalogCollection").CatalogCollection.find(l);
      var s = o("WAWebCatalogCollection").CatalogCollection.get(l),
        u = s == null ? void 0 : s.getMostRecentlyApprovedProduct(),
        c = u == null ? void 0 : u.getProductImageCollectionHead();
      c != null && (await c.triggerImageUpdate());
        ...
        return (
          o("WALogger")
            .ERROR(
              ...
              String(u != null),
              String(
                (u == null ? void 0 : u.getProductImageCollectionHead()) !=
                  null,
              ),
            )
      ...
      var p = JSON.parse(a),
        ...
        f = _.freshMedia,
        g = _.mediaMsgData,
        h = await o("WAWebSendBroadcastMsgAction").sendBroadcastMsgAction({
          beforeSend: o(
            "WAWebBizBroadcastMediaProcessor",
    ...
    async function F(e, t, n) {
      (await o("WAWebPendingBusinessBroadcastAPI").deletePendingBroadcast(e),
        await M(e, t),
        await o(
          "WAWebBizBroadcastSystemMessageManager",
    ...
    async function B(e) {
      ...
      if (i != null && a != null) {
        ...
        var m = JSON.parse(a),
          ...
          y = p.mediaMsgData;
        ((d = _.type),
          (c = await o("WAWebSendBroadcastMsgAction").sendBroadcastMsgAction({
            beforeSend: o(
              "WAWebBizBroadcastMediaProcessor",
    ...
    async function W(e) {
      ...
      if (e.status === "INTEGRITY_NOT_CLEARED") {
        (o("WALogger").LOG(
          ...
          await o("WAWebPendingBusinessBroadcastAPI").deletePendingBroadcast(t),
          await M(t, n));
        var l = await o(
          "WAWebBizBroadcastCampaignAPI",
        ).getBizBroadcastCampaignByAdGroupId(t);
      ...
      try {
        ...
        if (g == null || d == null)
          return (
            ...
            d != null && (await F(t, n, d)),
            !1
          );
        var x = o("WAWebWidFactory").createWid(d),
          P = await o("WAWebBroadcastDatabaseJob").getBroadcastMetadataJob(x),
          w = ((u = P == null ? void 0 : P.recipients) != null ? u : []).map(
            function (e) {
        ...
        var O = A.mediaType,
          W = A.result;
        if (
          W.messageSendResult === o("WAWebSendMsgResultAction").SendMsgResult.OK
        ) {
          var U, V, H;
          return (
            o("WALogger").LOG(
            ...
            o(
              ...
              attachment_type:
                (U = o("WAWebBizBroadcastMediaProcessor").getAttachmentType(
                  m,
                  h,
                  O,
                )) != null
              ...
              is_web_imported_list:
                (H = P == null ? void 0 : P.isWebCreatedList) != null ? H : !1,
        ...
        await q(W, t, n, d, w, m, h, O, f);
      } catch (e) {
        var G, z;
        if (
          e === o("WAWebPendingBusinessBroadcastAPI").AD_GROUP_NOT_FOUND_ERROR
        )
          return (
            o("WALogger").LOG(
              I ||
        ...
        (o("WALogger")
          ...
          o(
            ...
            null,
            String(
              (G = (z = r("getErrorSafe")(e)) == null ? void 0 : z.message) !=
                null
                ? G
                : e,
            ),
    ...
    async function q(e, t, n, r, a, i, l, s, u) {
    ...
    l.processCampaignNotification = W;
  },
  98,
);
