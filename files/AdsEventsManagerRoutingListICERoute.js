__d(
  ...
  function (t, n, r, o, a, i) {
    ...
    ((e.routeName = "AdsEventsManagerRoutingListICERoute"),
      (e.configName = "AdsEventsManagerRouting"),
      (e.configPath = n("immutable").List(["list"])),
      (e.givenName = "list"),
      (e.path = "/events_manager2/list"),
      (e.paramDefinitions = {}),
      ...
      (e.handler = n("AdsEventsManagerListingPageRouteHandler")),
      (e.forceLoad = !1),
      (e.viewModuleName = "AdsEventsManagerListingPage.react"),
      (a.exports = e));
  },
  null,
);
