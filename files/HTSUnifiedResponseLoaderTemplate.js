__d(
  "HTSUnifiedResponseLoaderTemplate",
  [],
    ...
    var e = {
      layout: {
        bloks_payload: {
          ...
          error_attribution: {
            logging_id:
              '{"callsite":"{\\"product\\":\\"unified_response\\",\\"feature\\":\\"unified_response_loader\\",\\"oncall\\":\\"product_elements\\"}","push_phase":"sandcastle","version":1,"request_id":"AmFP3Ek9D84cPrxx_y1PZ1s","www_revision":1034127093}',
            source_map_id: "qFes9y7yRSsOn0euH5W97g",
          },
          tree: {
              ...
              extensions: [
                {
                  "bk.extensions.OnDataChange": {
                    ...
                    on_bind:
                      '(bk.action.array.Make, "data", (bk.action.core.If, (bk.action.core.Match, (bk.action.bloks.GetVariable2, "query_info_1o57x5n0n4"), (bk.action.array.Make, (bk.action.core.Pattern, null, (bk.action.core.FuncConst, true))), (bk.action.core.Default, (bk.action.core.FuncConst, false))), null, (bk.action.map.Get, (bk.action.bloks.GetVariable2, "query_info_1o57x5n0n4"), "resolution_type")))',
                  },
                },
                {
