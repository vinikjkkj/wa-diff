      ...
      return {
        ...
        voipInit: async function (t, n, r) {
          ...
          (o("WALogger").LOG(
            ...
            o("WAWebVoipWebCodecsEncoderState").setWebCodecsEncoderEnabled(i),
            o("WALogger").LOG(
              d ||
          ...
          try {
            (o("WAWebVoipStackInterfaceWebHelpers").setABPropsOnWasm(e),
              e.setABPropBool("enable_passthrough_video_decoder", a),
              e.setABPropBool("enable_webcodec_video_encode", i),
              o(
                "WAWebLowEndDeviceExperimentGating",
          ...
          var h = e.getWebP2PVirtualIpv4(),
            y = e.getWebP2PVirtualIpv6(),
            C = e.getWebP2PVirtualPort();
          (o("WAWebVoipP2PConnectionManager").initP2PVirtualAddresses(h, y, C),
            o("WAWebVoipP2PConnectionManager").registerOnDataChannelMessage(
              function (t) {
                ...
                (e.GROWABLE_HEAP_U8().set(n, r),
                  e.handleOnMessageFromHeap(r, n.byteLength, h, C));
              },
            ));
          var b = !1;
        ...
        notifyUiViewChange: async function (t, n) {
          var e = await A,
            r = e.notifyUiViewChange(t, n != null ? n : "");
          return r;
        },
