__d(
  ...
  function (t, n, r, o, a, i, l) {
    var e, s, u, c, d, m, p, _;
    function f(t, n) {
      var r = (o("WATimeUtils").unixTime() - t) / 60;
      return r < 5
        ? (o("WALogger").LOG(
            e ||
        ...
        : o("WAWebOrchestratorNonPersistedJob")
            .createNonPersistedJob(
              ...
              function (e) {
                return g(e.timeAfterPairingMins, e.loggingCount);
              },
              { priority: o("WAJobOrchestratorTypes").JOB_PRIORITY.LOW },
            )
            .waitUntilCompleted({ timeAfterPairingMins: r, loggingCount: n });
    }
    async function g(e, t) {
      ...
      if (e >= 60) {
        (o("WALogger").LOG(
          ...
          await h(
            o("WAWebWamEnumActiveTimeAfterPairing").ACTIVE_TIME_AFTER_PAIRING
              .MINS_60,
          ),
          o(
            "WAWebUserPrefsHistorySync",
    ...
    async function y(e) {
      ...
      var d = await o("WAWebUserPrefsHistorySync").getHistorySyncStatus();
    ...
    ((l.logHistorySyncStatusAfterPairingJob = f),
      (l.logHistorySyncStatusAfterPairing = g),
      (l.commitHistorySyncStatusData = h));
  },
  98,
);
