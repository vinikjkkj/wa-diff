  ...
  function (t, n, r, o, a, i, l) {
    ...
    function m(e) {
      return e === "ERROR" || e === "CATCHING"
        ? {
            level: 4,
            consoleFunction: d() <= 4 ? console.error : r("WAWebNoop"),
          }
        : e === "WARN"
          ? {
              level: 3,
              consoleFunction: d() <= 3 ? console.warn : r("WAWebNoop"),
            }
          : e === "COUNT"
            ? {
                level: 2,
                consoleFunction: d() <= 2 ? console.count : r("WAWebNoop"),
              }
            : e === "LOG"
              ? {
                  level: 2,
                  consoleFunction: d() <= 2 ? console.log : r("WAWebNoop"),
                }
              : e === "DEV_XMPP" || e === "DEV"
                ? {
                    level: 1,
                    consoleFunction: d() <= 1 ? console.info : r("WAWebNoop"),
                  }
                : (function () {
                    throw Error(
    ...
    function f(e, t, n) {
      ...
      (e.tags != null &&
        ...
        ((r = e.sendLogs) == null ? void 0 : r.sampling) != null &&
          i.push("sampling"));
      var l = e.template.join("%s"),
        s = e.expressions.map(function (e) {
          return e instanceof Error
            ? ""
    ...
    function g(e) {
      var t,
        n = o("WAWebFBLogger").WAWebFBLogger().tags(e.tags);
      (e.error != null
        ? (n = n.catching(e.error))
        : (n = n.blameToPreviousFrame().blameToPreviousFrame()),
        e.fileId != null && (n = n.addMetadata("WA_WEB", "FILE_ID", e.fileId)),
        (t = n).mustfix.apply(
          t,
          [e.formatString + " (" + e.reason + ")"].concat(
            e.sanitizedExpressions,
          ),
        ));
    }
    var h = {
      ...
      devConsole: function (t, n, o) {
        if (!r("gkx")("5943") && s()) {
          for (
            ...
            a[i - 3] = arguments[i];
          p.apply(void 0, [t, n + " devConsole:"].concat(a));
        }
      },
      sendLogs: function (t) {
        var e, n, a, i, l, c;
        if (
          ...
          var d = m(t.level),
            ...
            h = _ ? [] : [o("WAWebLoggerImpl").STACK_TRACE_TAG],
            y = o("WAWebLoggerImpl")
              .Logger.log(d.level, t.verbose, g, !1, h)
              .apply(void 0, [t.template].concat(t.expressions));
          s() && !r("gkx")("5943") && p(t.level, y);
          var C = o("WAWebLoggerImpl")
            .Logger.log(d.level, t.verbose, void 0, !0, t.tags)
            .apply(void 0, [t.template].concat(t.expressions));
          s() && !r("gkx")("5943") && p(t.level, C);
          var b =
    ...
    function y(e, t) {
      ((u = e), (c = t), o("WATagsLogger").initializeWaLogger(h));
    }
    ((l.logToFBLoggerLocal = g), (l.initializeWAWebLogger = y));
  },
  98,
);
