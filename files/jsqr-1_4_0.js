__d(
  ...
  function (t, n, r, o, a, i) {
    ...
    function s() {
      (function (n, r) {
        typeof e == "object" && typeof l == "object"
          ? (l.exports = r())
          : typeof e == "object"
            ? (e.jsQR = r())
            : (n.jsQR = r());
        ...
        return (function (e) {
            ...
            var r = (function () {
              ...
              return (
                ...
                (e.prototype.setRegion = function (e, t, n, r, o) {
                  for (var a = t; a < t + r; a++)
                    for (var i = e; i < e + n; i++) this.set(i, a, !!o);
                }),
                e
              );
            })();
            ...
            var a = (function () {
              ...
              return (
                ...
                (e.prototype.inverse = function (e) {
                  if (e === 0) throw new Error("Can't invert 0");
                ...
                (e.prototype.log = function (e) {
                  if (e === 0) throw new Error("Can't take log(0)");
          ...
          function (e, t, n) {
            ...
            var r = n(1),
              o = (function () {
                function e(e, t) {
                  if (t.length === 0) throw new Error("No coefficients.");
                  this.field = e;
                  var n = t.length;
                  if (n > 1 && t[0] === 0) {
                ...
                return (
                  ...
                  (e.prototype.addOrSubtract = function (t) {
                    ...
                    for (
                      ...
                      i[s] = a[s];
                    for (var s = l; s < a.length; s++)
                      i[s] = r.addOrSubtractGF(o[s - l], a[s]);
                  ...
                  (e.prototype.multiplyPoly = function (t) {
                    ...
                    for (
                      var n = this.coefficients,
                        ...
                        a = t.coefficients,
                        i = a.length,
                        l = new Uint8ClampedArray(o + i - 1),
                        s = 0;
                      s < o;
                      s++
                    )
                      for (var u = n[s], c = 0; c < i; c++)
                        l[s + c] = r.addOrSubtractGF(
                          l[s + c],
          ...
          function (e, t, n) {
            ...
            function s(e, t, n, s) {
              ...
              for (var u = new l(t, n), c = 0; c < t; c++)
                for (var d = 0; d < n; d++) {
                  var m = e[(d * t + c) * 4 + 0],
                    p = e[(d * t + c) * 4 + 1],
                    _ = e[(d * t + c) * 4 + 2];
                  u.set(c, d, 0.2126 * m + 0.7152 * p + 0.0722 * _);
                }
              for (
                var f = Math.ceil(t / o),
                  g = Math.ceil(n / o),
                ...
                for (var C = 0; C < f; C++) {
                  for (var b = 0, v = 1 / 0, S = 0, d = 0; d < o; d++)
                    for (var c = 0; c < o; c++) {
                      var R = u.get(C * o + c, y * o + d);
                      ((b += R), (v = Math.min(v, R)), (S = Math.max(S, R)));
                    }
                  var L = b / Math.pow(o, 2);
                  if (S - v <= a && ((L = v / 2), y > 0 && C > 0)) {
                    var E =
                      (h.get(C, y - 1) +
                        2 * h.get(C - 1, y) +
                        h.get(C - 1, y - 1)) /
              ...
              var k = r.BitMatrix.createEmpty(t, n),
                I = null;
              s && (I = r.BitMatrix.createEmpty(t, n));
              for (var y = 0; y < g; y++)
                for (var C = 0; C < f; C++) {
                  for (
                    var T = i(C, 2, f - 3), D = i(y, 2, g - 3), b = 0, x = -2;
                    x <= 2;
                    x++
                  )
                    for (var $ = -2; $ <= 2; $++) b += h.get(T + x, D + $);
                  for (var P = b / 25, x = 0; x < o; x++)
                    for (var $ = 0; $ < o; $++) {
                      var c = C * o + x,
                        d = y * o + $,
                        N = u.get(c, d);
                      (k.set(c, d, N <= P), s && I.set(c, d, !(N <= P)));
                    }
                }
              return s ? { binarized: k, inverted: I } : { binarized: k };
            }
            t.binarize = s;
          },
          function (e, t, n) {
            ...
            function d(e) {
              ...
              for (var o = 0, a = e.alignmentPatternCenters; o < a.length; o++)
                for (
                  var i = a[o], l = 0, s = e.alignmentPatternCenters;
                  l < s.length;
                  l++
                ) {
                  var u = s[l];
            ...
            function p(e) {
              var t = e.height,
                n = Math.floor((t - 17) / 4);
              if (n <= 6) return i.VERSIONS[n - 1];
              for (var r = 0, o = 5; o >= 0; o--)
                for (var a = t - 9; a >= t - 11; a--) r = s(e.get(a, o), r);
              for (var u = 0, a = 5; a >= 0; a--)
                for (var o = t - 9; o >= t - 11; o--) u = s(e.get(a, o), u);
              for (var c = 1 / 0, d, m = 0, p = i.VERSIONS; m < p.length; m++) {
                var _ = p[m];
                if (_.infoBits === r || _.infoBits === u) return _;
                var f = l(r, _.infoBits);
                (f < c && ((d = _), (c = f)),
                  (f = l(u, _.infoBits)),
                  f < c && ((d = _), (c = f)));
              }
            ...
            function _(e) {
              for (var t = 0, n = 0; n <= 8; n++)
                n !== 6 && (t = s(e.get(n, 8), t));
              for (var r = 7; r >= 0; r--) r !== 6 && (t = s(e.get(8, r), t));
              for (var o = e.height, a = 0, r = o - 1; r >= o - 7; r--)
                a = s(e.get(8, r), a);
              for (var n = o - 8; n < o; n++) a = s(e.get(n, 8), a);
              for (var i = 1 / 0, c = null, d = 0, m = u; d < m.length; d++) {
                var p = m[d],
                  _ = p.bits,
                  f = p.formatInfo;
                if (_ === t || _ === a) return f;
            ...
            function f(e, t, n) {
              ...
              e = e.slice(0, a);
              for (
                var i = r.ecBlocks[0].dataCodewordsPerBlock, l = 0;
                l < i;
                l++
              )
                for (var s = 0, u = o; s < u.length; s++) {
                  var c = u[s];
                  c.codewords.push(e.shift());
                }
              if (r.ecBlocks.length > 1)
                for (
                  var d = r.ecBlocks[0].numBlocks,
                    m = r.ecBlocks[1].numBlocks,
                    l = 0;
                  l < m;
                  l++
                )
                  o[d + l].codewords.push(e.shift());
              for (; e.length > 0; )
            ...
            function g(e) {
              ...
              if (!n) return null;
              var r = m(e, t, n),
                i = f(r, t, n.errorCorrectionLevel);
              if (!i) return null;
              for (
                var l = i.reduce(function (e, t) {
                    return e + t.numDataCodewords;
                  }, 0),
                  s = new Uint8ClampedArray(l),
                  u = 0,
                  c = 0,
                  d = i;
                c < d.length;
                ...
                if (!h) return null;
                for (var y = 0; y < g.numDataCodewords; y++) s[u++] = h[y];
              }
              try {
                return o.decode(s, t.versionNumber);
              } catch (e) {
                return null;
              }
            }
          ...
          function (e, t, n) {
            ...
            function l(e, t) {
              for (
                ...
                var l = Math.floor(i / 100),
                  s = Math.floor(i / 10) % 10,
                  u = i % 10;
                (n.push(48 + l, 48 + s, 48 + u),
                  (r += l.toString() + s.toString() + u.toString()),
                  (a -= 3));
              }
              if (a === 2) {
                var i = e.readBits(7);
                if (i >= 100) throw new Error("Invalid numeric value above 99");
                var l = Math.floor(i / 10),
                  s = i % 10;
                (n.push(48 + l, 48 + s), (r += l.toString() + s.toString()));
              } else if (a === 1) {
                var i = e.readBits(4);
                if (i >= 10) throw new Error("Invalid numeric value above 9");
                (n.push(48 + i), (r += i.toString()));
              }
            ...
            function u(e, t) {
              for (
                ...
                var i = e.readBits(11),
                  l = Math.floor(i / 45),
                  u = i % 45;
                (n.push(s[l].charCodeAt(0), s[u].charCodeAt(0)),
                  (r += s[l] + s[u]),
                  (a -= 2));
              }
              if (a === 1) {
                var l = e.readBits(6);
                (n.push(s[l].charCodeAt(0)), (r += s[l]));
              }
              return { bytes: n, text: r };
            }
            function c(e, t) {
            ...
            function d(e, t) {
              for (
                ...
                (u < 7936 ? (u += 33088) : (u += 49472),
                  n.push(u >> 8, u & 255),
                  (r += String.fromCharCode(o.shiftJISTable[u])));
              }
              return { bytes: n, text: r };
            }
            function m(e, t) {
              for (
                var n,
                  ...
                  p = new r.BitStream(e),
                  _ = t <= 9 ? 0 : t <= 26 ? 1 : 2,
                  f = { text: "", bytes: [], chunks: [], version: t };
                p.available() >= 4;
              ) {
                var g = p.readBits(4);
                if (g === i.Terminator) return f;
                if (g === i.ECI)
                  p.readBits(1) === 0
                    ? f.chunks.push({
                        type: a.ECI,
                    ...
                    : p.readBits(1) === 0
                      ...
                      : p.readBits(1) === 0
                        ...
                        : f.chunks.push({ type: a.ECI, assignmentNumber: -1 });
                else if (g === i.Numeric) {
                  var h = l(p, _);
                  ((f.text += h.text),
                    (n = f.bytes).push.apply(n, h.bytes),
                    f.chunks.push({ type: a.Numeric, text: h.text }));
                } else if (g === i.Alphanumeric) {
                  var y = u(p, _);
                  ((f.text += y.text),
                    (o = f.bytes).push.apply(o, y.bytes),
                    f.chunks.push({ type: a.Alphanumeric, text: y.text }));
                } else if (g === i.Byte) {
                  var C = c(p, _);
                  ((f.text += C.text),
                    (s = f.bytes).push.apply(s, C.bytes),
                    f.chunks.push({
                      type: a.Byte,
                      bytes: C.bytes,
                      text: C.text,
                  ...
                  var b = d(p, _);
                  ((f.text += b.text),
                    (m = f.bytes).push.apply(m, b.bytes),
                    f.chunks.push({
                      type: a.Kanji,
                      bytes: b.bytes,
                      text: b.text,
                ...
                (e.prototype.readBits = function (e) {
                  ...
                  if (this.bitOffset > 0) {
                    var n = 8 - this.bitOffset,
                      ...
                      o = n - r,
                      a = (255 >> (8 - r)) << o;
                    ((t = (this.bytes[this.byteOffset] & a) >> o),
                      (e -= r),
                      (this.bitOffset += r),
                      this.bitOffset === 8 &&
                  ...
                  if (e > 0) {
                    ...
                    if (e > 0) {
                      var o = 8 - e,
                        a = (255 >> o) << o;
                      ((t =
                        (t << e) | ((this.bytes[this.byteOffset] & a) >> o)),
                        (this.bitOffset += e));
                    }
                  }
                  return t;
          ...
          function (e, t, n) {
            ...
            function a(e, t, n, r) {
              var o;
              t.degree() < n.degree() && ((o = [n, t]), (t = o[0]), (n = o[1]));
              for (
                var a = t, i = n, l = e.zero, s = e.one;
                i.degree() >= r / 2;
              ) {
                var u = a,
                  c = l;
                if (((a = i), (l = s), a.isZero())) return null;
                i = u;
                for (
                  var d = e.zero,
                    m = a.getCoefficient(a.degree()),
                    p = e.inverse(m);
                  i.degree() >= a.degree() && !i.isZero();
                ) {
                  var _ = i.degree() - a.degree(),
                    f = e.multiply(i.getCoefficient(i.degree()), p);
                  ((d = d.addOrSubtract(e.buildMonomial(_, f))),
                    (i = i.addOrSubtract(a.multiplyByMonomial(_, f))));
                }
                if (
                  ((s = d.multiplyPoly(l).addOrSubtract(c)),
                  i.degree() >= a.degree())
                )
                  return null;
              }
              ...
              if (g === 0) return null;
              var h = e.inverse(g);
              return [s.multiply(h), i.multiply(h)];
            }
            function i(e, t) {
              var n = t.degree();
              if (n === 1) return [t.getCoefficient(1)];
              for (var r = new Array(n), o = 0, a = 1; a < e.size && o < n; a++)
                t.evaluateAt(a) === 0 && ((r[o] = e.inverse(a)), o++);
              return o !== n ? null : r;
            }
            function l(e, t, n) {
              for (var o = n.length, a = new Array(o), i = 0; i < o; i++) {
                for (var l = e.inverse(n[i]), s = 1, u = 0; u < o; u++)
                  i !== u &&
                    (s = e.multiply(
                      s,
                      r.addOrSubtractGF(1, e.multiply(n[u], l)),
                    ));
                ((a[i] = e.multiply(t.evaluateAt(l), e.inverse(s))),
                  e.generatorBase !== 0 && (a[i] = e.multiply(a[i], l)));
              }
              return a;
            }
            function s(e, t) {
              ...
              n.set(e);
              for (
                var s = new r.default(285, 256, 0),
                  u = new o.default(s, n),
                  c = new Uint8ClampedArray(t),
                  d = !1,
                  m = 0;
                m < t;
                m++
              ) {
                var p = u.evaluateAt(s.exp(m + s.generatorBase));
                ((c[c.length - 1 - m] = p), p !== 0 && (d = !0));
              }
              if (!d) return n;
              var _ = new o.default(s, c),
                f = a(s, s.buildMonomial(t, 1), _, t);
              if (f === null) return null;
              var g = i(s, f[0]);
              if (g == null) return null;
              for (var h = l(s, f[1], g), y = 0; y < g.length; y++) {
                var C = n.length - 1 - s.log(g[y]);
                if (C < 0) return null;
                n[C] = r.addOrSubtractGF(n[C], h[y]);
              }
              return n;
            }
            t.decode = s;
          ...
          function (e, t, n) {
            ...
            function l(e, t) {
              for (
                ...
                for (var m = 0; m < t.dimension; m++) {
                  var p = m + 0.5,
                    _ = d + 0.5,
                    f = c(p, _);
                  u.set(m, d, e.get(Math.floor(f.x), Math.floor(f.y)));
                }
          ...
          function (e, t, n) {
            ...
            function s(e, t, n) {
              ...
              return (
                u >= s && u >= c
                  ? ((r = [t, e, n]), (d = r[0]), (m = r[1]), (p = r[2]))
                  : c >= u && c >= s
                    ? ((o = [e, t, n]), (d = o[0]), (m = o[1]), (p = o[2]))
                    : ((a = [e, n, t]), (d = a[0]), (m = a[1]), (p = a[2])),
                (p.x - m.x) * (d.y - m.y) - (p.y - m.y) * (d.x - m.x) < 0 &&
                  ((l = [p, d]), (d = l[0]), (p = l[1])),
                { bottomLeft: d, topLeft: m, topRight: p }
              );
            }
            function u(e, t, n, r) {
              var o =
                (l(d(e, n, r, 5)) / 7 +
                  ...
                  l(d(t, e, r, 5)) / 7) /
                4;
              if (o < 1) throw new Error("Invalid module size");
              var a = Math.round(i(e, t) / o),
                s = Math.round(i(e, n) / o),
                u = Math.floor((a + s) / 2) + 7;
              switch (u % 4) {
                case 0:
                  u++;
                  break;
              ...
              return { dimension: u, moduleSize: o };
            }
            function c(e, t, n, r) {
              var o = [{ x: Math.floor(e.x), y: Math.floor(e.y) }],
              ...
              for (
                ...
                if (
                  n.get(C, b) !== g &&
                  ((g = !g), o.push({ x: C, y: b }), o.length === r + 1)
                )
                  break;
                if (((p += m), p > 0)) {
                  if (y === c) break;
              ...
              for (var v = [], S = 0; S < r; S++)
                o[S] && o[S + 1] ? v.push(i(o[S], o[S + 1])) : v.push(0);
              return v;
            }
            function d(e, t, n, r) {
              var o,
                a = t.y - e.y,
                i = t.x - e.x,
                l = c(e, t, n, Math.ceil(r / 2)),
                s = c(e, { x: e.x - i, y: e.y - a }, n, Math.ceil(r / 2)),
                u = l.shift() + s.shift() - 1;
              return (o = s.concat(u)).concat.apply(o, l);
            }
            function m(e, t) {
              var n = l(e) / l(t),
                r = 0;
            ...
            function p(e, t, n) {
              try {
                var r = d(e, { x: -1, y: e.y }, n, t.length),
                  o = d(e, { x: e.x, y: -1 }, n, t.length),
                  a = {
                  ...
                  g =
                    ...
                    4,
                  h =
                    (Math.pow(u.averageSize - g, 2) +
                      Math.pow(c.averageSize - g, 2) +
                      Math.pow(p.averageSize - g, 2) +
                      Math.pow(_.averageSize - g, 2)) /
                    g;
                return f + h;
              } catch (e) {
                return 1 / 0;
            ...
            function _(e, t) {
              ...
              for (
                ...
                a--;
              for (var i = Math.round(t.y); e.get(Math.round(o), i); ) i++;
              var l = (a + i) / 2;
              return { x: o, y: l };
            }
            function f(e) {
                              ...
                              var g = t - d[3] - d[4],
                                ...
                                C = n.filter(function (e) {
                                  return (
                                    ...
                                    (h <= e.bottom.startX &&
                                      g >= e.bottom.endX &&
                                      d[2] / (e.bottom.endX - e.bottom.startX) <
                                        a &&
                                      d[2] / (e.bottom.endX - e.bottom.startX) >
                                        o)
                                  );
              ...
              var m = t
                ...
                .map(function (e, t, n) {
                  ...
                  return { points: [e].concat(o.slice(0, 2)), score: a };
                })
                .filter(function (e) {
                  return !!e;
                })
              ...
              var f = s(m[0].points[0], m[0].points[1], m[0].points[2]),
                h = f.topRight,
                y = f.topLeft,
                C = f.bottomLeft,
                b = g(e, i, h, y, C),
              ...
              return (
                E &&
                  v.push({
                    alignmentPattern: {
                      x: E.alignmentPattern.x,
                      y: E.alignmentPattern.y,
                    },
                    bottomLeft: { x: L.x, y: L.y },
                    topLeft: { x: R.x, y: R.y },
                    topRight: { x: S.x, y: S.y },
            ...
            function g(e, t, n, r, o) {
              var a, s, c;
              try {
                ((a = u(r, n, o, e)), (s = a.dimension), (c = a.moduleSize));
              } catch (e) {
                return null;
              }
              var d = { x: n.x - r.x + o.x, y: n.y - r.y + o.y },
                m = (i(r, o) + i(r, n)) / 2 / c,
                _ = 1 - 3 / m,
                f = { x: r.x + _ * (d.x - r.x), y: r.y + _ * (d.y - r.y) },
                g = t
                  .map(function (t) {
                    var n =
                        (t.top.startX +
                ...
                h = m >= 15 && g.length ? g[0] : f;
              return { alignmentPattern: h, dimension: s };
            }
          },
        ]).default;
      });
