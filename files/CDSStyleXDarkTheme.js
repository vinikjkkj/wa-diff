__d(
  ...
  function (t, n, r, o, a, i) {
    a.exports = {
      ...
      "attachment-footer-background": "rgba(255,255,255,0.10)",
      "background-deemphasized": "rgba(28,43,51)",
      ...
      "card-background": "rgb(52,72,84)",
      "card-background-flat": "rgb(52,72,84)",
      "card-box-shadow":
      ...
      "comment-background": "rgba(255,255,255,0.10)",
      "comment-bubble": "18px",
      ...
      "disabled-icon": "rgba(255,255,255,0.15)",
      "disabled-text": "rgba(255,255,255,0.15)",
      divider: "rgb(70,90,105)",
      "divider-on-color": "#3E4042",
      "emphasized-card-background-blue-comet":
        "linear-gradient(rgb(0,59,173),rgb(0,10,73))",
      "emphasized-card-background-green-comet":
        "linear-gradient(rgb(0,82,35),rgb(0,20,11))",
      "emphasized-card-background-purple-comet":
        "linear-gradient(rgb(66,23,160),rgb(18,3,53))",
      "emphasized-card-background-teal-comet":
        "linear-gradient(rgb(0,65,75), rgb(0,19,26))",
      "event-date": "rgb(240,95,105)",
      "fb-logo": "#0866FF",
      "fb-wordmark": "#FFFFFF",
      ...
      "hosted-view-selected-state": "rgb(222,227,233)",
      "hover-overlay": "rgba(255, 255, 255, 0.1)",
      "image-corner-radius": "4px",
      "infochip-medium-radius": "12px",
      "input-background": "rgb(52,72,84)",
      ...
      "list-cell-chevron": "rgb(203, 210, 217)",
      ...
      "media-inner-border": "rgba(255,255,255,0.10)",
      "media-outer-border": "#33363A",
      "media-pressed": "rgba(255,255,255,0.30)",
      ...
      negative: "rgb(240,95,105)",
      "negative-background": "hsl(350, 87%, 55%, 20%)",
      "new-notification-background": "rgba(255,255,255,0.10)",
      "non-media-pressed": "rgba(255,255,255,0.20)",
      "non-media-pressed-on-dark": "rgba(255,255,255,0.30)",
      "notification-badge": "rgb(240,95,105)",
      ...
      "primary-deemphasized-button-pressed": "rgb(255,255,255,.05)",
      "primary-deemphasized-button-pressed-overlay": "rgb(255,255,255,.15)",
      "primary-deemphasized-button-text": "rgb(28,43,51)",
      ...
      "scroll-shadow": "0 0px 16px 0 rgba(52,72,84,0.05)",
      "scroll-thumb": "rgba(255, 255, 255, 0.3)",
      "search-input-background": "rgba(255, 255, 255, 0.19)",
      ...
      "secondary-button-stroke": "rgb(167,179,191)",
      "secondary-button-text": "rgb(255,255,255)",
      "secondary-emphasized-button-stroke": "rgb(69,153,255)",
      "secondary-icon": "rgb(222,227,233)",
      "secondary-text": "rgb(222,227,233)",
      ...
      "stepper-inactive": "rgba(203, 210, 217, 0.4)",
      "surface-background": "rgb(28,43,51)",
      ...
      "text-highlight": "rgb(130,185,230)",
      "text-input-bar-background": "rgba(255, 255, 255, 0.1)",
      ...
      "toast-background": "rgb(70,90,105)",
      ...
      "toggle-active-background": "rgb(222,227,233)",
      "toggle-active-icon": "rgb(28,43,51)",
      "toggle-active-text": "rgb(28,43,51)",
      "toggle-button-active-background": "#E6F2FF",
      "tooltip-background": "rgb(70,90,105)",
